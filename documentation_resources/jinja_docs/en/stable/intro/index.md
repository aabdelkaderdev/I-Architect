<!-- Source: https://jinja.palletsprojects.com/en/stable/intro/ -->
...
3.7 and newer. We also recommend using a [virtual environment](https://packaging.python.org/tutorials/installing-packages/#creating-virtual-environments) in order
...
- [MarkupSafe](https://markupsafe.palletsprojects.com/) escapes untrusted input when rendering templates to
