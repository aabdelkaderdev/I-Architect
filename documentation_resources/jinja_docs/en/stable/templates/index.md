...
[Line Statements and Comments](#line-statements) are also possible,
...
[`Environment`](../api/#jinja2.Environment "jinja2.Environment").
...
sign (`-`) to the start or end of a block (e.g. a [For](#for-loop) tag), a
...
If [Line Statements](#line-statements) are enabled, they strip leading whitespace
...
advantage of it, see [Null-Default Fallback](../tricks/#null-default-fallback). Also a block will always be
filled in regardless of whether the surrounding condition is evaluated to be true
or false.

The filename of the template depends on the template loader. For example, the
[`FileSystemLoader`](../api/#jinja2.FileSystemLoader "jinja2.FileSystemLoader") allows you to access other templates by giving the
...
1. The context dictionary by the application with
   `markupsafe.Markup`
...
cycling. For more information, have a look at the [List of Global Functions](#builtin-globals).
...
This is not supported. See [Assignments](#assignments) for more information about
...
use more complex [Expressions](#expressions) there, too:
...
If can also be used as an [inline expression](#if-expression) and for
...
`caller`
:   If the macro was called from a [call](#call) tag, the caller is stored
...
:   This is `true` if the macro accesses the special `caller` variable and may
    be called from a [call](#call) tag.
...
[Template Inheritance](#template-inheritance) section.
...
imports and includes, see [Import Context Behavior](#import-visibility).
...
:   A dict in Python is a structure that combines keys and values. Keys must
    ...
    templates; they are useful in some rare cases such as the `xmlattr()`
    filter.
...
evaluates into an [`Undefined`](../api/#jinja2.Undefined "jinja2.Undefined") object (regardless of what `undefined`
...
jinja-filters.attr(*obj: Any*, *name: [str](https://docs.python.org/3/library/stdtypes.html#str "(in Python v3.13)")*) → [jinja2.runtime.Undefined](../api/#jinja2.Undefined "jinja2.runtime.Undefined") | Any
...
jinja-filters.batch(*value: 't.Iterable[V]'*, *linecount: [int](https://docs.python.org/3/library/functions.html#int "(in Python v3.13)")*, *fill\_with: 't.Optional[V]' = None*) → 't.Iterator[t.List[V]]'
...
jinja-filters.capitalize(*s: [str](https://docs.python.org/3/library/stdtypes.html#str "(in Python v3.13)")*) → [str](https://docs.python.org/3/library/stdtypes.html#str "(in Python v3.13)")
:   Capitalize a value. The first character will be uppercase, all others
    lowercase.

jinja-filters.center(*value: [str](https://docs.python.org/3/library/stdtypes.html#str "(in Python v3.13)")*, *width: [int](https://docs.python.org/3/library/functions.html#int "(in Python v3.13)") = 80*) → [str](https://docs.python.org/3/library/stdtypes.html#str "(in Python v3.13)")
:   Centers the value in a field of a given width.

jinja-filters.default(*value: V*, *default\_value: V = ''*, *boolean: [bool](https://docs.python.org/3/library/functions.html#bool "(in Python v3.13)") = False*) → V
:   If the value is undefined it will return the passed default value,
    ...
    Changed in version 2.11: It’s now possible to configure the [`Environment`](../api/#jinja2.Environment "jinja2.Environment") with
    [`ChainableUndefined`](../api/#jinja2.ChainableUndefined "jinja2.ChainableUndefined") to make the `default` filter work
    on nested elements and attributes that may contain undefined values
    in the chain without getting an [`UndefinedError`](../api/#jinja2.UndefinedError "jinja2.UndefinedError").

    Aliases:
    :   `d`

jinja-filters.dictsort(*value: Mapping[K, V]*, *case\_sensitive: [bool](https://docs.python.org/3/library/functions.html#bool "(in Python v3.13)") = False*, *by: 'te.Literal["key", "value"]' = 'key'*, *reverse: [bool](https://docs.python.org/3/library/functions.html#bool "(in Python v3.13)") = False*) → [List](../extensions/#jinja2.nodes.List "jinja2.nodes.List")[[Tuple](../extensions/#jinja2.nodes.Tuple "jinja2.nodes.Tuple")[K, V]]
...
jinja-filters.float(*value: Any*, *default: [float](https://docs.python.org/3/library/functions.html#float "(in Python v3.13)") = 0.0*) → [float](https://docs.python.org/3/library/functions.html#float "(in Python v3.13)")
...
jinja-filters.format(*value: [str](https://docs.python.org/3/library/stdtypes.html#str "(in Python v3.13)")*, *\*args: Any*, *\*\*kwargs: Any*) → [str](https://docs.python.org/3/library/stdtypes.html#str "(in Python v3.13)")
:   Apply the given values to a [printf-style](https://docs.python.org/library/stdtypes.html#printf-style-string-formatting) format string, like
    `string % values`.
    ...
    `%` operator or [`str.format()`](https://docs.python.org/3/library/stdtypes.html#str.format "(in Python v3.13)").
...
jinja-filters.groupby(*value: 't.Iterable[V]'*, *attribute: [str](https://docs.python.org/3/library/stdtypes.html#str "(in Python v3.13)") | [int](https://docs.python.org/3/library/functions.html#int "(in Python v3.13)")*, *default: Any | [None](https://docs.python.org/3/library/constants.html#None "(in Python v3.13)") = None*, *case\_sensitive: [bool](https://docs.python.org/3/library/functions.html#bool "(in Python v3.13)") = False*) → 't.List[\_GroupTuple]'
:   Group a sequence of objects by an attribute using Python’s
    [`itertools.groupby()`](https://docs.python.org/3/library/itertools.html#itertools.groupby "(in Python v3.13)"). The attribute can use dot notation for
    ...
    Like the [`sort()`](#jinja-filters.sort "jinja-filters.sort") filter, sorting and grouping is
    ...
    Changed in version 3.1: Added the `case_sensitive` parameter. Sorting and grouping is
...
jinja-filters.indent(*s: [str](https://docs.python.org/3/library/stdtypes.html#str "(in Python v3.13)")*, *width: [int](https://docs.python.org/3/library/functions.html#int "(in Python v3.13)") | [str](https://docs.python.org/3/library/stdtypes.html#str "(in Python v3.13)") = 4*, *first: [bool](https://docs.python.org/3/library/functions.html#bool "(in Python v3.13)") = False*, *blank: [bool](https://docs.python.org/3/library/functions.html#bool "(in Python v3.13)") = False*) → [str](https://docs.python.org/3/library/stdtypes.html#str "(in Python v3.13)")
...
jinja-filters.int(*value: Any*, *default: [int](https://docs.python.org/3/library/functions.html#int "(in Python v3.13)") = 0*, *base: [int](https://docs.python.org/3/library/functions.html#int "(in Python v3.13)") = 10*) → [int](https://docs.python.org/3/library/functions.html#int "(in Python v3.13)")
...
jinja-filters.items(*value: Mapping[K, V] | [jinja2.runtime.Undefined](../api/#jinja2.Undefined "jinja2.runtime.Undefined")*) → Iterator[[Tuple](../extensions/#jinja2.nodes.Tuple "jinja2.nodes.Tuple")[K, V]]
...
jinja-filters.join(*value: Iterable[Any]*, *d: [str](https://docs.python.org/3/library/stdtypes.html#str "(in Python v3.13)") = ''*, *attribute: [str](https://docs.python.org/3/library/stdtypes.html#str "(in Python v3.13)") | [int](https://docs.python.org/3/library/functions.html#int "(in Python v3.13)") | NoneType = None*) → [str](https://docs.python.org/3/library/stdtypes.html#str "(in Python v3.13)")
...
jinja-filters.lower(*s: [str](https://docs.python.org/3/library/stdtypes.html#str "(in Python v3.13)")*) → [str](https://docs.python.org/3/library/stdtypes.html#str "(in Python v3.13)")
...
jinja-filters.max(*value: 't.Iterable[V]'*, *case\_sensitive: [bool](https://docs.python.org/3/library/functions.html#bool "(in Python v3.13)") = False*, *attribute: [str](https://docs.python.org/3/library/stdtypes.html#str "(in Python v3.13)") | [int](https://docs.python.org/3/library/functions.html#int "(in Python v3.13)") | NoneType = None*) → 't.Union[V, Undefined]'
...
jinja-filters.min(*value: 't.Iterable[V]'*, *case\_sensitive: [bool](https://docs.python.org/3/library/functions.html#bool "(in Python v3.13)") = False*, *attribute: [str](https://docs.python.org/3/library/stdtypes.html#str "(in Python v3.13)") | [int](https://docs.python.org/3/library/functions.html#int "(in Python v3.13)") | NoneType = None*) → 't.Union[V, Undefined]'
...
jinja-filters.pprint(*value: Any*) → [str](https://docs.python.org/3/library/stdtypes.html#str "(in Python v3.13)")
...
jinja-filters.replace(*s: [str](https://docs.python.org/3/library/stdtypes.html#str "(in Python v3.13)")*, *old: [str](https://docs.python.org/3/library/stdtypes.html#str "(in Python v3.13)")*, *new: [str](https://docs.python.org/3/library/stdtypes.html#str "(in Python v3.13)")*, *count: [int](https://docs.python.org/3/library/functions.html#int "(in Python v3.13)") | [None](https://docs.python.org/3/library/constants.html#None "(in Python v3.13)") = None*) → [str](https://docs.python.org/3/library/stdtypes.html#str "(in Python v3.13)")
...
jinja-filters.reverse(*value: [str](https://docs.python.org/3/library/stdtypes.html#str "(in Python v3.13)") | Iterable[V]*) → [str](https://docs.python.org/3/library/stdtypes.html#str "(in Python v3.13)") | Iterable[V]
:   Reverse the object or return an iterator that iterates over it the other
    way round.

jinja-filters.round(*value: [float](https://docs.python.org/3/library/functions.html#float "(in Python v3.13)")*, *precision: [int](https://docs.python.org/3/library/functions.html#int "(in Python v3.13)") = 0*, *method: 'te.Literal["common", "ceil", "floor"]' = 'common'*) → [float](https://docs.python.org/3/library/functions.html#float "(in Python v3.13)")
...
jinja-filters.safe(*value: [str](https://docs.python.org/3/library/stdtypes.html#str "(in Python v3.13)")*) → markupsafe.Markup
...
jinja-filters.slice(*value: 't.Collection[V]'*, *slices: [int](https://docs.python.org/3/library/functions.html#int "(in Python v3.13)")*, *fill\_with: 't.Optional[V]' = None*) → 't.Iterator[t.List[V]]'
...
jinja-filters.sort(*value: 't.Iterable[V]'*, *reverse: [bool](https://docs.python.org/3/library/functions.html#bool "(in Python v3.13)") = False*, *case\_sensitive: [bool](https://docs.python.org/3/library/functions.html#bool "(in Python v3.13)") = False*, *attribute: [str](https://docs.python.org/3/library/stdtypes.html#str "(in Python v3.13)") | [int](https://docs.python.org/3/library/functions.html#int "(in Python v3.13)") | NoneType = None*) → 't.List[V]'
:   Sort an iterable using Python’s [`sorted()`](https://docs.python.org/3/library/functions.html#sorted "(in Python v3.13)").
    ...
    :   - **reverse** – Sort descending instead of ascending.
        - **case\_sensitive** – When sorting strings, sort upper and lower
          case separately.
    ...
    Changed in version 2.11.0: The `attribute` parameter can be a comma separated list of
...
:   Convert an object to a string if it isn’t already. This preserves
    a `Markup` string rather than converting it back to a basic
...
jinja-filters.striptags(*value: 't.Union[str, HasHTML]'*) → [str](https://docs.python.org/3/library/stdtypes.html#str "(in Python v3.13)")
:   Strip SGML/XML tags and replace adjacent whitespace by one space.

jinja-filters.sum(*iterable: 't.Iterable[V]'*, *attribute: [str](https://docs.python.org/3/library/stdtypes.html#str "(in Python v3.13)") | [int](https://docs.python.org/3/library/functions.html#int "(in Python v3.13)") | NoneType = None*, *start: V = 0*) → V
:   Returns the sum of a sequence of numbers plus the value of parameter
    ...
    Changed in version 2.6: The `attribute` parameter was added to allow summing up over
    attributes. Also the `start` parameter was moved on to the right.

jinja-filters.title(*s: [str](https://docs.python.org/3/library/stdtypes.html#str "(in Python v3.13)")*) → [str](https://docs.python.org/3/library/stdtypes.html#str "(in Python v3.13)")
:   Return a titlecased version of the value. I.e. words will start with
    uppercase letters, all remaining characters are lowercase.

jinja-filters.tojson(*value: Any*, *indent: [int](https://docs.python.org/3/library/functions.html#int "(in Python v3.13)") | [None](https://docs.python.org/3/library/constants.html#None "(in Python v3.13)") = None*) → markupsafe.Markup
:   Serialize an object to a string of JSON, and mark it safe to
    ...
    :   - **value** – The object to serialize to JSON.
        - **indent** – The `indent` parameter passed to `dumps`, for
...
jinja-filters.trim(*value: [str](https://docs.python.org/3/library/stdtypes.html#str "(in Python v3.13)")*, *chars: [str](https://docs.python.org/3/library/stdtypes.html#str "(in Python v3.13)") | [None](https://docs.python.org/3/library/constants.html#None "(in Python v3.13)") = None*) → [str](https://docs.python.org/3/library/stdtypes.html#str "(in Python v3.13)")
:   Strip leading and trailing characters, by default whitespace.

jinja-filters.truncate(*s: [str](https://docs.python.org/3/library/stdtypes.html#str "(in Python v3.13)")*, *length: [int](https://docs.python.org/3/library/functions.html#int "(in Python v3.13)") = 255*, *killwords: [bool](https://docs.python.org/3/library/functions.html#bool "(in Python v3.13)") = False*, *end: [str](https://docs.python.org/3/library/stdtypes.html#str "(in Python v3.13)") = '...'*, *leeway: [int](https://docs.python.org/3/library/functions.html#int "(in Python v3.13)") | [None](https://docs.python.org/3/library/constants.html#None "(in Python v3.13)") = None*) → [str](https://docs.python.org/3/library/stdtypes.html#str "(in Python v3.13)")
...
jinja-filters.unique(*value: 't.Iterable[V]'*, *case\_sensitive: [bool](https://docs.python.org/3/library/functions.html#bool "(in Python v3.13)") = False*, *attribute: [str](https://docs.python.org/3/library/stdtypes.html#str "(in Python v3.13)") | [int](https://docs.python.org/3/library/functions.html#int "(in Python v3.13)") | NoneType = None*) → 't.Iterator[V]'
...
jinja-filters.upper(*s: [str](https://docs.python.org/3/library/stdtypes.html#str "(in Python v3.13)")*) → [str](https://docs.python.org/3/library/stdtypes.html#str "(in Python v3.13)")
:   Convert a value to uppercase.

jinja-filters.urlencode(*value: [str](https://docs.python.org/3/library/stdtypes.html#str "(in Python v3.13)") | Mapping[[str](https://docs.python.org/3/library/stdtypes.html#str "(in Python v3.13)"), Any] | Iterable[[Tuple](../extensions/#jinja2.nodes.Tuple "jinja2.nodes.Tuple")[[str](https://docs.python.org/3/library/stdtypes.html#str "(in Python v3.13)"), Any]]*) → [str](https://docs.python.org/3/library/stdtypes.html#str "(in Python v3.13)")
:   Quote data for use in a URL path or query using UTF-8.

    Basic wrapper around [`urllib.parse.quote()`](https://docs.python.org/3/library/urllib.parse.html#urllib.parse.quote "(in Python v3.13)") when given a
    string, or [`urllib.parse.urlencode()`](https://docs.python.org/3/library/urllib.parse.html#urllib.parse.urlencode "(in Python v3.13)") for a dict or iterable.
...
jinja-filters.urlize(*value: [str](https://docs.python.org/3/library/stdtypes.html#str "(in Python v3.13)")*, *trim\_url\_limit: [int](https://docs.python.org/3/library/functions.html#int "(in Python v3.13)") | [None](https://docs.python.org/3/library/constants.html#None "(in Python v3.13)") = None*, *nofollow: [bool](https://docs.python.org/3/library/functions.html#bool "(in Python v3.13)") = False*, *target: [str](https://docs.python.org/3/library/stdtypes.html#str "(in Python v3.13)") | [None](https://docs.python.org/3/library/constants.html#None "(in Python v3.13)") = None*, *rel: [str](https://docs.python.org/3/library/stdtypes.html#str "(in Python v3.13)") | [None](https://docs.python.org/3/library/constants.html#None "(in Python v3.13)") = None*, *extra\_schemes: Iterable[[str](https://docs.python.org/3/library/stdtypes.html#str "(in Python v3.13)")] | [None](https://docs.python.org/3/library/constants.html#None "(in Python v3.13)") = None*) → [str](https://docs.python.org/3/library/stdtypes.html#str "(in Python v3.13)")
:   Convert URLs in text into clickable links.
    ...
    :   - **value** – Original text containing URLs to link.
        ...
        - **extra\_schemes** – Recognize URLs that start with these schemes
    ...
    Changed in version 3.0: The parsing rules were updated. Recognize email addresses with
    or without the `mailto:` scheme. Validate IP addresses. Ignore
    parentheses and brackets in more cases.

    Changed in version 2.8: The `target` parameter was added.

jinja-filters.wordcount(*s: [str](https://docs.python.org/3/library/stdtypes.html#str "(in Python v3.13)")*) → [int](https://docs.python.org/3/library/functions.html#int "(in Python v3.13)")
:   Count the words in that string.

jinja-filters.wordwrap(*s: [str](https://docs.python.org/3/library/stdtypes.html#str "(in Python v3.13)")*, *width: [int](https://docs.python.org/3/library/functions.html#int "(in Python v3.13)") = 79*, *break\_long\_words: [bool](https://docs.python.org/3/library/functions.html#bool "(in Python v3.13)") = True*, *wrapstring: [str](https://docs.python.org/3/library/stdtypes.html#str "(in Python v3.13)") | [None](https://docs.python.org/3/library/constants.html#None "(in Python v3.13)") = None*, *break\_on\_hyphens: [bool](https://docs.python.org/3/library/functions.html#bool "(in Python v3.13)") = True*) → [str](https://docs.python.org/3/library/stdtypes.html#str "(in Python v3.13)")
:   Wrap a string to the given width. Existing newlines are treated
    ...
    :   - **s** – Original text to wrap.
        ...
        - **break\_long\_words** – If a word is longer than `width`, break
          it across lines.
        - **break\_on\_hyphens** – If a word contains hyphens, it may be split
          across lines.
...
jinja-filters.xmlattr(*d: Mapping[[str](https://docs.python.org/3/library/stdtypes.html#str "(in Python v3.13)"), Any]*, *autospace: [bool](https://docs.python.org/3/library/functions.html#bool "(in Python v3.13)") = True*) → [str](https://docs.python.org/3/library/stdtypes.html#str "(in Python v3.13)")
:   Create an SGML/XML attribute string based on the items in a dict.
    ...
    **Values** that are neither `none` nor `undefined` are automatically
    ...
    Changed in version 3.1.4: Keys with `/` solidus, `>` greater-than sign, or `=` equals sign
    are not allowed.
...
jinja-tests.boolean(*value: Any*) → [bool](https://docs.python.org/3/library/functions.html#bool "(in Python v3.13)")
...
jinja-tests.defined(*value: Any*) → [bool](https://docs.python.org/3/library/functions.html#bool "(in Python v3.13)")
...
jinja-tests.divisibleby(*value: [int](https://docs.python.org/3/library/functions.html#int "(in Python v3.13)")*, *num: [int](https://docs.python.org/3/library/functions.html#int "(in Python v3.13)")*) → [bool](https://docs.python.org/3/library/functions.html#bool "(in Python v3.13)")
...
jinja-tests.escaped(*value: Any*) → [bool](https://docs.python.org/3/library/functions.html#bool "(in Python v3.13)")
:   Check if the value is escaped.

jinja-tests.even(*value: [int](https://docs.python.org/3/library/functions.html#int "(in Python v3.13)")*) → [bool](https://docs.python.org/3/library/functions.html#bool "(in Python v3.13)")
:   Return true if the variable is even.

jinja-tests.false(*value: Any*) → [bool](https://docs.python.org/3/library/functions.html#bool "(in Python v3.13)")
...
jinja-tests.filter(*value: [str](https://docs.python.org/3/library/stdtypes.html#str "(in Python v3.13)")*) → [bool](https://docs.python.org/3/library/functions.html#bool "(in Python v3.13)")
...
jinja-tests.float(*value: Any*) → [bool](https://docs.python.org/3/library/functions.html#bool "(in Python v3.13)")
...
jinja-tests.in(*value: Any*, *seq: Container[Any]*) → [bool](https://docs.python.org/3/library/functions.html#bool "(in Python v3.13)")
...
jinja-tests.integer(*value: Any*) → [bool](https://docs.python.org/3/library/functions.html#bool "(in Python v3.13)")
...
jinja-tests.iterable(*value: Any*) → [bool](https://docs.python.org/3/library/functions.html#bool "(in Python v3.13)")
...
jinja-tests.lower(*value: [str](https://docs.python.org/3/library/stdtypes.html#str "(in Python v3.13)")*) → [bool](https://docs.python.org/3/library/functions.html#bool "(in Python v3.13)")
...
jinja-tests.mapping(*value: Any*) → [bool](https://docs.python.org/3/library/functions.html#bool "(in Python v3.13)")
...
jinja-tests.none(*value: Any*) → [bool](https://docs.python.org/3/library/functions.html#bool "(in Python v3.13)")
:   Return true if the variable is none.

jinja-tests.number(*value: Any*) → [bool](https://docs.python.org/3/library/functions.html#bool "(in Python v3.13)")
:   Return true if the variable is a number.

jinja-tests.odd(*value: [int](https://docs.python.org/3/library/functions.html#int "(in Python v3.13)")*) → [bool](https://docs.python.org/3/library/functions.html#bool "(in Python v3.13)")
:   Return true if the variable is odd.

jinja-tests.sameas(*value: Any*, *other: Any*) → [bool](https://docs.python.org/3/library/functions.html#bool "(in Python v3.13)")
...
jinja-tests.sequence(*value: Any*) → [bool](https://docs.python.org/3/library/functions.html#bool "(in Python v3.13)")
:   Return true if the variable is a sequence. Sequences are variables
    that are iterable.

jinja-tests.string(*value: Any*) → [bool](https://docs.python.org/3/library/functions.html#bool "(in Python v3.13)")
:   Return true if the object is a string.

jinja-tests.test(*value: [str](https://docs.python.org/3/library/stdtypes.html#str "(in Python v3.13)")*) → [bool](https://docs.python.org/3/library/functions.html#bool "(in Python v3.13)")
...
jinja-tests.true(*value: Any*) → [bool](https://docs.python.org/3/library/functions.html#bool "(in Python v3.13)")
...
jinja-tests.undefined(*value: Any*) → [bool](https://docs.python.org/3/library/functions.html#bool "(in Python v3.13)")
:   Like [`defined()`](#jinja-tests.defined "jinja-tests.defined") but the other way round.

jinja-tests.upper(*value: [str](https://docs.python.org/3/library/stdtypes.html#str "(in Python v3.13)")*) → [bool](https://docs.python.org/3/library/functions.html#bool "(in Python v3.13)")
...
:   Cycle through values by yielding them one at a time, then restarting
    ...
    *property* current
    :   Return the current item. Equivalent to the item that will be
        returned next time [`next()`](#jinja-globals.cycler.next "jinja-globals.cycler.next") is called.

    next()
    :   Return the current item, then advance [`current`](#jinja-globals.cycler.current "jinja-globals.cycler.current") to the
        next item.
...
be a separate document explaining said [extensions](../extensions/#jinja-extensions).

### i18n

If the [i18n Extension](../extensions/#i18n-extension) is enabled, it’s possible to mark text in
...
Added in version 3.1: A context can be passed to the `trans` tag to use `pgettext` and
`npgettext`.
...
If [New Style Gettext](../extensions/#newstyle-gettext) calls are activated, using placeholders is
...
If the application enables the [Loop Controls](../extensions/#loopcontrols-extension), it’s possible to
...
If the [Debug Extension](../extensions/#debug-extension) is enabled, a `{% debug %}` tag will be
