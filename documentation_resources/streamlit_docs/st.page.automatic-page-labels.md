<!-- Source: https://docs.streamlit.io/st.page.automatic-page-labels -->
...
[*arrow\_back*Previous: Multipage apps](/develop/concepts/multipage-apps)[*arrow\_forward*Next: Page and navigation](/develop/concepts/multipage-apps/page-and-navigation)
