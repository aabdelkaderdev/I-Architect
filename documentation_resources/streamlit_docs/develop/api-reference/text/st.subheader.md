...
| Function signature[[source]](https://github.com/streamlit/streamlit/blob/1.55.0/lib/streamlit/elements/heading.py#L149 "View st.subheader source code on GitHub") | |
| --- | --- |
