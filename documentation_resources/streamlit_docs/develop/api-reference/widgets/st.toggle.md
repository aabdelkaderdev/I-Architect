...
| Function signature[[source]](https://github.com/streamlit/streamlit/blob/1.55.0/lib/streamlit/elements/widgets/checkbox.py#L218 "View st.toggle source code on GitHub") | |
| --- | --- |
| st.toggle(label, value=False, key=None, help=None, on\_change=None, args=None, kwargs=None, \*, disabled=False, label\_visibility="visible", width="content", bind=None) | |
| Parameters | |
