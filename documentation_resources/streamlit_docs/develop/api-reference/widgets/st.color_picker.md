...
| Function signature[[source]](https://github.com/streamlit/streamlit/blob/1.55.0/lib/streamlit/elements/widgets/color_picker.py#L85 "View st.color_picker source code on GitHub") | |
| --- | --- |
| st.color\_picker(label, value=None, key=None, help=None, on\_change=None, args=None, kwargs=None, \*, disabled=False, label\_visibility="visible", width="content", bind=None) | |
| Parameters | |
