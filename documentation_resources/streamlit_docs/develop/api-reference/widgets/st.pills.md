...
| Function signature[[source]](https://github.com/streamlit/streamlit/blob/1.55.0/lib/streamlit/elements/widgets/button_group.py#L312 "View st.pills source code on GitHub") | |
| --- | --- |
| st.pills(label, options, \*, selection\_mode="single", default=None, format\_func=None, key=None, help=None, on\_change=None, args=None, kwargs=None, disabled=False, label\_visibility="visible", width="content", bind=None) | |
| Parameters | |
