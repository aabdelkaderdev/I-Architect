...
| Function signature[[source]](https://github.com/streamlit/streamlit/blob/1.55.0/lib/streamlit/elements/lib/column_types.py#L1156 "View st.BarChartColumn source code on GitHub") | |
| --- | --- |
| st.column\_config.BarChartColumn(label=None, \*, width=None, help=None, pinned=None, y\_min=None, y\_max=None, color=None) | |
| Parameters | |
...
[*arrow\_back*Previous: Line chart column](/develop/api-reference/data/st.column_config/st.column_config.linechartcolumn)[*arrow\_forward*Next: Progress column](/develop/api-reference/data/st.column_config/st.column_config.progresscolumn)
