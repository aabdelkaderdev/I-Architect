...
| Function signature[[source]](https://github.com/streamlit/streamlit/blob/1.55.0/lib/streamlit/elements/lib/column_types.py#L1276 "View st.LineChartColumn source code on GitHub") | |
| --- | --- |
| st.column\_config.LineChartColumn(label=None, \*, width=None, help=None, pinned=None, y\_min=None, y\_max=None, color=None) | |
| Parameters | |
...
[*arrow\_back*Previous: Area chart column](/develop/api-reference/data/st.column_config/st.column_config.areachartcolumn)[*arrow\_forward*Next: Bar chart column](/develop/api-reference/data/st.column_config/st.column_config.barchartcolumn)
