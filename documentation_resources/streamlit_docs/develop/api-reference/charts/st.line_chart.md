...
| Function signature[[source]](https://github.com/streamlit/streamlit/blob/1.55.0/lib/streamlit/elements/vega_charts.py#L677 "View st.line_chart source code on GitHub") | |
| --- | --- |
