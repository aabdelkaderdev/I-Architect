...
3. Search for or follow the link to [Nunito](https://fonts.google.com/specimen/Nunito), and select "**Get font**."
...
5. On the right, in the first code block, copy the `href` URL from the third link, and paste it into your text editor.
   ...
   ```
6. To remove Nunito from your list and get a clean URL for Space Mono, select the trash can (*delete*). Then, repeat the previous three steps for [Space Mono](https://fonts.google.com/specimen/Space+Mono).
   ...
   ```
7. In your text editor, modify each URL by prepending its font family and a colon separator:
...
[*arrow\_back*Previous: Configuration and theming](/develop/tutorials/configuration-and-theming)[*arrow\_forward*Next: Use external font files (streamlit<1.50.0)](/develop/tutorials/configuration-and-theming/external-fonts-old)
