<!-- Source: https://docs.streamlit.io/develop/tutorials/custom-components/template-typescript -->
...
[*arrow\_back*Previous: Build custom components](/develop/tutorials/custom-components)[*arrow\_forward*Next: Create a component with React + TypeScript](/develop/tutorials/custom-components/template-react)
