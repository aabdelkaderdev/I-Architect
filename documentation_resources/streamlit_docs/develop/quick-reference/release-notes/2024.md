...
- You can use `:streamlit:` to render the Streamlit logo in [Markdown](/develop/api-reference/text/st.markdown).
...
[*arrow\_back*Previous: 2025](/develop/quick-reference/release-notes/2025)[*arrow\_forward*Next: 2023](/develop/quick-reference/release-notes/2023)
