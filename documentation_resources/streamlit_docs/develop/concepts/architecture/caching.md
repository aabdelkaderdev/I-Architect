...
[*arrow\_back*Previous: The app chrome](/develop/concepts/architecture/app-chrome)[*arrow\_forward*Next: Session State](/develop/concepts/architecture/session-state)
