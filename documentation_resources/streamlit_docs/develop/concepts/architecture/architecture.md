...
[*arrow\_back*Previous: Running your app](/develop/concepts/architecture/run-your-app)[*arrow\_forward*Next: The app chrome](/develop/concepts/architecture/app-chrome)
