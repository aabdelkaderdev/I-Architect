<!-- Source: https://docs.streamlit.io/develop/concepts/custom-components/components-v1/create -->
...
[*arrow\_back*Previous: Intro to v1 components](/develop/concepts/custom-components/components-v1/intro)[*arrow\_forward*Next: Limitations](/develop/concepts/custom-components/components-v1/limitations)
