<!-- Source: https://docs.streamlit.io/develop/concepts/custom-components/components-v2/mount -->
...
[*arrow\_back*Previous: Registration](/develop/concepts/custom-components/components-v2/register)[*arrow\_forward*Next: State vs trigger values](/develop/concepts/custom-components/components-v2/state-and-triggers)
