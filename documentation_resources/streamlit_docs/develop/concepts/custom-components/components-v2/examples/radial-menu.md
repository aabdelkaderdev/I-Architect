<!-- Source: https://docs.streamlit.io/develop/concepts/custom-components/components-v2/examples/radial-menu -->
...
[*arrow\_back*Previous: Danger button](/develop/concepts/custom-components/components-v2/examples/danger-button)[*arrow\_forward*Next: Registration](/develop/concepts/custom-components/components-v2/register)
