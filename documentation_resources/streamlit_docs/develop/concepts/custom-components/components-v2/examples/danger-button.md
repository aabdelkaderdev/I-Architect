<!-- Source: https://docs.streamlit.io/develop/concepts/custom-components/components-v2/examples/danger-button -->
...
[*arrow\_back*Previous: Text input](/develop/concepts/custom-components/components-v2/examples/text-input)[*arrow\_forward*Next: Radial menu](/develop/concepts/custom-components/components-v2/examples/radial-menu)
