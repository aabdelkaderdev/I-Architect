<!-- Source: https://docs.streamlit.io/develop/concepts/custom-components/components-v2/examples/interactive-counter -->
...
[*arrow\_back*Previous: Simple checkbox](/develop/concepts/custom-components/components-v2/examples/simple-checkbox)[*arrow\_forward*Next: Text input](/develop/concepts/custom-components/components-v2/examples/text-input)
