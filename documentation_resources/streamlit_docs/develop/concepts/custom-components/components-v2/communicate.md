<!-- Source: https://docs.streamlit.io/develop/concepts/custom-components/components-v2/communicate -->
...
[*arrow\_back*Previous: State vs trigger values](/develop/concepts/custom-components/components-v2/state-and-triggers)[*arrow\_forward*Next: Theming and styling](/develop/concepts/custom-components/components-v2/theming)
