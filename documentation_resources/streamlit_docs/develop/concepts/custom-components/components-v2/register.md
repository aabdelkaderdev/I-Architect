<!-- Source: https://docs.streamlit.io/develop/concepts/custom-components/components-v2/register -->
...
[*arrow\_back*Previous: Quickstart examples](/develop/concepts/custom-components/components-v2/examples)[*arrow\_forward*Next: Mounting](/develop/concepts/custom-components/components-v2/mount)
