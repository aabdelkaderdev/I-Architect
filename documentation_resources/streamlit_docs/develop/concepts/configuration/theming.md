...
[*arrow\_back*Previous: Serving static files](/develop/concepts/configuration/serving-static-files)[*arrow\_forward*Next: Customize colors and borders](/develop/concepts/configuration/theming-customize-colors-and-borders)
