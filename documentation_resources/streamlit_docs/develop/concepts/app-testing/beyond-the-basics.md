...
[*arrow\_back*Previous: Get started](/develop/concepts/app-testing/get-started)[*arrow\_forward*Next: Automate your tests](/develop/concepts/app-testing/automate-tests)
