<!-- Source: https://reference.langchain.com/python/langchain-classic/memory/chat_message_histories/cassandra -->
...
DEPRECATED\_LOOKUP: dict](/python/langchain-classic/memory/chat_message_histories/cassandra/DEPRECATED_LOOKUP)
