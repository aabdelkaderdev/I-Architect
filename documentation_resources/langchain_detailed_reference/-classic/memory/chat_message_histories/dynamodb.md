<!-- Source: https://reference.langchain.com/python/langchain-classic/memory/chat_message_histories/dynamodb -->
...
DEPRECATED\_LOOKUP: dict](/python/langchain-classic/memory/chat_message_histories/dynamodb/DEPRECATED_LOOKUP)
