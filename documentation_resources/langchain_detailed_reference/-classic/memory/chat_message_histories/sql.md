<!-- Source: https://reference.langchain.com/python/langchain-classic/memory/chat_message_histories/sql -->
...
DEPRECATED\_LOOKUP: dict](/python/langchain-classic/memory/chat_message_histories/sql/DEPRECATED_LOOKUP)
