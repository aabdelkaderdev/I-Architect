<!-- Source: https://reference.langchain.com/python/langchain-classic/memory/chat_message_histories/xata -->
...
DEPRECATED\_LOOKUP: dict](/python/langchain-classic/memory/chat_message_histories/xata/DEPRECATED_LOOKUP)
