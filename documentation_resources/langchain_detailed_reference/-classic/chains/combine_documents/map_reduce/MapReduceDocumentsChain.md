<!-- Source: https://reference.langchain.com/python/langchain-classic/chains/combine_documents/map_reduce/MapReduceDocumentsChain -->
...
Chain to apply to each document individually.](/python/langchain-classic/chains/combine_documents/map_reduce/MapReduceDocumentsChain/llm_chain)

[attribute

reduce\_documents\_chain: BaseCombineDocumentsChain

Chain to use to reduce the results of applying `llm_chain` to each doc.
This typically either a ReduceDocumentChain or StuffDocumentChain.](/python/langchain-classic/chains/combine_documents/map_reduce/MapReduceDocumentsChain/reduce_documents_chain)
...
If only one variable in the llm\_chain, this need not be provided.](/python/langchain-classic/chains/combine_documents/map_reduce/MapReduceDocumentsChain/document_variable_name)

[attribute

return\_intermediate\_steps: bool

Return the results of the map steps in the output.](/python/langchain-classic/chains/combine_documents/map_reduce/MapReduceDocumentsChain/return_intermediate_steps)

[attribute

output\_keys: list[str]

Expect input key.](/python/langchain-classic/chains/combine_documents/map_reduce/MapReduceDocumentsChain/output_keys)

[attribute

model\_config](/python/langchain-classic/chains/combine_documents/map_reduce/MapReduceDocumentsChain/model_config)

[attribute

collapse\_document\_chain: BaseCombineDocumentsChain

Kept for backward compatibility.](/python/langchain-classic/chains/combine_documents/map_reduce/MapReduceDocumentsChain/collapse_document_chain)

[attribute

combine\_document\_chain: BaseCombineDocumentsChain

Kept for backward compatibility.](/python/langchain-classic/chains/combine_documents/map_reduce/MapReduceDocumentsChain/combine_document_chain)

[method

get\_output\_schema](/python/langchain-classic/chains/combine_documents/map_reduce/MapReduceDocumentsChain/get_output_schema)

[method

get\_reduce\_chain

For backwards compatibility.](/python/langchain-classic/chains/combine_documents/map_reduce/MapReduceDocumentsChain/get_reduce_chain)

[method

get\_return\_intermediate\_steps

For backwards compatibility.](/python/langchain-classic/chains/combine_documents/map_reduce/MapReduceDocumentsChain/get_return_intermediate_steps)

[method

get\_default\_document\_variable\_name

Get default document variable name, if not provided.](/python/langchain-classic/chains/combine_documents/map_reduce/MapReduceDocumentsChain/get_default_document_variable_name)
...
This reducing can be done recursively if needed (if there are many documents).](/python/langchain-classic/chains/combine_documents/map_reduce/MapReduceDocumentsChain/combine_docs)
...
Combine by mapping first chain over all documents, then reducing the results.
This reducing can be done recursively if needed (if there are many documents).](/python/langchain-classic/chains/combine_documents/map_reduce/MapReduceDocumentsChain/acombine_docs)
