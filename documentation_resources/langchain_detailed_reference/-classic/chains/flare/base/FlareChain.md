<!-- Source: https://reference.langchain.com/python/langchain-classic/chains/flare/base/FlareChain -->
...
question\_generator\_chain: Runnable

Chain that generates questions from uncertain spans.](/python/langchain-classic/chains/flare/base/FlareChain/question_generator_chain)

[attribute

response\_chain: Runnable

Chain that generates responses from user input and context.](/python/langchain-classic/chains/flare/base/FlareChain/response_chain)

[attribute

output\_parser: FinishedOutputParser

Parser that determines whether the chain is finished.](/python/langchain-classic/chains/flare/base/FlareChain/output_parser)

[attribute

retriever: BaseRetriever

Retriever that retrieves relevant documents from a user input.](/python/langchain-classic/chains/flare/base/FlareChain/retriever)

[attribute

min\_prob: float

Minimum probability for a token to be considered low confidence.](/python/langchain-classic/chains/flare/base/FlareChain/min_prob)

[attribute

min\_token\_gap: int

Minimum number of tokens between two low confidence spans.](/python/langchain-classic/chains/flare/base/FlareChain/min_token_gap)

[attribute

num\_pad\_tokens: int

Number of tokens to pad around a low confidence span.](/python/langchain-classic/chains/flare/base/FlareChain/num_pad_tokens)

[attribute

max\_iter: int

Maximum number of iterations.](/python/langchain-classic/chains/flare/base/FlareChain/max_iter)

[attribute

start\_with\_retrieval: bool

Whether to start with retrieval.](/python/langchain-classic/chains/flare/base/FlareChain/start_with_retrieval)

[attribute

input\_keys: list[str]

Input keys for the chain.](/python/langchain-classic/chains/flare/base/FlareChain/input_keys)

[attribute

output\_keys: list[str]

Output keys for the chain.](/python/langchain-classic/chains/flare/base/FlareChain/output_keys)

[method

from\_llm

Creates a FlareChain from a language model.](/python/langchain-classic/chains/flare/base/FlareChain/from_llm)
