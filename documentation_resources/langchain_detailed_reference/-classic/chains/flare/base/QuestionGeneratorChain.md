<!-- Source: https://reference.langchain.com/python/langchain-classic/chains/flare/base/QuestionGeneratorChain -->
...
Output parser to use.](/python/langchain-classic/chains/llm/LLMChain/output_parser)[A](/python/langchain-classic/chains/llm/LLMChain/return_final_only)
...
[Amodel\_config](/python/langchain-classic/chains/llm/LLMChain/model_config)
...
Prompt template for the chain.](/python/langchain-classic/chains/flare/base/QuestionGeneratorChain/prompt)

[attribute

input\_keys: list[str]

Input keys for the chain.](/python/langchain-classic/chains/flare/base/QuestionGeneratorChain/input_keys)

[method

is\_lc\_serializable](/python/langchain-classic/chains/flare/base/QuestionGeneratorChain/is_lc_serializable)
