<!-- Source: https://reference.langchain.com/python/langchain-classic/chains/qa_generation/base/QAGenerationChain -->
...
LLM Chain that generates responses from user input and context.](/python/langchain-classic/chains/qa_generation/base/QAGenerationChain/llm_chain)

[attribute

text\_splitter: TextSplitter

Text splitter that splits the input into chunks.](/python/langchain-classic/chains/qa_generation/base/QAGenerationChain/text_splitter)

[attribute

input\_key: str

Key of the input to the chain.](/python/langchain-classic/chains/qa_generation/base/QAGenerationChain/input_key)

[attribute

output\_key: str

Key of the output of the chain.](/python/langchain-classic/chains/qa_generation/base/QAGenerationChain/output_key)

[attribute

k: int | None

Number of questions to generate.](/python/langchain-classic/chains/qa_generation/base/QAGenerationChain/k)

[attribute

input\_keys: list[str]](/python/langchain-classic/chains/qa_generation/base/QAGenerationChain/input_keys)

[attribute

output\_keys: list[str]](/python/langchain-classic/chains/qa_generation/base/QAGenerationChain/output_keys)

[method

from\_llm

Create a QAGenerationChain from a language model.](/python/langchain-classic/chains/qa_generation/base/QAGenerationChain/from_llm)
