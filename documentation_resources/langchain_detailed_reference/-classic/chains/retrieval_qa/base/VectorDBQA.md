<!-- Source: https://reference.langchain.com/python/langchain-classic/chains/retrieval_qa/base/VectorDBQA -->
...
## Inherited from[BaseRetrievalQA](/python/langchain-classic/chains/retrieval_qa/base/BaseRetrievalQA)
...
Chain to use to combine the documents.](/python/langchain-classic/chains/retrieval_qa/base/BaseRetrievalQA/combine_documents_chain)[Ainput\_key: str](/python/langchain-classic/chains/retrieval_qa/base/BaseRetrievalQA/input_key)[Aoutput\_key: str](/python/langchain-classic/chains/retrieval_qa/base/BaseRetrievalQA/output_key)[A](/python/langchain-classic/chains/retrieval_qa/base/BaseRetrievalQA/return_source_documents)



return\_source\_documents
...
[Amodel\_config](/python/langchain-classic/chains/retrieval_qa/base/BaseRetrievalQA/model_config)

[Ainput\_keys: list[str]

—

Input keys.](/python/langchain-classic/chains/retrieval_qa/base/BaseRetrievalQA/input_keys)

[Aoutput\_keys: list[str]

—

Output keys.](/python/langchain-classic/chains/retrieval_qa/base/BaseRetrievalQA/output_keys)
...
Initialize from LLM.](/python/langchain-classic/chains/retrieval_qa/base/BaseRetrievalQA/from_llm)[Mfrom\_chain\_type

—

Load chain from chain type.](/python/langchain-classic/chains/retrieval_qa/base/BaseRetrievalQA/from_chain_type)
...
Vector Database to connect to.](/python/langchain-classic/chains/retrieval_qa/base/VectorDBQA/vectorstore)

[attribute

k: int

Number of documents to query for.](/python/langchain-classic/chains/retrieval_qa/base/VectorDBQA/k)

[attribute

search\_type: str

Search type to use over vectorstore. `similarity` or `mmr`.](/python/langchain-classic/chains/retrieval_qa/base/VectorDBQA/search_type)

[attribute

search\_kwargs: dict[str, Any]

Extra search args.](/python/langchain-classic/chains/retrieval_qa/base/VectorDBQA/search_kwargs)

[method

validate\_search\_type

Validate search type.](/python/langchain-classic/chains/retrieval_qa/base/VectorDBQA/validate_search_type)
