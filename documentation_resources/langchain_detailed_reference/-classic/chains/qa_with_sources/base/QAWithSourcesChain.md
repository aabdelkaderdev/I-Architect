<!-- Source: https://reference.langchain.com/python/langchain-classic/chains/qa_with_sources/base/QAWithSourcesChain -->
...
Chain to use to combine documents.](/python/langchain-classic/chains/qa_with_sources/base/BaseQAWithSourcesChain/combine_documents_chain)[Aquestion\_key: str](/python/langchain-classic/chains/qa_with_sources/base/BaseQAWithSourcesChain/question_key)[Aanswer\_key: str](/python/langchain-classic/chains/qa_with_sources/base/BaseQAWithSourcesChain/answer_key)[A](/python/langchain-classic/chains/qa_with_sources/base/BaseQAWithSourcesChain/sources_answer_key)



sources\_answer\_key
...
[DEPRECATED] Use `callbacks` instead.](/python/langchain-classic/chains/base/Chain/callback_manager)[Amodel\_config](/python/langchain-classic/chains/base/Chain/model_config)[Aoutput\_keys: list[str]
...
input\_docs\_key: str](/python/langchain-classic/chains/qa_with_sources/base/QAWithSourcesChain/input_docs_key)

[attribute

input\_keys: list[str]

Expect input key.](/python/langchain-classic/chains/qa_with_sources/base/QAWithSourcesChain/input_keys)
