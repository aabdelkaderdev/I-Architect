<!-- Source: https://reference.langchain.com/python/langchain-classic/chains/qa_with_sources/vector_db/VectorDBQAWithSourcesChain -->
...
## Inherited from[BaseQAWithSourcesChain](/python/langchain-classic/chains/qa_with_sources/base/BaseQAWithSourcesChain)

### Attributes

[Acombine\_documents\_chain: BaseCombineDocumentsChain

—

Chain to use to combine documents.](/python/langchain-classic/chains/qa_with_sources/base/BaseQAWithSourcesChain/combine_documents_chain)[Aquestion\_key: str](/python/langchain-classic/chains/qa_with_sources/base/BaseQAWithSourcesChain/question_key)[Ainput\_docs\_key: str](/python/langchain-classic/chains/qa_with_sources/base/BaseQAWithSourcesChain/input_docs_key)[A](/python/langchain-classic/chains/qa_with_sources/base/BaseQAWithSourcesChain/answer_key)
...
[Asources\_answer\_key: str](/python/langchain-classic/chains/qa_with_sources/base/BaseQAWithSourcesChain/sources_answer_key)

[Areturn\_source\_documents: bool

—

Return the source documents.](/python/langchain-classic/chains/qa_with_sources/base/BaseQAWithSourcesChain/return_source_documents)

[Amodel\_config](/python/langchain-classic/chains/qa_with_sources/base/BaseQAWithSourcesChain/model_config)

[Ainput\_keys: list[str]

—

Expect input key.](/python/langchain-classic/chains/qa_with_sources/base/BaseQAWithSourcesChain/input_keys)

[Aoutput\_keys: list[str]

—

Return output key.](/python/langchain-classic/chains/qa_with_sources/base/BaseQAWithSourcesChain/output_keys)
...
Construct the chain from an LLM.](/python/langchain-classic/chains/qa_with_sources/base/BaseQAWithSourcesChain/from_llm)[Mfrom\_chain\_type

—

Load chain from chain type.](/python/langchain-classic/chains/qa_with_sources/base/BaseQAWithSourcesChain/from_chain_type)[Mvalidate\_naming

—

Fix backwards compatibility in naming.](/python/langchain-classic/chains/qa_with_sources/base/BaseQAWithSourcesChain/validate_naming)
...
Vector Database to connect to.](/python/langchain-classic/chains/qa_with_sources/vector_db/VectorDBQAWithSourcesChain/vectorstore)

[attribute

k: int

Number of results to return from store](/python/langchain-classic/chains/qa_with_sources/vector_db/VectorDBQAWithSourcesChain/k)

[attribute

reduce\_k\_below\_max\_tokens: bool

Reduce the number of results to return from store based on tokens limit](/python/langchain-classic/chains/qa_with_sources/vector_db/VectorDBQAWithSourcesChain/reduce_k_below_max_tokens)

[attribute

max\_tokens\_limit: int

Restrict the docs to return from store based on tokens,
enforced only for StuffDocumentChain and if reduce\_k\_below\_max\_tokens is to true](/python/langchain-classic/chains/qa_with_sources/vector_db/VectorDBQAWithSourcesChain/max_tokens_limit)

[attribute

search\_kwargs: dict[str, Any]

Extra search args.](/python/langchain-classic/chains/qa_with_sources/vector_db/VectorDBQAWithSourcesChain/search_kwargs)
