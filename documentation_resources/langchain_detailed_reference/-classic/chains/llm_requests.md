<!-- Source: https://reference.langchain.com/python/langchain-classic/chains/llm_requests -->
...
DEPRECATED\_LOOKUP: dict](/python/langchain-classic/chains/llm_requests/DEPRECATED_LOOKUP)
