<!-- Source: https://reference.langchain.com/python/langchain-classic/chains/router/multi_retrieval_qa/MultiRetrievalQAChain -->
...
router\_chain: LLMRouterChain

Chain for deciding a destination chain and the input to it.](/python/langchain-classic/chains/router/multi_retrieval_qa/MultiRetrievalQAChain/router_chain)

[attribute

destination\_chains: Mapping[str, BaseRetrievalQA]

Map of name to candidate chains that inputs can be routed to.](/python/langchain-classic/chains/router/multi_retrieval_qa/MultiRetrievalQAChain/destination_chains)

[attribute

default\_chain: Chain

Default chain to use when router doesn't map input to one of the destinations.](/python/langchain-classic/chains/router/multi_retrieval_qa/MultiRetrievalQAChain/default_chain)

[attribute

output\_keys: list[str]](/python/langchain-classic/chains/router/multi_retrieval_qa/MultiRetrievalQAChain/output_keys)

[method

from\_retrievers

Create a multi retrieval qa chain from an LLM and a default chain.](/python/langchain-classic/chains/router/multi_retrieval_qa/MultiRetrievalQAChain/from_retrievers)
