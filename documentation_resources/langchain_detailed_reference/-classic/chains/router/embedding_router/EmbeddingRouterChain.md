<!-- Source: https://reference.langchain.com/python/langchain-classic/chains/router/embedding_router/EmbeddingRouterChain -->
...
## Inherited from[RouterChain](/python/langchain-classic/chains/router/base/RouterChain)

### Attributes

[Aoutput\_keys: list[str]](/python/langchain-classic/chains/router/base/RouterChain/output_keys)
...
Route inputs to a destination chain.](/python/langchain-classic/chains/router/base/RouterChain/route)[Maroute

—

Route inputs to a destination chain.](/python/langchain-classic/chains/router/base/RouterChain/aroute)
...
vectorstore: VectorStore](/python/langchain-classic/chains/router/embedding_router/EmbeddingRouterChain/vectorstore)

[attribute

routing\_keys: list[str]](/python/langchain-classic/chains/router/embedding_router/EmbeddingRouterChain/routing_keys)

[attribute

model\_config](/python/langchain-classic/chains/router/embedding_router/EmbeddingRouterChain/model_config)

[attribute

input\_keys: list[str]

Will be whatever keys the LLM chain prompt expects.](/python/langchain-classic/chains/router/embedding_router/EmbeddingRouterChain/input_keys)

[method

from\_names\_and\_descriptions

Convenience constructor.](/python/langchain-classic/chains/router/embedding_router/EmbeddingRouterChain/from_names_and_descriptions)

[method

afrom\_names\_and\_descriptions

Convenience constructor.](/python/langchain-classic/chains/router/embedding_router/EmbeddingRouterChain/afrom_names_and_descriptions)
