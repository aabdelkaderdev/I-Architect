<!-- Source: https://reference.langchain.com/python/langchain-classic/chains/router/base/RouterChain -->
...
output\_keys: list[str]](/python/langchain-classic/chains/router/base/RouterChain/output_keys)

[method

route

Route inputs to a destination chain.](/python/langchain-classic/chains/router/base/RouterChain/route)
