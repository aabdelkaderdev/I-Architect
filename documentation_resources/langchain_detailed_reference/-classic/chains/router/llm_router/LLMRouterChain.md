<!-- Source: https://reference.langchain.com/python/langchain-classic/chains/router/llm_router/LLMRouterChain -->
...
llm\_chain: LLMChain](/python/langchain-classic/chains/router/llm_router/LLMRouterChain/llm_chain)[attribute

input\_keys: list[str]](/python/langchain-classic/chains/router/llm_router/LLMRouterChain/input_keys)

## Methods

[method

from\_llm](/python/langchain-classic/chains/router/llm_router/LLMRouterChain/from_llm)
...
Optional list of tags associated with the chain.](/python/langchain-classic/chains/base/Chain/tags)
