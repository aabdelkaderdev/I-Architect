<!-- Source: https://reference.langchain.com/python/langchain-classic/chains/router/llm_router/RouterOutputParser -->
...
default\_destination: str](/python/langchain-classic/chains/router/llm_router/RouterOutputParser/default_destination)

[attribute

next\_inputs\_type: type](/python/langchain-classic/chains/router/llm_router/RouterOutputParser/next_inputs_type)

[attribute

next\_inputs\_inner\_key: str](/python/langchain-classic/chains/router/llm_router/RouterOutputParser/next_inputs_inner_key)

[method

parse](/python/langchain-classic/chains/router/llm_router/RouterOutputParser/parse)
