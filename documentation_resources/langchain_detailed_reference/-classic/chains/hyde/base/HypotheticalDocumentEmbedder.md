<!-- Source: https://reference.langchain.com/python/langchain-classic/chains/hyde/base/HypotheticalDocumentEmbedder -->
...
[Maembed\_documents](/python/langchain-core/embeddings/embeddings/Embeddings/aembed_documents)[Maembed\_query](/python/langchain-core/embeddings/embeddings/Embeddings/aembed_query)
...
base\_embeddings: Embeddings](/python/langchain-classic/chains/hyde/base/HypotheticalDocumentEmbedder/base_embeddings)

[attribute

llm\_chain: Runnable](/python/langchain-classic/chains/hyde/base/HypotheticalDocumentEmbedder/llm_chain)

[attribute

model\_config](/python/langchain-classic/chains/hyde/base/HypotheticalDocumentEmbedder/model_config)

[attribute

input\_keys: list[str]

Input keys for Hyde's LLM chain.](/python/langchain-classic/chains/hyde/base/HypotheticalDocumentEmbedder/input_keys)

[attribute

output\_keys: list[str]

Output keys for Hyde's LLM chain.](/python/langchain-classic/chains/hyde/base/HypotheticalDocumentEmbedder/output_keys)

[method

embed\_documents

Call the base embeddings.](/python/langchain-classic/chains/hyde/base/HypotheticalDocumentEmbedder/embed_documents)

[method

combine\_embeddings

Combine embeddings into final embeddings.](/python/langchain-classic/chains/hyde/base/HypotheticalDocumentEmbedder/combine_embeddings)

[method

embed\_query

Generate a hypothetical document and embedded it.](/python/langchain-classic/chains/hyde/base/HypotheticalDocumentEmbedder/embed_query)

[method

from\_llm

Load and use LLMChain with either a specific prompt key or custom prompt.](/python/langchain-classic/chains/hyde/base/HypotheticalDocumentEmbedder/from_llm)
