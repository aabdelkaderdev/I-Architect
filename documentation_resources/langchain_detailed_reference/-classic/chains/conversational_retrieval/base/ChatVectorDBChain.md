<!-- Source: https://reference.langchain.com/python/langchain-classic/chains/conversational_retrieval/base/ChatVectorDBChain -->
...
## Inherited from[BaseConversationalRetrievalChain](/python/langchain-classic/chains/conversational_retrieval/base/BaseConversationalRetrievalChain)

### Attributes

[Acombine\_docs\_chain: BaseCombineDocumentsChain

—

The chain used to combine any retrieved documents.](/python/langchain-classic/chains/conversational_retrieval/base/BaseConversationalRetrievalChain/combine_docs_chain)[Aquestion\_generator: LLMChain

—

The chain used to generate a new question for the sake of retrieval.](/python/langchain-classic/chains/conversational_retrieval/base/BaseConversationalRetrievalChain/question_generator)[Aoutput\_key: str](/python/langchain-classic/chains/conversational_retrieval/base/BaseConversationalRetrievalChain/output_key)
...
[Arephrase\_question: bool

—

Whether or not to pass the new generated question to the combine\_docs\_chain.](/python/langchain-classic/chains/conversational_retrieval/base/BaseConversationalRetrievalChain/rephrase_question)
...
[Areturn\_generated\_question: bool
...
[Aget\_chat\_history: Callable[[list[CHAT\_TURN\_TYPE]], str] | None

—

An optional function to get a string of the chat history.](/python/langchain-classic/chains/conversational_retrieval/base/BaseConversationalRetrievalChain/get_chat_history)

[Aresponse\_if\_no\_docs\_found: str | None

—

If specified, the chain will return a fixed response if no docs](/python/langchain-classic/chains/conversational_retrieval/base/BaseConversationalRetrievalChain/response_if_no_docs_found)

[Amodel\_config](/python/langchain-classic/chains/conversational_retrieval/base/BaseConversationalRetrievalChain/model_config)
...
[Mget\_input\_schema](/python/langchain-classic/chains/conversational_retrieval/base/BaseConversationalRetrievalChain/get_input_schema)[Msave](/python/langchain-classic/chains/conversational_retrieval/base/BaseConversationalRetrievalChain/save)
...
vectorstore: VectorStore](/python/langchain-classic/chains/conversational_retrieval/base/ChatVectorDBChain/vectorstore)

[attribute

top\_k\_docs\_for\_context: int](/python/langchain-classic/chains/conversational_retrieval/base/ChatVectorDBChain/top_k_docs_for_context)

[attribute

search\_kwargs: dict](/python/langchain-classic/chains/conversational_retrieval/base/ChatVectorDBChain/search_kwargs)

[method

from\_llm

Load chain from LLM.](/python/langchain-classic/chains/conversational_retrieval/base/ChatVectorDBChain/from_llm)
