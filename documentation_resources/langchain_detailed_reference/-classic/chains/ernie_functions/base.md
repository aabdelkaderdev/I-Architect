<!-- Source: https://reference.langchain.com/python/langchain-classic/chains/ernie_functions/base -->
...
DEPRECATED\_LOOKUP: dict](/python/langchain-classic/chains/ernie_functions/base/DEPRECATED_LOOKUP)
