<!-- Source: https://reference.langchain.com/python/langchain-classic/chains/moderation/OpenAIModerationChain -->
...
client: Any](/python/langchain-classic/chains/moderation/OpenAIModerationChain/client)

[attribute

async\_client: Any](/python/langchain-classic/chains/moderation/OpenAIModerationChain/async_client)

[attribute

model\_name: str | None

Moderation model name to use.](/python/langchain-classic/chains/moderation/OpenAIModerationChain/model_name)

[attribute

error: bool

Whether or not to error if bad content was found.](/python/langchain-classic/chains/moderation/OpenAIModerationChain/error)

[attribute

input\_key: str](/python/langchain-classic/chains/moderation/OpenAIModerationChain/input_key)

[attribute

output\_key: str](/python/langchain-classic/chains/moderation/OpenAIModerationChain/output_key)

[attribute

openai\_api\_key: str | None](/python/langchain-classic/chains/moderation/OpenAIModerationChain/openai_api_key)

[attribute

openai\_organization: str | None](/python/langchain-classic/chains/moderation/OpenAIModerationChain/openai_organization)

[attribute

openai\_pre\_1\_0: bool](/python/langchain-classic/chains/moderation/OpenAIModerationChain/openai_pre_1_0)

[attribute

input\_keys: list[str]

Expect input key.](/python/langchain-classic/chains/moderation/OpenAIModerationChain/input_keys)

[attribute

output\_keys: list[str]

Return output key.](/python/langchain-classic/chains/moderation/OpenAIModerationChain/output_keys)

[method

validate\_environment

Validate that api key and python package exists in environment.](/python/langchain-classic/chains/moderation/OpenAIModerationChain/validate_environment)
