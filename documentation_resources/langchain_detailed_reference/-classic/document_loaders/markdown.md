<!-- Source: https://reference.langchain.com/python/langchain-classic/document_loaders/markdown -->
...
DEPRECATED\_LOOKUP: dict](/python/langchain-classic/document_loaders/markdown/DEPRECATED_LOOKUP)
