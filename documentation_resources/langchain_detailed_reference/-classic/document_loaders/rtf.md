<!-- Source: https://reference.langchain.com/python/langchain-classic/document_loaders/rtf -->
...
DEPRECATED\_LOOKUP: dict](/python/langchain-classic/document_loaders/rtf/DEPRECATED_LOOKUP)
