<!-- Source: https://reference.langchain.com/python/langchain-classic/document_loaders/async_html -->
...
DEPRECATED\_LOOKUP: dict](/python/langchain-classic/document_loaders/async_html/DEPRECATED_LOOKUP)
