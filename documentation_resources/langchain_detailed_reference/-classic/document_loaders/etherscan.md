<!-- Source: https://reference.langchain.com/python/langchain-classic/document_loaders/etherscan -->
...
DEPRECATED\_LOOKUP: dict](/python/langchain-classic/document_loaders/etherscan/DEPRECATED_LOOKUP)
