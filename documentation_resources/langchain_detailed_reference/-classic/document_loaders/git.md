<!-- Source: https://reference.langchain.com/python/langchain-classic/document_loaders/git -->
...
DEPRECATED\_LOOKUP: dict](/python/langchain-classic/document_loaders/git/DEPRECATED_LOOKUP)
