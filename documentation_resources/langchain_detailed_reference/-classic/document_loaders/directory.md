<!-- Source: https://reference.langchain.com/python/langchain-classic/document_loaders/directory -->
...
DEPRECATED\_LOOKUP: dict](/python/langchain-classic/document_loaders/directory/DEPRECATED_LOOKUP)
