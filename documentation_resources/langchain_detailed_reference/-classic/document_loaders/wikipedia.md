<!-- Source: https://reference.langchain.com/python/langchain-classic/document_loaders/wikipedia -->
...
DEPRECATED\_LOOKUP: dict](/python/langchain-classic/document_loaders/wikipedia/DEPRECATED_LOOKUP)
