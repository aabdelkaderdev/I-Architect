<!-- Source: https://reference.langchain.com/python/langchain-classic/document_loaders/sitemap -->
...
DEPRECATED\_LOOKUP: dict](/python/langchain-classic/document_loaders/sitemap/DEPRECATED_LOOKUP)
