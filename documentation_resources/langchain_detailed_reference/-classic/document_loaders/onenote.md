<!-- Source: https://reference.langchain.com/python/langchain-classic/document_loaders/onenote -->
...
DEPRECATED\_LOOKUP: dict](/python/langchain-classic/document_loaders/onenote/DEPRECATED_LOOKUP)
