<!-- Source: https://reference.langchain.com/python/langchain-classic/document_loaders/google_speech_to_text -->

Modulev1.2.13 (latest)●Since v1.0

# google\_speech\_to\_text

## Attributes

[attribute

DEPRECATED\_LOOKUP: dict](/python/langchain-classic/document_loaders/google_speech_to_text/DEPRECATED_LOOKUP)
