<!-- Source: https://reference.langchain.com/python/langchain-classic/document_loaders/azure_blob_storage_file -->

Modulev1.2.13 (latest)●Since v1.0

# azure\_blob\_storage\_file

## Attributes

[attribute

DEPRECATED\_LOOKUP: dict](/python/langchain-classic/document_loaders/azure_blob_storage_file/DEPRECATED_LOOKUP)
