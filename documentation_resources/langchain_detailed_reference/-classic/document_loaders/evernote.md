<!-- Source: https://reference.langchain.com/python/langchain-classic/document_loaders/evernote -->
...
DEPRECATED\_LOOKUP: dict](/python/langchain-classic/document_loaders/evernote/DEPRECATED_LOOKUP)
