<!-- Source: https://reference.langchain.com/python/langchain-classic/document_loaders/url_selenium -->
...
DEPRECATED\_LOOKUP: dict](/python/langchain-classic/document_loaders/url_selenium/DEPRECATED_LOOKUP)
