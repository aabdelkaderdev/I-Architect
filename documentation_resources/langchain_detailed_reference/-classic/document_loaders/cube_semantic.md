<!-- Source: https://reference.langchain.com/python/langchain-classic/document_loaders/cube_semantic -->
...
DEPRECATED\_LOOKUP: dict](/python/langchain-classic/document_loaders/cube_semantic/DEPRECATED_LOOKUP)
