<!-- Source: https://reference.langchain.com/python/langchain-classic/document_loaders/mediawikidump -->
...
DEPRECATED\_LOOKUP: dict](/python/langchain-classic/document_loaders/mediawikidump/DEPRECATED_LOOKUP)
