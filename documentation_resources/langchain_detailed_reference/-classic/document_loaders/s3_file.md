<!-- Source: https://reference.langchain.com/python/langchain-classic/document_loaders/s3_file -->
...
DEPRECATED\_LOOKUP: dict](/python/langchain-classic/document_loaders/s3_file/DEPRECATED_LOOKUP)
