<!-- Source: https://reference.langchain.com/python/langchain-classic/document_loaders/tencent_cos_directory -->

Modulev1.2.13 (latest)●Since v1.0

# tencent\_cos\_directory

## Attributes

[attribute

DEPRECATED\_LOOKUP: dict](/python/langchain-classic/document_loaders/tencent_cos_directory/DEPRECATED_LOOKUP)
