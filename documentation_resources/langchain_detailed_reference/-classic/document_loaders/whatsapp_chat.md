<!-- Source: https://reference.langchain.com/python/langchain-classic/document_loaders/whatsapp_chat -->
...
DEPRECATED\_LOOKUP: dict](/python/langchain-classic/document_loaders/whatsapp_chat/DEPRECATED_LOOKUP)
