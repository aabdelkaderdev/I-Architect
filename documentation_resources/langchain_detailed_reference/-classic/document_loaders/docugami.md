<!-- Source: https://reference.langchain.com/python/langchain-classic/document_loaders/docugami -->
...
DEPRECATED\_LOOKUP: dict](/python/langchain-classic/document_loaders/docugami/DEPRECATED_LOOKUP)
