<!-- Source: https://reference.langchain.com/python/langchain-classic/document_loaders/telegram -->
...
DEPRECATED\_LOOKUP: dict](/python/langchain-classic/document_loaders/telegram/DEPRECATED_LOOKUP)
