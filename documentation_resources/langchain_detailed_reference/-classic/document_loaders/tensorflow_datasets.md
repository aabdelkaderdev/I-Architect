<!-- Source: https://reference.langchain.com/python/langchain-classic/document_loaders/tensorflow_datasets -->
...
DEPRECATED\_LOOKUP: dict](/python/langchain-classic/document_loaders/tensorflow_datasets/DEPRECATED_LOOKUP)
