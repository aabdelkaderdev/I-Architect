<!-- Source: https://reference.langchain.com/python/langchain-classic/document_loaders/facebook_chat -->
...
DEPRECATED\_LOOKUP: dict](/python/langchain-classic/document_loaders/facebook_chat/DEPRECATED_LOOKUP)
