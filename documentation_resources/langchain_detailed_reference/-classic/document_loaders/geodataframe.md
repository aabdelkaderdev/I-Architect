<!-- Source: https://reference.langchain.com/python/langchain-classic/document_loaders/geodataframe -->
...
DEPRECATED\_LOOKUP: dict](/python/langchain-classic/document_loaders/geodataframe/DEPRECATED_LOOKUP)
