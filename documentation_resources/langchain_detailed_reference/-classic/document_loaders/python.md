<!-- Source: https://reference.langchain.com/python/langchain-classic/document_loaders/python -->
...
DEPRECATED\_LOOKUP: dict](/python/langchain-classic/document_loaders/python/DEPRECATED_LOOKUP)
