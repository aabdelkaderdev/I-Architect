<!-- Source: https://reference.langchain.com/python/langchain-classic/document_loaders/lakefs -->
...
DEPRECATED\_LOOKUP: dict](/python/langchain-classic/document_loaders/lakefs/DEPRECATED_LOOKUP)
