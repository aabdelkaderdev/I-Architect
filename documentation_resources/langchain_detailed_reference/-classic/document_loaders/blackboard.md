<!-- Source: https://reference.langchain.com/python/langchain-classic/document_loaders/blackboard -->
...
DEPRECATED\_LOOKUP: dict](/python/langchain-classic/document_loaders/blackboard/DEPRECATED_LOOKUP)
