<!-- Source: https://reference.langchain.com/python/langchain-classic/document_loaders/pubmed -->
...
DEPRECATED\_LOOKUP: dict](/python/langchain-classic/document_loaders/pubmed/DEPRECATED_LOOKUP)
