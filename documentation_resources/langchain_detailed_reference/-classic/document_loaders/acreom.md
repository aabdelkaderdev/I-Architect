<!-- Source: https://reference.langchain.com/python/langchain-classic/document_loaders/acreom -->
...
DEPRECATED\_LOOKUP: dict](/python/langchain-classic/document_loaders/acreom/DEPRECATED_LOOKUP)
