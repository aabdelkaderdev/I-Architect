<!-- Source: https://reference.langchain.com/python/langchain-classic/document_loaders/fauna -->
...
DEPRECATED\_LOOKUP: dict](/python/langchain-classic/document_loaders/fauna/DEPRECATED_LOOKUP)
