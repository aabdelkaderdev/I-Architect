<!-- Source: https://reference.langchain.com/python/langchain-classic/document_loaders/rspace -->
...
DEPRECATED\_LOOKUP: dict](/python/langchain-classic/document_loaders/rspace/DEPRECATED_LOOKUP)
