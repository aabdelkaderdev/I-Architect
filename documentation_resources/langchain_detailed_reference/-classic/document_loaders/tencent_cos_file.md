<!-- Source: https://reference.langchain.com/python/langchain-classic/document_loaders/tencent_cos_file -->
...
DEPRECATED\_LOOKUP: dict](/python/langchain-classic/document_loaders/tencent_cos_file/DEPRECATED_LOOKUP)
