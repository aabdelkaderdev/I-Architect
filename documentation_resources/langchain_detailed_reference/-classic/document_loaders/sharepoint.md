<!-- Source: https://reference.langchain.com/python/langchain-classic/document_loaders/sharepoint -->
...
DEPRECATED\_LOOKUP: dict](/python/langchain-classic/document_loaders/sharepoint/DEPRECATED_LOOKUP)
