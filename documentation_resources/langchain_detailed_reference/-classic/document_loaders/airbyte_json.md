<!-- Source: https://reference.langchain.com/python/langchain-classic/document_loaders/airbyte_json -->
...
DEPRECATED\_LOOKUP: dict](/python/langchain-classic/document_loaders/airbyte_json/DEPRECATED_LOOKUP)
