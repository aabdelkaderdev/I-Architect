<!-- Source: https://reference.langchain.com/python/langchain-classic/document_loaders/org_mode -->
...
DEPRECATED\_LOOKUP: dict](/python/langchain-classic/document_loaders/org_mode/DEPRECATED_LOOKUP)
