<!-- Source: https://reference.langchain.com/python/langchain-classic/document_loaders/epub -->
...
DEPRECATED\_LOOKUP: dict](/python/langchain-classic/document_loaders/epub/DEPRECATED_LOOKUP)
