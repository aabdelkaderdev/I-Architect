<!-- Source: https://reference.langchain.com/python/langchain-classic/document_loaders/quip -->
...
DEPRECATED\_LOOKUP: dict](/python/langchain-classic/document_loaders/quip/DEPRECATED_LOOKUP)
