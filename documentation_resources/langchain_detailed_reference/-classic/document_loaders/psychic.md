<!-- Source: https://reference.langchain.com/python/langchain-classic/document_loaders/psychic -->
...
DEPRECATED\_LOOKUP: dict](/python/langchain-classic/document_loaders/psychic/DEPRECATED_LOOKUP)
