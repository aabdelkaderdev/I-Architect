<!-- Source: https://reference.langchain.com/python/langchain-classic/document_loaders/hn -->
...
DEPRECATED\_LOOKUP: dict](/python/langchain-classic/document_loaders/hn/DEPRECATED_LOOKUP)
