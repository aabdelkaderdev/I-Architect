<!-- Source: https://reference.langchain.com/python/langchain-classic/document_loaders/merge -->
...
DEPRECATED\_LOOKUP: dict](/python/langchain-classic/document_loaders/merge/DEPRECATED_LOOKUP)
