<!-- Source: https://reference.langchain.com/python/langchain-classic/document_loaders/couchbase -->
...
DEPRECATED\_LOOKUP: dict](/python/langchain-classic/document_loaders/couchbase/DEPRECATED_LOOKUP)
