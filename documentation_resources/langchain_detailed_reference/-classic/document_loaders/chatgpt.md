<!-- Source: https://reference.langchain.com/python/langchain-classic/document_loaders/chatgpt -->
...
DEPRECATED\_LOOKUP: dict](/python/langchain-classic/document_loaders/chatgpt/DEPRECATED_LOOKUP)
