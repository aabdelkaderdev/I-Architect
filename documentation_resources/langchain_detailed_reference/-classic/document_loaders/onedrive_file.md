<!-- Source: https://reference.langchain.com/python/langchain-classic/document_loaders/onedrive_file -->
...
DEPRECATED\_LOOKUP: dict](/python/langchain-classic/document_loaders/onedrive_file/DEPRECATED_LOOKUP)
