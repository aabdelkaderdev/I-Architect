<!-- Source: https://reference.langchain.com/python/langchain-classic/document_loaders/mastodon -->
...
DEPRECATED\_LOOKUP: dict](/python/langchain-classic/document_loaders/mastodon/DEPRECATED_LOOKUP)
