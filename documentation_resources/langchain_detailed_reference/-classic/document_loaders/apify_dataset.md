<!-- Source: https://reference.langchain.com/python/langchain-classic/document_loaders/apify_dataset -->
...
DEPRECATED\_LOOKUP: dict](/python/langchain-classic/document_loaders/apify_dataset/DEPRECATED_LOOKUP)
