<!-- Source: https://reference.langchain.com/python/langchain-classic/document_loaders/college_confidential -->

Modulev1.2.13 (latest)●Since v1.0

# college\_confidential

## Attributes

[attribute

DEPRECATED\_LOOKUP: dict](/python/langchain-classic/document_loaders/college_confidential/DEPRECATED_LOOKUP)
