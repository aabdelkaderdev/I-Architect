<!-- Source: https://reference.langchain.com/python/langchain-classic/document_loaders/hugging_face_dataset -->

Modulev1.2.13 (latest)●Since v1.0

# hugging\_face\_dataset

## Attributes

[attribute

DEPRECATED\_LOOKUP: dict](/python/langchain-classic/document_loaders/hugging_face_dataset/DEPRECATED_LOOKUP)
