<!-- Source: https://reference.langchain.com/python/langchain-classic/document_loaders/docusaurus -->
...
DEPRECATED\_LOOKUP: dict](/python/langchain-classic/document_loaders/docusaurus/DEPRECATED_LOOKUP)
