<!-- Source: https://reference.langchain.com/python/langchain-classic/document_loaders/polars_dataframe -->
...
DEPRECATED\_LOOKUP: dict](/python/langchain-classic/document_loaders/polars_dataframe/DEPRECATED_LOOKUP)
