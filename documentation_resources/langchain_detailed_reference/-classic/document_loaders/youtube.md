<!-- Source: https://reference.langchain.com/python/langchain-classic/document_loaders/youtube -->
...
DEPRECATED\_LOOKUP: dict](/python/langchain-classic/document_loaders/youtube/DEPRECATED_LOOKUP)
