<!-- Source: https://reference.langchain.com/python/langchain-classic/document_loaders/odt -->
...
DEPRECATED\_LOOKUP: dict](/python/langchain-classic/document_loaders/odt/DEPRECATED_LOOKUP)
