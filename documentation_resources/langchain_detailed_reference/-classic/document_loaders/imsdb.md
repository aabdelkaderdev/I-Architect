<!-- Source: https://reference.langchain.com/python/langchain-classic/document_loaders/imsdb -->
...
DEPRECATED\_LOOKUP: dict](/python/langchain-classic/document_loaders/imsdb/DEPRECATED_LOOKUP)
