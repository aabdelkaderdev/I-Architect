<!-- Source: https://reference.langchain.com/python/langchain-classic/document_loaders/excel -->
...
DEPRECATED\_LOOKUP: dict](/python/langchain-classic/document_loaders/excel/DEPRECATED_LOOKUP)
