<!-- Source: https://reference.langchain.com/python/langchain-classic/document_loaders/word_document -->
...
DEPRECATED\_LOOKUP: dict](/python/langchain-classic/document_loaders/word_document/DEPRECATED_LOOKUP)
