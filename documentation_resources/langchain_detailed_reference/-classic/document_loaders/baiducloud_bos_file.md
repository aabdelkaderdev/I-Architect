<!-- Source: https://reference.langchain.com/python/langchain-classic/document_loaders/baiducloud_bos_file -->

Modulev1.2.13 (latest)●Since v1.0

# baiducloud\_bos\_file

## Attributes

[attribute

DEPRECATED\_LOOKUP: dict](/python/langchain-classic/document_loaders/baiducloud_bos_file/DEPRECATED_LOOKUP)
