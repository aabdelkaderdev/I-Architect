<!-- Source: https://reference.langchain.com/python/langchain-classic/document_loaders/toml -->
...
DEPRECATED\_LOOKUP: dict](/python/langchain-classic/document_loaders/toml/DEPRECATED_LOOKUP)
