<!-- Source: https://reference.langchain.com/python/langchain-classic/document_loaders/s3_directory -->
...
DEPRECATED\_LOOKUP: dict](/python/langchain-classic/document_loaders/s3_directory/DEPRECATED_LOOKUP)
