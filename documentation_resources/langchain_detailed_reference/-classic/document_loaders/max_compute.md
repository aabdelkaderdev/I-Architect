<!-- Source: https://reference.langchain.com/python/langchain-classic/document_loaders/max_compute -->
...
DEPRECATED\_LOOKUP: dict](/python/langchain-classic/document_loaders/max_compute/DEPRECATED_LOOKUP)
