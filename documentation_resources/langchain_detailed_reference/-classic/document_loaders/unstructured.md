<!-- Source: https://reference.langchain.com/python/langchain-classic/document_loaders/unstructured -->
...
DEPRECATED\_LOOKUP: dict](/python/langchain-classic/document_loaders/unstructured/DEPRECATED_LOOKUP)
