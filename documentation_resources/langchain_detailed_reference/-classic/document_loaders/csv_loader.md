<!-- Source: https://reference.langchain.com/python/langchain-classic/document_loaders/csv_loader -->
...
DEPRECATED\_LOOKUP: dict](/python/langchain-classic/document_loaders/csv_loader/DEPRECATED_LOOKUP)
