<!-- Source: https://reference.langchain.com/python/langchain-classic/document_loaders/spreedly -->
...
DEPRECATED\_LOOKUP: dict](/python/langchain-classic/document_loaders/spreedly/DEPRECATED_LOOKUP)
