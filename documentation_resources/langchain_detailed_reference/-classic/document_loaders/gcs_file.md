<!-- Source: https://reference.langchain.com/python/langchain-classic/document_loaders/gcs_file -->
...
DEPRECATED\_LOOKUP: dict](/python/langchain-classic/document_loaders/gcs_file/DEPRECATED_LOOKUP)
