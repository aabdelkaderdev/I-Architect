<!-- Source: https://reference.langchain.com/python/langchain-classic/document_loaders/parsers/language/python -->
...
DEPRECATED\_LOOKUP: dict](/python/langchain-classic/document_loaders/parsers/language/python/DEPRECATED_LOOKUP)
