<!-- Source: https://reference.langchain.com/python/langchain-classic/document_loaders/parsers/pdf -->
...
DEPRECATED\_LOOKUP: dict](/python/langchain-classic/document_loaders/parsers/pdf/DEPRECATED_LOOKUP)
