<!-- Source: https://reference.langchain.com/python/langchain-classic/document_loaders/base_o365 -->
...
DEPRECATED\_LOOKUP: dict](/python/langchain-classic/document_loaders/base_o365/DEPRECATED_LOOKUP)
