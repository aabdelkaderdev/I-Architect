<!-- Source: https://reference.langchain.com/python/langchain-classic/document_loaders/gcs_directory -->
...
DEPRECATED\_LOOKUP: dict](/python/langchain-classic/document_loaders/gcs_directory/DEPRECATED_LOOKUP)
