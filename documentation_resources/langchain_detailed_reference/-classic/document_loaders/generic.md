<!-- Source: https://reference.langchain.com/python/langchain-classic/document_loaders/generic -->
...
DEPRECATED\_LOOKUP: dict](/python/langchain-classic/document_loaders/generic/DEPRECATED_LOOKUP)
