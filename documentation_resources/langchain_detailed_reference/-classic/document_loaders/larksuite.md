<!-- Source: https://reference.langchain.com/python/langchain-classic/document_loaders/larksuite -->
...
DEPRECATED\_LOOKUP: dict](/python/langchain-classic/document_loaders/larksuite/DEPRECATED_LOOKUP)
