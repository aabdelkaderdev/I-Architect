<!-- Source: https://reference.langchain.com/python/langchain-classic/document_loaders/diffbot -->
...
DEPRECATED\_LOOKUP: dict](/python/langchain-classic/document_loaders/diffbot/DEPRECATED_LOOKUP)
