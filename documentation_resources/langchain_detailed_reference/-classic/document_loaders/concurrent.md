<!-- Source: https://reference.langchain.com/python/langchain-classic/document_loaders/concurrent -->
...
DEPRECATED\_LOOKUP: dict](/python/langchain-classic/document_loaders/concurrent/DEPRECATED_LOOKUP)
