<!-- Source: https://reference.langchain.com/python/langchain-classic/document_loaders/tomarkdown -->
...
DEPRECATED\_LOOKUP: dict](/python/langchain-classic/document_loaders/tomarkdown/DEPRECATED_LOOKUP)
