<!-- Source: https://reference.langchain.com/python/langchain-classic/document_loaders/confluence -->
...
DEPRECATED\_LOOKUP: dict](/python/langchain-classic/document_loaders/confluence/DEPRECATED_LOOKUP)
