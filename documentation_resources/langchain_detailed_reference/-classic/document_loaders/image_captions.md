<!-- Source: https://reference.langchain.com/python/langchain-classic/document_loaders/image_captions -->
...
DEPRECATED\_LOOKUP: dict](/python/langchain-classic/document_loaders/image_captions/DEPRECATED_LOOKUP)
