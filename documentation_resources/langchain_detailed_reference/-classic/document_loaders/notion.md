<!-- Source: https://reference.langchain.com/python/langchain-classic/document_loaders/notion -->
...
DEPRECATED\_LOOKUP: dict](/python/langchain-classic/document_loaders/notion/DEPRECATED_LOOKUP)
