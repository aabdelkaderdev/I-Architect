<!-- Source: https://reference.langchain.com/python/langchain-classic/document_loaders/airtable -->
...
DEPRECATED\_LOOKUP: dict](/python/langchain-classic/document_loaders/airtable/DEPRECATED_LOOKUP)
