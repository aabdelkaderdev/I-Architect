<!-- Source: https://reference.langchain.com/python/langchain-classic/document_loaders/readthedocs -->
...
DEPRECATED\_LOOKUP: dict](/python/langchain-classic/document_loaders/readthedocs/DEPRECATED_LOOKUP)
