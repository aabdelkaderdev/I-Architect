<!-- Source: https://reference.langchain.com/python/langchain-classic/document_loaders/image -->
...
DEPRECATED\_LOOKUP: dict](/python/langchain-classic/document_loaders/image/DEPRECATED_LOOKUP)
