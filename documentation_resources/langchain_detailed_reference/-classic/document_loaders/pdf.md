<!-- Source: https://reference.langchain.com/python/langchain-classic/document_loaders/pdf -->
...
DEPRECATED\_LOOKUP: dict](/python/langchain-classic/document_loaders/pdf/DEPRECATED_LOOKUP)
