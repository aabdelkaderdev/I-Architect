<!-- Source: https://reference.langchain.com/python/langchain-classic/document_loaders/chromium -->
...
DEPRECATED\_LOOKUP: dict](/python/langchain-classic/document_loaders/chromium/DEPRECATED_LOOKUP)
