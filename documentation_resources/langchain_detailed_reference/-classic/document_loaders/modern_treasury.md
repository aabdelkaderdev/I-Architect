<!-- Source: https://reference.langchain.com/python/langchain-classic/document_loaders/modern_treasury -->
...
DEPRECATED\_LOOKUP: dict](/python/langchain-classic/document_loaders/modern_treasury/DEPRECATED_LOOKUP)
