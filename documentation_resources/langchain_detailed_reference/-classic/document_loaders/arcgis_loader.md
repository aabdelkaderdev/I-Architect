<!-- Source: https://reference.langchain.com/python/langchain-classic/document_loaders/arcgis_loader -->
...
DEPRECATED\_LOOKUP: dict](/python/langchain-classic/document_loaders/arcgis_loader/DEPRECATED_LOOKUP)
