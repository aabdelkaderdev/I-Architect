<!-- Source: https://reference.langchain.com/python/langchain-classic/document_loaders/srt -->
...
DEPRECATED\_LOOKUP: dict](/python/langchain-classic/document_loaders/srt/DEPRECATED_LOOKUP)
