<!-- Source: https://reference.langchain.com/python/langchain-classic/document_loaders/azure_blob_storage_container -->

Modulev1.2.13 (latest)●Since v1.0

# azure\_blob\_storage\_container

## Attributes

[attribute

DEPRECATED\_LOOKUP: dict](/python/langchain-classic/document_loaders/azure_blob_storage_container/DEPRECATED_LOOKUP)
