<!-- Source: https://reference.langchain.com/python/langchain-classic/document_loaders/rocksetdb -->
...
DEPRECATED\_LOOKUP: dict](/python/langchain-classic/document_loaders/rocksetdb/DEPRECATED_LOOKUP)
