<!-- Source: https://reference.langchain.com/python/langchain-classic/document_loaders/web_base -->
...
DEPRECATED\_LOOKUP: dict](/python/langchain-classic/document_loaders/web_base/DEPRECATED_LOOKUP)
