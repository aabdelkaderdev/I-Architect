<!-- Source: https://reference.langchain.com/python/langchain-classic/document_loaders/url_playwright -->
...
DEPRECATED\_LOOKUP: dict](/python/langchain-classic/document_loaders/url_playwright/DEPRECATED_LOOKUP)
