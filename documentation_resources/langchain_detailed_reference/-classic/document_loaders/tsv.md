<!-- Source: https://reference.langchain.com/python/langchain-classic/document_loaders/tsv -->
...
DEPRECATED\_LOOKUP: dict](/python/langchain-classic/document_loaders/tsv/DEPRECATED_LOOKUP)
