<!-- Source: https://reference.langchain.com/python/langchain-classic/document_loaders/recursive_url_loader -->

Modulev1.2.13 (latest)●Since v1.0

# recursive\_url\_loader

## Attributes

[attribute

DEPRECATED\_LOOKUP: dict](/python/langchain-classic/document_loaders/recursive_url_loader/DEPRECATED_LOOKUP)
