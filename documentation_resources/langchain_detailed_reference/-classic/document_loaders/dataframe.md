<!-- Source: https://reference.langchain.com/python/langchain-classic/document_loaders/dataframe -->
...
DEPRECATED\_LOOKUP: dict](/python/langchain-classic/document_loaders/dataframe/DEPRECATED_LOOKUP)
