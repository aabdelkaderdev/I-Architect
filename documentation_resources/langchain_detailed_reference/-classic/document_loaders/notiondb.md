<!-- Source: https://reference.langchain.com/python/langchain-classic/document_loaders/notiondb -->
...
DEPRECATED\_LOOKUP: dict](/python/langchain-classic/document_loaders/notiondb/DEPRECATED_LOOKUP)
