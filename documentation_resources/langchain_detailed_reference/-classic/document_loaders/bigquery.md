<!-- Source: https://reference.langchain.com/python/langchain-classic/document_loaders/bigquery -->
...
DEPRECATED\_LOOKUP: dict](/python/langchain-classic/document_loaders/bigquery/DEPRECATED_LOOKUP)
