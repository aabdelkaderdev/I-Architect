<!-- Source: https://reference.langchain.com/python/langchain-classic/document_loaders/obs_file -->
...
DEPRECATED\_LOOKUP: dict](/python/langchain-classic/document_loaders/obs_file/DEPRECATED_LOOKUP)
