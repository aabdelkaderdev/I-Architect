<!-- Source: https://reference.langchain.com/python/langchain-classic/tools/azure_cognitive_services/text_analytics_health -->

Modulev1.2.13 (latest)●Since v1.0

# text\_analytics\_health

## Attributes

[attribute

DEPRECATED\_LOOKUP: dict](/python/langchain-classic/tools/azure_cognitive_services/text_analytics_health/DEPRECATED_LOOKUP)
