<!-- Source: https://reference.langchain.com/python/langchain-classic/tools/golden_query -->
...
DEPRECATED\_LOOKUP: dict](/python/langchain-classic/tools/golden_query/DEPRECATED_LOOKUP)
...
tool](/python/langchain-classic/tools/golden_query/tool)
