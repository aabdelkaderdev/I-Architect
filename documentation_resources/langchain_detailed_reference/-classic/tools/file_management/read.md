<!-- Source: https://reference.langchain.com/python/langchain-classic/tools/file_management/read -->
...
DEPRECATED\_LOOKUP: dict](/python/langchain-classic/tools/file_management/read/DEPRECATED_LOOKUP)
