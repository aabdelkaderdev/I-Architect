<!-- Source: https://reference.langchain.com/python/langchain-classic/tools/file_management/move -->
...
DEPRECATED\_LOOKUP: dict](/python/langchain-classic/tools/file_management/move/DEPRECATED_LOOKUP)
