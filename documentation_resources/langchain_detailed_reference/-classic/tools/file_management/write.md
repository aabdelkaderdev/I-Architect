<!-- Source: https://reference.langchain.com/python/langchain-classic/tools/file_management/write -->
...
DEPRECATED\_LOOKUP: dict](/python/langchain-classic/tools/file_management/write/DEPRECATED_LOOKUP)
