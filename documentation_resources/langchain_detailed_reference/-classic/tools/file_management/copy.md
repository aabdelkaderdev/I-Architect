<!-- Source: https://reference.langchain.com/python/langchain-classic/tools/file_management/copy -->
...
DEPRECATED\_LOOKUP: dict](/python/langchain-classic/tools/file_management/copy/DEPRECATED_LOOKUP)
