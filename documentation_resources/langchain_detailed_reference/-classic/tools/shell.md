<!-- Source: https://reference.langchain.com/python/langchain-classic/tools/shell -->
...
DEPRECATED\_LOOKUP: dict](/python/langchain-classic/tools/shell/DEPRECATED_LOOKUP)
...
tool](/python/langchain-classic/tools/shell/tool)
