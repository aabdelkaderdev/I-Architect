<!-- Source: https://reference.langchain.com/python/langchain-classic/tools/plugin -->
...
DEPRECATED\_LOOKUP: dict](/python/langchain-classic/tools/plugin/DEPRECATED_LOOKUP)
