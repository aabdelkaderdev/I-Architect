<!-- Source: https://reference.langchain.com/python/langchain-classic/tools/dataforseo_api_search -->

Modulev1.2.13 (latest)●Since v1.0

# dataforseo\_api\_search
...
DEPRECATED\_LOOKUP: dict](/python/langchain-classic/tools/dataforseo_api_search/DEPRECATED_LOOKUP)
...
tool](/python/langchain-classic/tools/dataforseo_api_search/tool)
