<!-- Source: https://reference.langchain.com/python/langchain-classic/tools/ainetwork/transfer -->
...
DEPRECATED\_LOOKUP: dict](/python/langchain-classic/tools/ainetwork/transfer/DEPRECATED_LOOKUP)
