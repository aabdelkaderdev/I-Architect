<!-- Source: https://reference.langchain.com/python/langchain-classic/tools/steamship_image_generation -->

Modulev1.2.13 (latest)●Since v1.0

# steamship\_image\_generation
...
DEPRECATED\_LOOKUP: dict](/python/langchain-classic/tools/steamship_image_generation/DEPRECATED_LOOKUP)
...
tool](/python/langchain-classic/tools/steamship_image_generation/tool)
