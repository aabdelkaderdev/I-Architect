<!-- Source: https://reference.langchain.com/python/langchain-classic/tools/edenai/audio_speech_to_text -->

Modulev1.2.13 (latest)●Since v1.0

# audio\_speech\_to\_text

## Attributes

[attribute

DEPRECATED\_LOOKUP: dict](/python/langchain-classic/tools/edenai/audio_speech_to_text/DEPRECATED_LOOKUP)
