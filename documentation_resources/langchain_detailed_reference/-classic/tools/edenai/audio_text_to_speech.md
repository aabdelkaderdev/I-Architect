<!-- Source: https://reference.langchain.com/python/langchain-classic/tools/edenai/audio_text_to_speech -->

Modulev1.2.13 (latest)●Since v1.0

# audio\_text\_to\_speech

## Attributes

[attribute

DEPRECATED\_LOOKUP: dict](/python/langchain-classic/tools/edenai/audio_text_to_speech/DEPRECATED_LOOKUP)
