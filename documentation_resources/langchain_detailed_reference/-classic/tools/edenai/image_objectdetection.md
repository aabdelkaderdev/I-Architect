<!-- Source: https://reference.langchain.com/python/langchain-classic/tools/edenai/image_objectdetection -->

Modulev1.2.13 (latest)●Since v1.0

# image\_objectdetection

## Attributes

[attribute

DEPRECATED\_LOOKUP: dict](/python/langchain-classic/tools/edenai/image_objectdetection/DEPRECATED_LOOKUP)
