<!-- Source: https://reference.langchain.com/python/langchain-classic/tools/edenai/image_explicitcontent -->

Modulev1.2.13 (latest)●Since v1.0

# image\_explicitcontent

## Attributes

[attribute

DEPRECATED\_LOOKUP: dict](/python/langchain-classic/tools/edenai/image_explicitcontent/DEPRECATED_LOOKUP)
