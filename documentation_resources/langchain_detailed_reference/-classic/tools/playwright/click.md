<!-- Source: https://reference.langchain.com/python/langchain-classic/tools/playwright/click -->
...
DEPRECATED\_LOOKUP: dict](/python/langchain-classic/tools/playwright/click/DEPRECATED_LOOKUP)
