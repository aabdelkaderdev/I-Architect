<!-- Source: https://reference.langchain.com/python/langchain-classic/llms/llamacpp -->
...
DEPRECATED\_LOOKUP: dict](/python/langchain-classic/llms/llamacpp/DEPRECATED_LOOKUP)
