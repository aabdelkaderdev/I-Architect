<!-- Source: https://reference.langchain.com/python/langchain-classic/llms/manifest -->
...
DEPRECATED\_LOOKUP: dict](/python/langchain-classic/llms/manifest/DEPRECATED_LOOKUP)
