<!-- Source: https://reference.langchain.com/python/langchain-classic/llms/mlflow_ai_gateway -->
...
DEPRECATED\_LOOKUP: dict](/python/langchain-classic/llms/mlflow_ai_gateway/DEPRECATED_LOOKUP)
