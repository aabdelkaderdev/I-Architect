<!-- Source: https://reference.langchain.com/python/langchain-classic/llms/stochasticai -->
...
DEPRECATED\_LOOKUP: dict](/python/langchain-classic/llms/stochasticai/DEPRECATED_LOOKUP)
