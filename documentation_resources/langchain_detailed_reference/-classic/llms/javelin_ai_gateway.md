<!-- Source: https://reference.langchain.com/python/langchain-classic/llms/javelin_ai_gateway -->
...
DEPRECATED\_LOOKUP: dict](/python/langchain-classic/llms/javelin_ai_gateway/DEPRECATED_LOOKUP)
