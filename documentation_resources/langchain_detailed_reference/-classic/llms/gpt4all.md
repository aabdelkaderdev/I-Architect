<!-- Source: https://reference.langchain.com/python/langchain-classic/llms/gpt4all -->
...
DEPRECATED\_LOOKUP: dict](/python/langchain-classic/llms/gpt4all/DEPRECATED_LOOKUP)
