<!-- Source: https://reference.langchain.com/python/langchain-classic/chat_models/mlflow_ai_gateway -->
...
DEPRECATED\_LOOKUP: dict](/python/langchain-classic/chat_models/mlflow_ai_gateway/DEPRECATED_LOOKUP)
