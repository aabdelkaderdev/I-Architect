<!-- Source: https://reference.langchain.com/python/langchain-classic/chat_models/mlflow -->
...
DEPRECATED\_LOOKUP: dict](/python/langchain-classic/chat_models/mlflow/DEPRECATED_LOOKUP)
