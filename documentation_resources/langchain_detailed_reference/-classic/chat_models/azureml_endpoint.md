<!-- Source: https://reference.langchain.com/python/langchain-classic/chat_models/azureml_endpoint -->
...
DEPRECATED\_LOOKUP: dict](/python/langchain-classic/chat_models/azureml_endpoint/DEPRECATED_LOOKUP)
