<!-- Source: https://reference.langchain.com/python/langchain-classic/chat_models/litellm -->
...
DEPRECATED\_LOOKUP: dict](/python/langchain-classic/chat_models/litellm/DEPRECATED_LOOKUP)
