<!-- Source: https://reference.langchain.com/python/langchain-classic/vectorstores/azure_cosmos_db -->
...
DEPRECATED\_LOOKUP: dict](/python/langchain-classic/vectorstores/azure_cosmos_db/DEPRECATED_LOOKUP)
