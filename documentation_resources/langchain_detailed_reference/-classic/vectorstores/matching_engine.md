<!-- Source: https://reference.langchain.com/python/langchain-classic/vectorstores/matching_engine -->
...
DEPRECATED\_LOOKUP: dict](/python/langchain-classic/vectorstores/matching_engine/DEPRECATED_LOOKUP)
