<!-- Source: https://reference.langchain.com/python/langchain-classic/vectorstores/usearch -->
...
DEPRECATED\_LOOKUP: dict](/python/langchain-classic/vectorstores/usearch/DEPRECATED_LOOKUP)
