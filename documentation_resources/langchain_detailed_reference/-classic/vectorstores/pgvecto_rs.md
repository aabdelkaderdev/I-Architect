<!-- Source: https://reference.langchain.com/python/langchain-classic/vectorstores/pgvecto_rs -->
...
DEPRECATED\_LOOKUP: dict](/python/langchain-classic/vectorstores/pgvecto_rs/DEPRECATED_LOOKUP)
