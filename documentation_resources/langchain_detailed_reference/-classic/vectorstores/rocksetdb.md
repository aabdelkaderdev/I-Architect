<!-- Source: https://reference.langchain.com/python/langchain-classic/vectorstores/rocksetdb -->
...
DEPRECATED\_LOOKUP: dict](/python/langchain-classic/vectorstores/rocksetdb/DEPRECATED_LOOKUP)
