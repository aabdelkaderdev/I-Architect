<!-- Source: https://reference.langchain.com/python/langchain-classic/vectorstores/clickhouse -->
...
DEPRECATED\_LOOKUP: dict](/python/langchain-classic/vectorstores/clickhouse/DEPRECATED_LOOKUP)
