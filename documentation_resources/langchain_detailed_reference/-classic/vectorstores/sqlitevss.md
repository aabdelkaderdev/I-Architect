<!-- Source: https://reference.langchain.com/python/langchain-classic/vectorstores/sqlitevss -->
...
DEPRECATED\_LOOKUP: dict](/python/langchain-classic/vectorstores/sqlitevss/DEPRECATED_LOOKUP)
