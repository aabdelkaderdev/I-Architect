<!-- Source: https://reference.langchain.com/python/langchain-classic/vectorstores/supabase -->
...
DEPRECATED\_LOOKUP: dict](/python/langchain-classic/vectorstores/supabase/DEPRECATED_LOOKUP)
