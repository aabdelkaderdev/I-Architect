<!-- Source: https://reference.langchain.com/python/langchain-classic/vectorstores/opensearch_vector_search -->

Modulev1.2.13 (latest)●Since v1.0

# opensearch\_vector\_search

## Attributes

[attribute

DEPRECATED\_LOOKUP: dict](/python/langchain-classic/vectorstores/opensearch_vector_search/DEPRECATED_LOOKUP)
