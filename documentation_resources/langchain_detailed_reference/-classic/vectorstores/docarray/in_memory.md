<!-- Source: https://reference.langchain.com/python/langchain-classic/vectorstores/docarray/in_memory -->
...
DEPRECATED\_LOOKUP: dict](/python/langchain-classic/vectorstores/docarray/in_memory/DEPRECATED_LOOKUP)
