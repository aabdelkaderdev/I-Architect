<!-- Source: https://reference.langchain.com/python/langchain-classic/vectorstores/docarray/hnsw -->
...
DEPRECATED\_LOOKUP: dict](/python/langchain-classic/vectorstores/docarray/hnsw/DEPRECATED_LOOKUP)
