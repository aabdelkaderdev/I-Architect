<!-- Source: https://reference.langchain.com/python/langchain-classic/vectorstores/myscale -->
...
DEPRECATED\_LOOKUP: dict](/python/langchain-classic/vectorstores/myscale/DEPRECATED_LOOKUP)
