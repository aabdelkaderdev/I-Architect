<!-- Source: https://reference.langchain.com/python/langchain-classic/vectorstores/llm_rails -->
...
DEPRECATED\_LOOKUP: dict](/python/langchain-classic/vectorstores/llm_rails/DEPRECATED_LOOKUP)
