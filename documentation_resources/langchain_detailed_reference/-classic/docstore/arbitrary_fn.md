<!-- Source: https://reference.langchain.com/python/langchain-classic/docstore/arbitrary_fn -->
...
DEPRECATED\_LOOKUP: dict](/python/langchain-classic/docstore/arbitrary_fn/DEPRECATED_LOOKUP)
