<!-- Source: https://reference.langchain.com/python/langchain-classic/docstore/base -->
...
DEPRECATED\_LOOKUP: dict](/python/langchain-classic/docstore/base/DEPRECATED_LOOKUP)
