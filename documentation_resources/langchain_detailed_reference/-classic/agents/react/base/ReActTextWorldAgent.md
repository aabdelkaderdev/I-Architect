<!-- Source: https://reference.langchain.com/python/langchain-classic/agents/react/base/ReActTextWorldAgent -->
...
Return default prompt.](/python/langchain-classic/agents/react/base/ReActTextWorldAgent/create_prompt)

## Inherited from[ReActDocstoreAgent](/python/langchain-classic/agents/react/base/ReActDocstoreAgent)

### Attributes

[Aoutput\_parser: AgentOutputParser](/python/langchain-classic/agents/react/base/ReActDocstoreAgent/output_parser)[Aobservation\_prefix: str

—

Prefix to append the observation with.](/python/langchain-classic/agents/react/base/ReActDocstoreAgent/observation_prefix)[Allm\_prefix: str

—

Prefix to append the LLM call with.](/python/langchain-classic/agents/react/base/ReActDocstoreAgent/llm_prefix)
...
LLMChain to use for agent.](/python/langchain-classic/agents/agent/Agent/llm_chain)[Aoutput\_parser: AgentOutputParser

—

Output parser to use for agent.](/python/langchain-classic/agents/agent/Agent/output_parser)[Aallowed\_tools: list[str] | None
...
Return the input keys.](/python/langchain-classic/agents/agent/Agent/input_keys)[Aobservation\_prefix: str

—

Prefix to append the observation with.](/python/langchain-classic/agents/agent/Agent/observation_prefix)[Allm\_prefix: str
...
Validate that prompt matches format.](/python/langchain-classic/agents/agent/Agent/validate_prompt)[Mfrom\_llm\_and\_tools

—

Construct an agent from an LLM and tools.](/python/langchain-classic/agents/agent/Agent/from_llm_and_tools)[Mreturn\_stopped\_response
