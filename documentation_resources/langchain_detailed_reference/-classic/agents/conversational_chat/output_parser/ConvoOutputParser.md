<!-- Source: https://reference.langchain.com/python/langchain-classic/agents/conversational_chat/output_parser/ConvoOutputParser -->
...
Default formatting instructions](/python/langchain-classic/agents/conversational_chat/output_parser/ConvoOutputParser/format_instructions)

[method

get\_format\_instructions

Returns formatting instructions for the given output parser.](/python/langchain-classic/agents/conversational_chat/output_parser/ConvoOutputParser/get_format_instructions)

[method

parse

Attempts to parse the given text into an AgentAction or AgentFinish.](/python/langchain-classic/agents/conversational_chat/output_parser/ConvoOutputParser/parse)
