<!-- Source: https://reference.langchain.com/python/langchain-classic/agents/agent/MultiActionAgentOutputParser -->
...
Parse text into agent actions/finish.](/python/langchain-classic/agents/agent/MultiActionAgentOutputParser/parse)
