<!-- Source: https://reference.langchain.com/python/langchain-classic/agents/agent/Agent/from_llm_and_tools -->
...
| `output_parser` | `AgentOutputParser | None` | Default:`None`  Output parser to use. |
