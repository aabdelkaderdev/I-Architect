<!-- Source: https://reference.langchain.com/python/langchain-classic/agents/self_ask_with_search/base/SelfAskWithSearchAgent -->
...
output\_parser: AgentOutputParser](/python/langchain-classic/agents/self_ask_with_search/base/SelfAskWithSearchAgent/output_parser)[attribute

observation\_prefix: str

Prefix to append the observation with.](/python/langchain-classic/agents/self_ask_with_search/base/SelfAskWithSearchAgent/observation_prefix)[attribute

llm\_prefix: str

Prefix to append the LLM call with.](/python/langchain-classic/agents/self_ask_with_search/base/SelfAskWithSearchAgent/llm_prefix)
...
Prompt does not depend on tools.](/python/langchain-classic/agents/self_ask_with_search/base/SelfAskWithSearchAgent/create_prompt)
