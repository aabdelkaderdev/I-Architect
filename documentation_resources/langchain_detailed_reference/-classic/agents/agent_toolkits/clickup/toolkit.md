<!-- Source: https://reference.langchain.com/python/langchain-classic/agents/agent_toolkits/clickup/toolkit -->
...
DEPRECATED\_LOOKUP: dict](/python/langchain-classic/agents/agent_toolkits/clickup/toolkit/DEPRECATED_LOOKUP)
