<!-- Source: https://reference.langchain.com/python/langchain-classic/agents/agent_toolkits/ainetwork/toolkit -->
...
DEPRECATED\_LOOKUP: dict](/python/langchain-classic/agents/agent_toolkits/ainetwork/toolkit/DEPRECATED_LOOKUP)
