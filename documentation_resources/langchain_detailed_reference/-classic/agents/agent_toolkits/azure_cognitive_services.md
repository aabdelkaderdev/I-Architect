<!-- Source: https://reference.langchain.com/python/langchain-classic/agents/agent_toolkits/azure_cognitive_services -->
...
DEPRECATED\_LOOKUP: dict](/python/langchain-classic/agents/agent_toolkits/azure_cognitive_services/DEPRECATED_LOOKUP)
