<!-- Source: https://reference.langchain.com/python/langchain-classic/agents/agent_toolkits/multion/toolkit -->
...
DEPRECATED\_LOOKUP: dict](/python/langchain-classic/agents/agent_toolkits/multion/toolkit/DEPRECATED_LOOKUP)
