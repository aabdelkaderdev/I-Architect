<!-- Source: https://reference.langchain.com/python/langchain-classic/agents/agent_toolkits/nla/toolkit -->
...
DEPRECATED\_LOOKUP: dict](/python/langchain-classic/agents/agent_toolkits/nla/toolkit/DEPRECATED_LOOKUP)
