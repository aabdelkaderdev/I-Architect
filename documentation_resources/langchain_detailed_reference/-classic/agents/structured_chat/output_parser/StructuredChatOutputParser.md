<!-- Source: https://reference.langchain.com/python/langchain-classic/agents/structured_chat/output_parser/StructuredChatOutputParser -->
...
Default formatting instructions](/python/langchain-classic/agents/structured_chat/output_parser/StructuredChatOutputParser/format_instructions)

[attribute

pattern: Pattern

Regex pattern to parse the output.](/python/langchain-classic/agents/structured_chat/output_parser/StructuredChatOutputParser/pattern)

[method

get\_format\_instructions

Returns formatting instructions for the given output parser.](/python/langchain-classic/agents/structured_chat/output_parser/StructuredChatOutputParser/get_format_instructions)

[method

parse](/python/langchain-classic/agents/structured_chat/output_parser/StructuredChatOutputParser/parse)
