<!-- Source: https://reference.langchain.com/python/langchain-classic/agents/structured_chat/output_parser/StructuredChatOutputParserWithRetries -->
...
base\_parser: AgentOutputParser

The base parser to use.](/python/langchain-classic/agents/structured_chat/output_parser/StructuredChatOutputParserWithRetries/base_parser)

[attribute

output\_fixing\_parser: OutputFixingParser | None

The output fixing parser to use.](/python/langchain-classic/agents/structured_chat/output_parser/StructuredChatOutputParserWithRetries/output_fixing_parser)

[method

get\_format\_instructions](/python/langchain-classic/agents/structured_chat/output_parser/StructuredChatOutputParserWithRetries/get_format_instructions)

[method

parse](/python/langchain-classic/agents/structured_chat/output_parser/StructuredChatOutputParserWithRetries/parse)

[method

from\_llm

Create a StructuredChatOutputParserWithRetries from a language model.](/python/langchain-classic/agents/structured_chat/output_parser/StructuredChatOutputParserWithRetries/from_llm)
