<!-- Source: https://reference.langchain.com/python/langchain-classic/agents/mrkl/output_parser/MRKLOutputParser -->
...
Default formatting instructions](/python/langchain-classic/agents/mrkl/output_parser/MRKLOutputParser/format_instructions)

[method

get\_format\_instructions

Returns formatting instructions for the given output parser.](/python/langchain-classic/agents/mrkl/output_parser/MRKLOutputParser/get_format_instructions)

[method

parse

Parse the output from the agent into an AgentAction or AgentFinish object.](/python/langchain-classic/agents/mrkl/output_parser/MRKLOutputParser/parse)
