<!-- Source: https://reference.langchain.com/python/langchain-classic/agents/mrkl/base/ZeroShotAgent -->
...
| --- | --- | --- |
| `output_parser`\* | `unknown` | Output parser for the agent. |

## Attributes

[attribute

output\_parser: AgentOutputParser](/python/langchain-classic/agents/mrkl/base/ZeroShotAgent/output_parser)[attribute

observation\_prefix: str

Prefix to append the observation with.](/python/langchain-classic/agents/mrkl/base/ZeroShotAgent/observation_prefix)[attribute

llm\_prefix: str

Prefix to append the llm call with.](/python/langchain-classic/agents/mrkl/base/ZeroShotAgent/llm_prefix)
...
Create prompt in the style of the zero shot agent.](/python/langchain-classic/agents/mrkl/base/ZeroShotAgent/create_prompt)[method

from\_llm\_and\_tools

Construct an agent from an LLM and tools.](/python/langchain-classic/agents/mrkl/base/ZeroShotAgent/from_llm_and_tools)
