<!-- Source: https://reference.langchain.com/python/langchain-classic/agents/chat/base/ChatAgent -->
...
Output parser for the agent.](/python/langchain-classic/agents/chat/base/ChatAgent/output_parser)[attribute

observation\_prefix: str

Prefix to append the observation with.](/python/langchain-classic/agents/chat/base/ChatAgent/observation_prefix)[attribute

llm\_prefix: str

Prefix to append the llm call with.](/python/langchain-classic/agents/chat/base/ChatAgent/llm_prefix)
...
Create a prompt from a list of tools.](/python/langchain-classic/agents/chat/base/ChatAgent/create_prompt)[method

from\_llm\_and\_tools

Construct an agent from an LLM and tools.](/python/langchain-classic/agents/chat/base/ChatAgent/from_llm_and_tools)
