<!-- Source: https://reference.langchain.com/python/langchain-classic/agents/conversational/output_parser/ConvoOutputParser -->
...
Prefix to use before AI output.](/python/langchain-classic/agents/conversational/output_parser/ConvoOutputParser/ai_prefix)

[attribute

format\_instructions: str

Default formatting instructions](/python/langchain-classic/agents/conversational/output_parser/ConvoOutputParser/format_instructions)

[method

get\_format\_instructions

Returns formatting instructions for the given output parser.](/python/langchain-classic/agents/conversational/output_parser/ConvoOutputParser/get_format_instructions)

[method

parse

Parse the output from the agent into an AgentAction or AgentFinish object.](/python/langchain-classic/agents/conversational/output_parser/ConvoOutputParser/parse)
