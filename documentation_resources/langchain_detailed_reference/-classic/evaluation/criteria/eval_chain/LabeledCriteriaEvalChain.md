<!-- Source: https://reference.langchain.com/python/langchain-classic/evaluation/criteria/eval_chain/LabeledCriteriaEvalChain -->
...
## Inherited from[CriteriaEvalChain](/python/langchain-classic/evaluation/criteria/eval_chain/CriteriaEvalChain)

### Attributes

[Aoutput\_parser: BaseOutputParser

—

The parser to use to map the output to a structured result.](/python/langchain-classic/evaluation/criteria/eval_chain/CriteriaEvalChain/output_parser)[Acriterion\_name: str

—

The name of the criterion being evaluated.](/python/langchain-classic/evaluation/criteria/eval_chain/CriteriaEvalChain/criterion_name)[Aoutput\_key: str](/python/langchain-classic/evaluation/criteria/eval_chain/CriteriaEvalChain/output_key)
...
[Arequires\_input: bool](/python/langchain-classic/evaluation/criteria/eval_chain/CriteriaEvalChain/requires_input)

[Aevaluation\_name: str

—

Get the name of the evaluation.](/python/langchain-classic/evaluation/criteria/eval_chain/CriteriaEvalChain/evaluation_name)
...
Resolve the criteria to evaluate.](/python/langchain-classic/evaluation/criteria/eval_chain/CriteriaEvalChain/resolve_criteria)
...
Whether the evaluation requires a reference text.](/python/langchain-classic/evaluation/criteria/eval_chain/LabeledCriteriaEvalChain/requires_reference)

[method

is\_lc\_serializable](/python/langchain-classic/evaluation/criteria/eval_chain/LabeledCriteriaEvalChain/is_lc_serializable)
...
> > > llm=model,
> > > criteria=criteria,
> > > )](/python/langchain-classic/evaluation/criteria/eval_chain/LabeledCriteriaEvalChain/from_llm)
