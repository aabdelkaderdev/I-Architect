<!-- Source: https://reference.langchain.com/python/langchain-classic/evaluation/qa/generate_chain/QAGenerateChain -->
...
output\_parser: BaseLLMOutputParser](/python/langchain-classic/evaluation/qa/generate_chain/QAGenerateChain/output_parser)

[attribute

output\_key: str](/python/langchain-classic/evaluation/qa/generate_chain/QAGenerateChain/output_key)

[method

is\_lc\_serializable](/python/langchain-classic/evaluation/qa/generate_chain/QAGenerateChain/is_lc_serializable)

[method

from\_llm

Load QA Generate Chain from LLM.](/python/langchain-classic/evaluation/qa/generate_chain/QAGenerateChain/from_llm)
