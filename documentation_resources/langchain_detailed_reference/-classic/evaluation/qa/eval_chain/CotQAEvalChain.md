<!-- Source: https://reference.langchain.com/python/langchain-classic/evaluation/qa/eval_chain/CotQAEvalChain -->
...
## Inherited from[ContextQAEvalChain](/python/langchain-classic/evaluation/qa/eval_chain/ContextQAEvalChain)

### Attributes

[Arequires\_reference: bool

—

Whether the chain requires a reference string.](/python/langchain-classic/evaluation/qa/eval_chain/ContextQAEvalChain/requires_reference)[Arequires\_input: bool

—

Whether the chain requires an input string.](/python/langchain-classic/evaluation/qa/eval_chain/ContextQAEvalChain/requires_input)[Amodel\_config](/python/langchain-classic/evaluation/qa/eval_chain/ContextQAEvalChain/model_config)
...
evaluation\_name: str](/python/langchain-classic/evaluation/qa/eval_chain/CotQAEvalChain/evaluation_name)

[method

is\_lc\_serializable](/python/langchain-classic/evaluation/qa/eval_chain/CotQAEvalChain/is_lc_serializable)

[method

from\_llm

Load QA Eval Chain from LLM.](/python/langchain-classic/evaluation/qa/eval_chain/CotQAEvalChain/from_llm)
