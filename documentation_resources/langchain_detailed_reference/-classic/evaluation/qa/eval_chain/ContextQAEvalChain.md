<!-- Source: https://reference.langchain.com/python/langchain-classic/evaluation/qa/eval_chain/ContextQAEvalChain -->
...
`LLMChain``StringEvaluator``LLMEvalChain`
...
Language model to call.](/python/langchain-classic/chains/llm/LLMChain/llm)[Aoutput\_key: str](/python/langchain-classic/chains/llm/LLMChain/output_key)[Aoutput\_parser](/python/langchain-classic/chains/llm/LLMChain/output_parser)
...
Whether the chain requires a reference string.](/python/langchain-classic/evaluation/qa/eval_chain/ContextQAEvalChain/requires_reference)

[attribute

requires\_input: bool

Whether the chain requires an input string.](/python/langchain-classic/evaluation/qa/eval_chain/ContextQAEvalChain/requires_input)

[attribute

model\_config](/python/langchain-classic/evaluation/qa/eval_chain/ContextQAEvalChain/model_config)

[attribute

evaluation\_name: str](/python/langchain-classic/evaluation/qa/eval_chain/ContextQAEvalChain/evaluation_name)

[method

is\_lc\_serializable](/python/langchain-classic/evaluation/qa/eval_chain/ContextQAEvalChain/is_lc_serializable)

[method

from\_llm

Load QA Eval Chain from LLM.](/python/langchain-classic/evaluation/qa/eval_chain/ContextQAEvalChain/from_llm)

[method

evaluate

Evaluate question answering examples and predictions.](/python/langchain-classic/evaluation/qa/eval_chain/ContextQAEvalChain/evaluate)
