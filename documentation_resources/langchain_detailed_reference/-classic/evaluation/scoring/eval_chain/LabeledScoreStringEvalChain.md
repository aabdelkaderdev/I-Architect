<!-- Source: https://reference.langchain.com/python/langchain-classic/evaluation/scoring/eval_chain/LabeledScoreStringEvalChain -->
...
## Inherited from[ScoreStringEvalChain](/python/langchain-classic/evaluation/scoring/eval_chain/ScoreStringEvalChain)

### Attributes

[Aoutput\_key: str](/python/langchain-classic/evaluation/scoring/eval_chain/ScoreStringEvalChain/output_key)[Aoutput\_parser: BaseOutputParser](/python/langchain-classic/evaluation/scoring/eval_chain/ScoreStringEvalChain/output_parser)[Anormalize\_by: float | None

—

The value to normalize the score by, if specified.](/python/langchain-classic/evaluation/scoring/eval_chain/ScoreStringEvalChain/normalize_by)[A](/python/langchain-classic/evaluation/scoring/eval_chain/ScoreStringEvalChain/criterion_name)
...
[Amodel\_config](/python/langchain-classic/evaluation/scoring/eval_chain/ScoreStringEvalChain/model_config)

[Arequires\_input: bool

—

Return whether the chain requires an input.](/python/langchain-classic/evaluation/scoring/eval_chain/ScoreStringEvalChain/requires_input)

[Aevaluation\_name: str

—

Get the name of the evaluation.](/python/langchain-classic/evaluation/scoring/eval_chain/ScoreStringEvalChain/evaluation_name)

### Methods

[Mis\_lc\_serializable](/python/langchain-classic/evaluation/scoring/eval_chain/ScoreStringEvalChain/is_lc_serializable)
...
The name of the evaluation.](/python/langchain-classic/evaluation/schema/StringEvaluator/evaluation_name)
...
Language model to call.](/python/langchain-classic/chains/llm/LLMChain/llm)[Aoutput\_key: str](/python/langchain-classic/chains/llm/LLMChain/output_key)[Aoutput\_parser: BaseLLMOutputParser
...
Whether to return only the final parsed result.](/python/langchain-classic/chains/llm/LLMChain/return_final_only)[Allm\_kwargs: dict](/python/langchain-classic/chains/llm/LLMChain/llm_kwargs)[Amodel\_config](/python/langchain-classic/chains/llm/LLMChain/model_config)[Ainput\_keys: list[str]
...
[Mis\_lc\_serializable](/python/langchain-classic/chains/llm/LLMChain/is_lc_serializable)[Mgenerate
...
—](/python/langchain-classic/chains/llm/LLMChain/aprep_prompts)
...
Return whether the chain requires a reference.](/python/langchain-classic/evaluation/scoring/eval_chain/LabeledScoreStringEvalChain/requires_reference)

[method

from\_llm

Initialize the LabeledScoreStringEvalChain from an LLM.](/python/langchain-classic/evaluation/scoring/eval_chain/LabeledScoreStringEvalChain/from_llm)
...
Utilize the LLM generate method for speed gains.](/python/langchain-classic/chains/llm/LLMChain/apply)
