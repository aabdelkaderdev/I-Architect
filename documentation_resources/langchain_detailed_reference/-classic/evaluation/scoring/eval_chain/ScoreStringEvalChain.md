<!-- Source: https://reference.langchain.com/python/langchain-classic/evaluation/scoring/eval_chain/ScoreStringEvalChain -->
...
output\_key: str](/python/langchain-classic/evaluation/scoring/eval_chain/ScoreStringEvalChain/output_key)

[attribute

output\_parser: BaseOutputParser](/python/langchain-classic/evaluation/scoring/eval_chain/ScoreStringEvalChain/output_parser)

[attribute

normalize\_by: float | None

The value to normalize the score by, if specified.](/python/langchain-classic/evaluation/scoring/eval_chain/ScoreStringEvalChain/normalize_by)

[attribute

criterion\_name: str

The name of the criterion being evaluated.](/python/langchain-classic/evaluation/scoring/eval_chain/ScoreStringEvalChain/criterion_name)

[attribute

model\_config](/python/langchain-classic/evaluation/scoring/eval_chain/ScoreStringEvalChain/model_config)

[attribute

requires\_reference: bool

Return whether the chain requires a reference.](/python/langchain-classic/evaluation/scoring/eval_chain/ScoreStringEvalChain/requires_reference)
...
str
The name of the evaluation.](/python/langchain-classic/evaluation/scoring/eval_chain/ScoreStringEvalChain/evaluation_name)

[method

is\_lc\_serializable](/python/langchain-classic/evaluation/scoring/eval_chain/ScoreStringEvalChain/is_lc_serializable)

[method

from\_llm

Initialize the ScoreStringEvalChain from an LLM.](/python/langchain-classic/evaluation/scoring/eval_chain/ScoreStringEvalChain/from_llm)
