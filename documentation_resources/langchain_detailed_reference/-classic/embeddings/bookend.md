<!-- Source: https://reference.langchain.com/python/langchain-classic/embeddings/bookend -->
...
DEPRECATED\_LOOKUP: dict](/python/langchain-classic/embeddings/bookend/DEPRECATED_LOOKUP)
