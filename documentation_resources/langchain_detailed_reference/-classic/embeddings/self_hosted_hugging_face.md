<!-- Source: https://reference.langchain.com/python/langchain-classic/embeddings/self_hosted_hugging_face -->

Modulev1.2.13 (latest)●Since v1.0

# self\_hosted\_hugging\_face

## Attributes

[attribute

DEPRECATED\_LOOKUP: dict](/python/langchain-classic/embeddings/self_hosted_hugging_face/DEPRECATED_LOOKUP)
