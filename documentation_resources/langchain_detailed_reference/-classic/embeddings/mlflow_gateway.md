<!-- Source: https://reference.langchain.com/python/langchain-classic/embeddings/mlflow_gateway -->
...
DEPRECATED\_LOOKUP: dict](/python/langchain-classic/embeddings/mlflow_gateway/DEPRECATED_LOOKUP)
