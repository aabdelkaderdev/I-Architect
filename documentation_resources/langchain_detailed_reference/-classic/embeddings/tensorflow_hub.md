<!-- Source: https://reference.langchain.com/python/langchain-classic/embeddings/tensorflow_hub -->
...
DEPRECATED\_LOOKUP: dict](/python/langchain-classic/embeddings/tensorflow_hub/DEPRECATED_LOOKUP)
