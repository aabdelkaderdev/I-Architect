<!-- Source: https://reference.langchain.com/python/langchain-classic/embeddings/sentence_transformer -->
...
DEPRECATED\_LOOKUP: dict](/python/langchain-classic/embeddings/sentence_transformer/DEPRECATED_LOOKUP)
