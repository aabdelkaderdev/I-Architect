<!-- Source: https://reference.langchain.com/python/langchain-classic/embeddings/fastembed -->
...
DEPRECATED\_LOOKUP: dict](/python/langchain-classic/embeddings/fastembed/DEPRECATED_LOOKUP)
