<!-- Source: https://reference.langchain.com/python/langchain-classic/embeddings/llm_rails -->
...
DEPRECATED\_LOOKUP: dict](/python/langchain-classic/embeddings/llm_rails/DEPRECATED_LOOKUP)
