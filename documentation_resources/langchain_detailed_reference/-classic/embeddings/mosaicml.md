<!-- Source: https://reference.langchain.com/python/langchain-classic/embeddings/mosaicml -->
...
DEPRECATED\_LOOKUP: dict](/python/langchain-classic/embeddings/mosaicml/DEPRECATED_LOOKUP)
