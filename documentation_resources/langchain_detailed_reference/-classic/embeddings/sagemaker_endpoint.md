<!-- Source: https://reference.langchain.com/python/langchain-classic/embeddings/sagemaker_endpoint -->
...
DEPRECATED\_LOOKUP: dict](/python/langchain-classic/embeddings/sagemaker_endpoint/DEPRECATED_LOOKUP)
