<!-- Source: https://reference.langchain.com/python/langchain-classic/embeddings/mlflow -->
...
DEPRECATED\_LOOKUP: dict](/python/langchain-classic/embeddings/mlflow/DEPRECATED_LOOKUP)
