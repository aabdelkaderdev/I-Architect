<!-- Source: https://reference.langchain.com/python/langchain-classic/embeddings/gpt4all -->
...
DEPRECATED\_LOOKUP: dict](/python/langchain-classic/embeddings/gpt4all/DEPRECATED_LOOKUP)
