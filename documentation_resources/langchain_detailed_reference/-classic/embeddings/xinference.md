<!-- Source: https://reference.langchain.com/python/langchain-classic/embeddings/xinference -->
...
DEPRECATED\_LOOKUP: dict](/python/langchain-classic/embeddings/xinference/DEPRECATED_LOOKUP)
