<!-- Source: https://reference.langchain.com/python/langchain-classic/embeddings/cloudflare_workersai -->

Modulev1.2.13 (latest)●Since v1.0

# cloudflare\_workersai

## Attributes

[attribute

DEPRECATED\_LOOKUP: dict](/python/langchain-classic/embeddings/cloudflare_workersai/DEPRECATED_LOOKUP)
