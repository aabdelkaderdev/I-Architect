<!-- Source: https://reference.langchain.com/python/langchain-classic/embeddings/huggingface -->
...
DEPRECATED\_LOOKUP: dict](/python/langchain-classic/embeddings/huggingface/DEPRECATED_LOOKUP)
