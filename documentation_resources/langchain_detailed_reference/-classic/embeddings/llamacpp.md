<!-- Source: https://reference.langchain.com/python/langchain-classic/embeddings/llamacpp -->
...
DEPRECATED\_LOOKUP: dict](/python/langchain-classic/embeddings/llamacpp/DEPRECATED_LOOKUP)
