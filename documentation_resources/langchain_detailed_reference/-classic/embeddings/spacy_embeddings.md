<!-- Source: https://reference.langchain.com/python/langchain-classic/embeddings/spacy_embeddings -->
...
DEPRECATED\_LOOKUP: dict](/python/langchain-classic/embeddings/spacy_embeddings/DEPRECATED_LOOKUP)
