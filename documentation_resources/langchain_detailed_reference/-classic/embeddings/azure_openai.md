<!-- Source: https://reference.langchain.com/python/langchain-classic/embeddings/azure_openai -->
...
DEPRECATED\_LOOKUP: dict](/python/langchain-classic/embeddings/azure_openai/DEPRECATED_LOOKUP)
