<!-- Source: https://reference.langchain.com/python/langchain-classic/embeddings/octoai_embeddings -->
...
DEPRECATED\_LOOKUP: dict](/python/langchain-classic/embeddings/octoai_embeddings/DEPRECATED_LOOKUP)
