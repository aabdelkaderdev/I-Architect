<!-- Source: https://reference.langchain.com/python/langchain-classic/embeddings/huggingface_hub -->
...
DEPRECATED\_LOOKUP: dict](/python/langchain-classic/embeddings/huggingface_hub/DEPRECATED_LOOKUP)
