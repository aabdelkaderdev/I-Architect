<!-- Source: https://reference.langchain.com/python/langchain-classic/embeddings/nlpcloud -->
...
DEPRECATED\_LOOKUP: dict](/python/langchain-classic/embeddings/nlpcloud/DEPRECATED_LOOKUP)
