<!-- Source: https://reference.langchain.com/python/langchain-classic/output_parsers/fix/OutputFixingParser -->
...
The parser to use to parse the output.](/python/langchain-classic/output_parsers/fix/OutputFixingParser/parser)

[attribute

retry\_chain: Annotated[RunnableSerializable[OutputFixingParserRetryChainInput, str] | Any, SkipValidation()]

The RunnableSerializable to use to retry the completion (Legacy: LLMChain).](/python/langchain-classic/output_parsers/fix/OutputFixingParser/retry_chain)

[attribute

max\_retries: int

The maximum number of times to retry the parse.](/python/langchain-classic/output_parsers/fix/OutputFixingParser/max_retries)

[attribute

legacy: bool

Whether to use the run or arun method of the retry\_chain.](/python/langchain-classic/output_parsers/fix/OutputFixingParser/legacy)

[attribute

OutputType: type[T]](/python/langchain-classic/output_parsers/fix/OutputFixingParser/OutputType)

[method

is\_lc\_serializable](/python/langchain-classic/output_parsers/fix/OutputFixingParser/is_lc_serializable)

[method

from\_llm

Create an OutputFixingParser from a language model and a parser.](/python/langchain-classic/output_parsers/fix/OutputFixingParser/from_llm)

[method

parse](/python/langchain-classic/output_parsers/fix/OutputFixingParser/parse)

[method

aparse](/python/langchain-classic/output_parsers/fix/OutputFixingParser/aparse)

[method

get\_format\_instructions](/python/langchain-classic/output_parsers/fix/OutputFixingParser/get_format_instructions)
