<!-- Source: https://reference.langchain.com/python/langchain-classic/output_parsers/regex/RegexParser -->
...
The regex to use to parse the output.](/python/langchain-classic/output_parsers/regex/RegexParser/regex)

[attribute

output\_keys: list[str]

The keys to use for the output.](/python/langchain-classic/output_parsers/regex/RegexParser/output_keys)

[attribute

default\_output\_key: str | None

The default key to use for the output.](/python/langchain-classic/output_parsers/regex/RegexParser/default_output_key)

[method

is\_lc\_serializable](/python/langchain-classic/output_parsers/regex/RegexParser/is_lc_serializable)

[method

parse

Parse the output of an LLM call.](/python/langchain-classic/output_parsers/regex/RegexParser/parse)
