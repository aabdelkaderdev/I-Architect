<!-- Source: https://reference.langchain.com/python/langchain-classic/output_parsers/boolean/BooleanOutputParser -->
...
The string value that should be parsed as True.](/python/langchain-classic/output_parsers/boolean/BooleanOutputParser/true_val)

[attribute

false\_val: str

The string value that should be parsed as False.](/python/langchain-classic/output_parsers/boolean/BooleanOutputParser/false_val)

[method

parse

Parse the output of an LLM call to a boolean.](/python/langchain-classic/output_parsers/boolean/BooleanOutputParser/parse)
