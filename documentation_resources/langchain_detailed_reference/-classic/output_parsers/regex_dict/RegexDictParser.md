<!-- Source: https://reference.langchain.com/python/langchain-classic/output_parsers/regex_dict/RegexDictParser -->
...
[Mget\_format\_instructions](/python/langchain-core/output_parsers/base/BaseOutputParser/get_format_instructions)
...
The regex pattern to use to parse the output.](/python/langchain-classic/output_parsers/regex_dict/RegexDictParser/regex_pattern)

[attribute

output\_key\_to\_format: dict[str, str]

The keys to use for the output.](/python/langchain-classic/output_parsers/regex_dict/RegexDictParser/output_key_to_format)

[attribute

no\_update\_value: str | None

The default key to use for the output.](/python/langchain-classic/output_parsers/regex_dict/RegexDictParser/no_update_value)

[method

parse

Parse the output of an LLM call.](/python/langchain-classic/output_parsers/regex_dict/RegexDictParser/parse)
