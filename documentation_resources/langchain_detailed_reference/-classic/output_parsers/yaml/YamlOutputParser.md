<!-- Source: https://reference.langchain.com/python/langchain-classic/output_parsers/yaml/YamlOutputParser -->
...
pydantic\_object: type[T]

The Pydantic model to parse.](/python/langchain-classic/output_parsers/yaml/YamlOutputParser/pydantic_object)
...
within triple backticks with optional yaml or yml prefix.](/python/langchain-classic/output_parsers/yaml/YamlOutputParser/pattern)

[attribute

OutputType: type[T]](/python/langchain-classic/output_parsers/yaml/YamlOutputParser/OutputType)

[method

parse](/python/langchain-classic/output_parsers/yaml/YamlOutputParser/parse)

[method

get\_format\_instructions](/python/langchain-classic/output_parsers/yaml/YamlOutputParser/get_format_instructions)
