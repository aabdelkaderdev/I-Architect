<!-- Source: https://reference.langchain.com/python/langchain-classic/output_parsers/structured/StructuredOutputParser -->
...
response\_schemas: list[ResponseSchema]

The schemas for the response.](/python/langchain-classic/output_parsers/structured/StructuredOutputParser/response_schemas)

[method

from\_response\_schemas

Create a StructuredOutputParser from a list of ResponseSchema.](/python/langchain-classic/output_parsers/structured/StructuredOutputParser/from_response_schemas)
...
```](/python/langchain-classic/output_parsers/structured/StructuredOutputParser/get_format_instructions)

[method

parse](/python/langchain-classic/output_parsers/structured/StructuredOutputParser/parse)
