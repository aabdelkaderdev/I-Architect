<!-- Source: https://reference.langchain.com/python/langchain-classic/output_parsers/enum/EnumOutputParser -->
...
The enum to parse. Its values must be strings.](/python/langchain-classic/output_parsers/enum/EnumOutputParser/enum)

[attribute

OutputType: type[Enum]](/python/langchain-classic/output_parsers/enum/EnumOutputParser/OutputType)

[method

parse](/python/langchain-classic/output_parsers/enum/EnumOutputParser/parse)

[method

get\_format\_instructions](/python/langchain-classic/output_parsers/enum/EnumOutputParser/get_format_instructions)
