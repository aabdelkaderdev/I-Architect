<!-- Source: https://reference.langchain.com/python/langchain-classic/indexes/graph -->
...
DEPRECATED\_LOOKUP: dict](/python/langchain-classic/indexes/graph/DEPRECATED_LOOKUP)
