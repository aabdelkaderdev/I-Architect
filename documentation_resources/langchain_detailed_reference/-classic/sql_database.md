<!-- Source: https://reference.langchain.com/python/langchain-classic/sql_database -->
...
DEPRECATED\_LOOKUP: dict](/python/langchain-classic/sql_database/DEPRECATED_LOOKUP)
