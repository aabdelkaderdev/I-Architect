<!-- Source: https://reference.langchain.com/python/langchain-classic/utilities/outline -->
...
DEPRECATED\_LOOKUP: dict](/python/langchain-classic/utilities/outline/DEPRECATED_LOOKUP)
