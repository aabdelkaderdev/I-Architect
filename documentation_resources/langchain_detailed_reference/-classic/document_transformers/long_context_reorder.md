<!-- Source: https://reference.langchain.com/python/langchain-classic/document_transformers/long_context_reorder -->

Modulev1.2.13 (latest)●Since v1.0

# long\_context\_reorder

## Attributes

[attribute

DEPRECATED\_LOOKUP: dict](/python/langchain-classic/document_transformers/long_context_reorder/DEPRECATED_LOOKUP)
