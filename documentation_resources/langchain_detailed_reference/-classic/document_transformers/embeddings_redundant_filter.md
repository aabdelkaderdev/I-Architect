<!-- Source: https://reference.langchain.com/python/langchain-classic/document_transformers/embeddings_redundant_filter -->

Modulev1.2.13 (latest)●Since v1.0

# embeddings\_redundant\_filter

## Attributes

[attribute

DEPRECATED\_LOOKUP: dict](/python/langchain-classic/document_transformers/embeddings_redundant_filter/DEPRECATED_LOOKUP)
