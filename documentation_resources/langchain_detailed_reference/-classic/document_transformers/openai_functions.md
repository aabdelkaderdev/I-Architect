<!-- Source: https://reference.langchain.com/python/langchain-classic/document_transformers/openai_functions -->
...
DEPRECATED\_LOOKUP: dict](/python/langchain-classic/document_transformers/openai_functions/DEPRECATED_LOOKUP)
