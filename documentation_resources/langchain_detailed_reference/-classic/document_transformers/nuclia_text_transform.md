<!-- Source: https://reference.langchain.com/python/langchain-classic/document_transformers/nuclia_text_transform -->

Modulev1.2.13 (latest)●Since v1.0

# nuclia\_text\_transform

## Attributes

[attribute

DEPRECATED\_LOOKUP: dict](/python/langchain-classic/document_transformers/nuclia_text_transform/DEPRECATED_LOOKUP)
