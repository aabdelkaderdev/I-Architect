<!-- Source: https://reference.langchain.com/python/langchain-classic/document_transformers/beautiful_soup_transformer -->

Modulev1.2.13 (latest)●Since v1.0

# beautiful\_soup\_transformer

## Attributes

[attribute

DEPRECATED\_LOOKUP: dict](/python/langchain-classic/document_transformers/beautiful_soup_transformer/DEPRECATED_LOOKUP)
