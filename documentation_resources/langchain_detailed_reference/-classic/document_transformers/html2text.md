<!-- Source: https://reference.langchain.com/python/langchain-classic/document_transformers/html2text -->
...
DEPRECATED\_LOOKUP: dict](/python/langchain-classic/document_transformers/html2text/DEPRECATED_LOOKUP)
