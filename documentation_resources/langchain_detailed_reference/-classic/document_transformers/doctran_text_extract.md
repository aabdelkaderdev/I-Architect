<!-- Source: https://reference.langchain.com/python/langchain-classic/document_transformers/doctran_text_extract -->

Modulev1.2.13 (latest)●Since v1.0

# doctran\_text\_extract

## Attributes

[attribute

DEPRECATED\_LOOKUP: dict](/python/langchain-classic/document_transformers/doctran_text_extract/DEPRECATED_LOOKUP)
