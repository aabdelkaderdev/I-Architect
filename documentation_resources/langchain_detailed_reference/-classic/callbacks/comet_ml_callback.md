<!-- Source: https://reference.langchain.com/python/langchain-classic/callbacks/comet_ml_callback -->
...
DEPRECATED\_LOOKUP: dict](/python/langchain-classic/callbacks/comet_ml_callback/DEPRECATED_LOOKUP)
