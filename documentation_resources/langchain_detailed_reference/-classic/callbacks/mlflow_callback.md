<!-- Source: https://reference.langchain.com/python/langchain-classic/callbacks/mlflow_callback -->
...
DEPRECATED\_LOOKUP: dict](/python/langchain-classic/callbacks/mlflow_callback/DEPRECATED_LOOKUP)
