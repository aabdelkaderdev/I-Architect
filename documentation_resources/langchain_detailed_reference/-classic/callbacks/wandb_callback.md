<!-- Source: https://reference.langchain.com/python/langchain-classic/callbacks/wandb_callback -->
...
DEPRECATED\_LOOKUP: dict](/python/langchain-classic/callbacks/wandb_callback/DEPRECATED_LOOKUP)
