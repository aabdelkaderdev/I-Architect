<!-- Source: https://reference.langchain.com/python/langchain-classic/callbacks/trubrics_callback -->
...
DEPRECATED\_LOOKUP: dict](/python/langchain-classic/callbacks/trubrics_callback/DEPRECATED_LOOKUP)
