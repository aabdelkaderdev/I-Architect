<!-- Source: https://reference.langchain.com/python/langchain-classic/callbacks/human -->
...
DEPRECATED\_LOOKUP: dict](/python/langchain-classic/callbacks/human/DEPRECATED_LOOKUP)
