<!-- Source: https://reference.langchain.com/python/langchain-classic/callbacks/arize_callback -->
...
DEPRECATED\_LOOKUP: dict](/python/langchain-classic/callbacks/arize_callback/DEPRECATED_LOOKUP)
