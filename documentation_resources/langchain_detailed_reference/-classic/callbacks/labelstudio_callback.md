<!-- Source: https://reference.langchain.com/python/langchain-classic/callbacks/labelstudio_callback -->

Modulev1.2.13 (latest)●Since v1.0

# labelstudio\_callback

## Attributes

[attribute

DEPRECATED\_LOOKUP: dict](/python/langchain-classic/callbacks/labelstudio_callback/DEPRECATED_LOOKUP)
