<!-- Source: https://reference.langchain.com/python/langchain-classic/callbacks/manager -->
...
DEPRECATED\_LOOKUP: dict](/python/langchain-classic/callbacks/manager/DEPRECATED_LOOKUP)
