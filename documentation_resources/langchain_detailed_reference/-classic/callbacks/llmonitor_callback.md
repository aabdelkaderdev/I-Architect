<!-- Source: https://reference.langchain.com/python/langchain-classic/callbacks/llmonitor_callback -->
...
DEPRECATED\_LOOKUP: dict](/python/langchain-classic/callbacks/llmonitor_callback/DEPRECATED_LOOKUP)
