<!-- Source: https://reference.langchain.com/python/langchain-classic/callbacks/context_callback -->
...
DEPRECATED\_LOOKUP: dict](/python/langchain-classic/callbacks/context_callback/DEPRECATED_LOOKUP)
