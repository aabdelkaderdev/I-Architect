<!-- Source: https://reference.langchain.com/python/langchain-classic/callbacks/arthur_callback -->
...
DEPRECATED\_LOOKUP: dict](/python/langchain-classic/callbacks/arthur_callback/DEPRECATED_LOOKUP)
