<!-- Source: https://reference.langchain.com/python/langchain-classic/callbacks/promptlayer_callback -->

Modulev1.2.13 (latest)●Since v1.0

# promptlayer\_callback

## Attributes

[attribute

DEPRECATED\_LOOKUP: dict](/python/langchain-classic/callbacks/promptlayer_callback/DEPRECATED_LOOKUP)
