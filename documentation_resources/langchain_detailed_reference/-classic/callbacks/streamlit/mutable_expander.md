<!-- Source: https://reference.langchain.com/python/langchain-classic/callbacks/streamlit/mutable_expander -->
...
DEPRECATED\_LOOKUP: dict](/python/langchain-classic/callbacks/streamlit/mutable_expander/DEPRECATED_LOOKUP)
