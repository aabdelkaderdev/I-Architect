<!-- Source: https://reference.langchain.com/python/langchain-classic/retrievers/outline -->
...
DEPRECATED\_LOOKUP: dict](/python/langchain-classic/retrievers/outline/DEPRECATED_LOOKUP)
