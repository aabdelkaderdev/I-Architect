<!-- Source: https://reference.langchain.com/python/langchain-classic/retrievers/document_compressors/flashrank_rerank -->
...
DEPRECATED\_LOOKUP: dict](/python/langchain-classic/retrievers/document_compressors/flashrank_rerank/DEPRECATED_LOOKUP)
