<!-- Source: https://reference.langchain.com/python/langchain-classic/retrievers/chatgpt_plugin_retriever -->

Modulev1.2.13 (latest)●Since v1.0

# chatgpt\_plugin\_retriever

## Attributes

[attribute

DEPRECATED\_LOOKUP: dict](/python/langchain-classic/retrievers/chatgpt_plugin_retriever/DEPRECATED_LOOKUP)
