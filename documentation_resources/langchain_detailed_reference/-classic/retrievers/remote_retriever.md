<!-- Source: https://reference.langchain.com/python/langchain-classic/retrievers/remote_retriever -->
...
DEPRECATED\_LOOKUP: dict](/python/langchain-classic/retrievers/remote_retriever/DEPRECATED_LOOKUP)
