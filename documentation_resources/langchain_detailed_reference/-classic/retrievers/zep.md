<!-- Source: https://reference.langchain.com/python/langchain-classic/retrievers/zep -->
...
DEPRECATED\_LOOKUP: dict](/python/langchain-classic/retrievers/zep/DEPRECATED_LOOKUP)
