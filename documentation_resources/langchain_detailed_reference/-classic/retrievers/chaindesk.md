<!-- Source: https://reference.langchain.com/python/langchain-classic/retrievers/chaindesk -->
...
DEPRECATED\_LOOKUP: dict](/python/langchain-classic/retrievers/chaindesk/DEPRECATED_LOOKUP)
