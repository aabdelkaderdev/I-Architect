<!-- Source: https://reference.langchain.com/python/langchain-classic/retrievers/zilliz -->
...
DEPRECATED\_LOOKUP: dict](/python/langchain-classic/retrievers/zilliz/DEPRECATED_LOOKUP)
