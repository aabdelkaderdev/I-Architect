<!-- Source: https://reference.langchain.com/python/langchain-classic/retrievers/azure_ai_search -->
...
DEPRECATED\_LOOKUP: dict](/python/langchain-classic/retrievers/azure_ai_search/DEPRECATED_LOOKUP)
