<!-- Source: https://reference.langchain.com/python/langchain-classic/retrievers/multi_query/LineListOutputParser -->
...
parse](/python/langchain-classic/retrievers/multi_query/LineListOutputParser/parse)
