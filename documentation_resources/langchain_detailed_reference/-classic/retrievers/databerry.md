<!-- Source: https://reference.langchain.com/python/langchain-classic/retrievers/databerry -->
...
DEPRECATED\_LOOKUP: dict](/python/langchain-classic/retrievers/databerry/DEPRECATED_LOOKUP)
