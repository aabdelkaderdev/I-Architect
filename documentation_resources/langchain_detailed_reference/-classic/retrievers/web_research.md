<!-- Source: https://reference.langchain.com/python/langchain-classic/retrievers/web_research -->
...
DEPRECATED\_LOOKUP: dict](/python/langchain-classic/retrievers/web_research/DEPRECATED_LOOKUP)
