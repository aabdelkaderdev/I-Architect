<!-- Source: https://reference.langchain.com/python/langchain-classic/retrievers/pubmed -->
...
DEPRECATED\_LOOKUP: dict](/python/langchain-classic/retrievers/pubmed/DEPRECATED_LOOKUP)
