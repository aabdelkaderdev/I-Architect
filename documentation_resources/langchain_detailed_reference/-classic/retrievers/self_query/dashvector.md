<!-- Source: https://reference.langchain.com/python/langchain-classic/retrievers/self_query/dashvector -->
...
DEPRECATED\_LOOKUP: dict](/python/langchain-classic/retrievers/self_query/dashvector/DEPRECATED_LOOKUP)
