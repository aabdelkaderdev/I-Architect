<!-- Source: https://reference.langchain.com/python/langchain-classic/retrievers/self_query/supabase -->
...
DEPRECATED\_LOOKUP: dict](/python/langchain-classic/retrievers/self_query/supabase/DEPRECATED_LOOKUP)
