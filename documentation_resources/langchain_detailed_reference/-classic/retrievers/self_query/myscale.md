<!-- Source: https://reference.langchain.com/python/langchain-classic/retrievers/self_query/myscale -->
...
DEPRECATED\_LOOKUP: dict](/python/langchain-classic/retrievers/self_query/myscale/DEPRECATED_LOOKUP)
