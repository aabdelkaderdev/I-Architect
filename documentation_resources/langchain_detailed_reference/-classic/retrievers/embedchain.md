<!-- Source: https://reference.langchain.com/python/langchain-classic/retrievers/embedchain -->
...
DEPRECATED\_LOOKUP: dict](/python/langchain-classic/retrievers/embedchain/DEPRECATED_LOOKUP)
