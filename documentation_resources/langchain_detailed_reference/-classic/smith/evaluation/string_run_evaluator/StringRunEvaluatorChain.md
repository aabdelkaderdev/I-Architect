<!-- Source: https://reference.langchain.com/python/langchain-classic/smith/evaluation/string_run_evaluator/StringRunEvaluatorChain -->
...
run\_mapper: StringRunMapper

Maps the Run to a dictionary with 'input' and 'prediction' strings.](/python/langchain-classic/smith/evaluation/string_run_evaluator/StringRunEvaluatorChain/run_mapper)

[attribute

example\_mapper: StringExampleMapper | None

Maps the Example (dataset row) to a dictionary
with a 'reference' string.](/python/langchain-classic/smith/evaluation/string_run_evaluator/StringRunEvaluatorChain/example_mapper)

[attribute

name: str

The name of the evaluation metric.](/python/langchain-classic/smith/evaluation/string_run_evaluator/StringRunEvaluatorChain/name)

[attribute

string\_evaluator: StringEvaluator

The evaluation chain.](/python/langchain-classic/smith/evaluation/string_run_evaluator/StringRunEvaluatorChain/string_evaluator)

[attribute

input\_keys: list[str]](/python/langchain-classic/smith/evaluation/string_run_evaluator/StringRunEvaluatorChain/input_keys)

[attribute

output\_keys: list[str]](/python/langchain-classic/smith/evaluation/string_run_evaluator/StringRunEvaluatorChain/output_keys)

[method

evaluate\_run

Evaluate an example.](/python/langchain-classic/smith/evaluation/string_run_evaluator/StringRunEvaluatorChain/evaluate_run)

[method

aevaluate\_run

Evaluate an example.](/python/langchain-classic/smith/evaluation/string_run_evaluator/StringRunEvaluatorChain/aevaluate_run)
...
The method supports LLM and chain runs.](/python/langchain-classic/smith/evaluation/string_run_evaluator/StringRunEvaluatorChain/from_run_and_data_type)
