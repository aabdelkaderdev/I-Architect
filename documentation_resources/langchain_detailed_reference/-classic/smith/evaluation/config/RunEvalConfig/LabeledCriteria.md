<!-- Source: https://reference.langchain.com/python/langchain-classic/smith/evaluation/config/RunEvalConfig/LabeledCriteria -->
...
criteria: CRITERIA\_TYPE | None](/python/langchain-classic/smith/evaluation/config/RunEvalConfig/LabeledCriteria/criteria)[attribute

llm: BaseLanguageModel | None](/python/langchain-classic/smith/evaluation/config/RunEvalConfig/LabeledCriteria/llm)[attribute

evaluator\_type: EvaluatorType](/python/langchain-classic/smith/evaluation/config/RunEvalConfig/LabeledCriteria/evaluator_type)
