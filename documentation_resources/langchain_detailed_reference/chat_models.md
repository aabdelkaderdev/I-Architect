<!-- Source: https://reference.langchain.com/python/langchain/chat_models -->
...
for supported model parameters to use as `**kwargs`.](/python/langchain/chat_models/init_chat_model)
...
Factory functions for chat models.](/python/langchain/chat_models/base)
