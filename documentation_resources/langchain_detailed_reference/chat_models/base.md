<!-- Source: https://reference.langchain.com/python/langchain/chat_models/base -->
...
for supported model parameters to use as `**kwargs`.](/python/langchain/chat_models/base/init_chat_model)
