...
| --- | --- | --- |
| `example_id` | `UUID | str | None` | Default:`None`  The ID of the example being traced. |
...
name: str](/python/langchain-core/tracers/run_collector/RunCollectorCallbackHandler/name)[attribute

example\_id](/python/langchain-core/tracers/run_collector/RunCollectorCallbackHandler/example_id)[attribute

traced\_runs: list[Run]](/python/langchain-core/tracers/run_collector/RunCollectorCallbackHandler/traced_runs)
