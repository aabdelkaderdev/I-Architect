...
| --- | --- | --- |
| `function`\* | `Callable[[str], None]` | The callback function to call. |
...
| Name | Type |
| --- | --- |
| function | [Callable](https://docs.python.org/3/library/typing.html#typing.Callable)[[[str](https://docs.python.org/3/library/stdtypes.html#str)], None] |
...
This is used to identify the tracer in the logs.](/python/langchain-core/tracers/stdout/FunctionCallbackHandler/name)[attribute

function\_callback: function](/python/langchain-core/tracers/stdout/FunctionCallbackHandler/function_callback)
...
Get the parents of a run.](/python/langchain-core/tracers/stdout/FunctionCallbackHandler/get_parents)[method
