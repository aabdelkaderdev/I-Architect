...
`FunctionMessage``BaseMessageChunk`

## Attributes

[attribute

type: Literal['FunctionMessageChunk']

The type of the message (used for serialization).](/python/langchain-core/messages/function/FunctionMessageChunk/type)

## Inherited from[FunctionMessage](/python/langchain-core/messages/function/FunctionMessage)
...
The name of the function that was executed.](/python/langchain-core/messages/function/FunctionMessage/name)
