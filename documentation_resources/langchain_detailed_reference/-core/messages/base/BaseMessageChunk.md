...
Examples: response headers, logprobs, token counts, model name.](/python/langchain-core/messages/base/BaseMessage/response_metadata)[Atype: str

—

The type of the message. Must be a string that is unique to the message type.](/python/langchain-core/messages/base/BaseMessage/type)[Aname: str | None
