...
| --- | --- | --- |
| `url` | `str | None` | Default:`None`  URL of the video. |
| `base64` | `str | None` | Default:`None`  Base64-encoded video data. |
| `file_id` | `str | None` | Default:`None`  ID of the video file from a file storage system. |
| `mime_type` | `str | None` | Default:`None`  MIME type of the video.  Required for base64 data. |
