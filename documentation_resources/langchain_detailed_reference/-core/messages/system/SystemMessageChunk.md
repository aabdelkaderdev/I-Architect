<!-- Source: https://reference.langchain.com/python/langchain-core/messages/system/SystemMessageChunk -->
...
`SystemMessage``BaseMessageChunk`
...
The type of the message (used for serialization).](/python/langchain-core/messages/system/SystemMessageChunk/type)
