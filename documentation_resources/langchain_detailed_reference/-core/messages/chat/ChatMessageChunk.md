<!-- Source: https://reference.langchain.com/python/langchain-core/messages/chat/ChatMessageChunk -->
...
The type of the message (used during serialization).](/python/langchain-core/messages/chat/ChatMessageChunk/type)

## Inherited from[ChatMessage](/python/langchain-core/messages/chat/ChatMessage)
...
The speaker / role of the Message.](/python/langchain-core/messages/chat/ChatMessage/role)
