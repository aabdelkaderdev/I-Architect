<!-- Source: https://reference.langchain.com/python/langchain-core/runnables/router -->
...
Router input.](/python/langchain-core/runnables/router/RouterInput)[class

RouterRunnable

`Runnable` that routes to a set of `Runnable` based on `Input['key']`.

Returns the output of the selected Runnable.](/python/langchain-core/runnables/router/RouterRunnable)
