...
get\_name](/python/langchain-core/runnables/base/RunnableEach/get_name)[method

bind](/python/langchain-core/runnables/base/RunnableEach/bind)[method

with\_config](/python/langchain-core/runnables/base/RunnableEach/with_config)[method
...
any tags or metadata added to the run.](/python/langchain-core/runnables/base/RunnableEach/with_listeners)[method
...
The `Run` object contains information about the run, including its `id`,
`type`, `input`, `output`, `error`, `start_time`, `end_time`, and
any tags or metadata added to the run.](/python/langchain-core/runnables/base/RunnableEach/with_alisteners)

## Inherited from[RunnableEachBase](/python/langchain-core/runnables/base/RunnableEachBase)

### Attributes

[Abound: Runnable[Input, Output]](/python/langchain-core/runnables/base/RunnableEachBase/bound)[Amodel\_config](/python/langchain-core/runnables/base/RunnableEachBase/model_config)[AInputType: Any](/python/langchain-core/runnables/base/RunnableEachBase/InputType)[AOutputType: type[list[Output]]](/python/langchain-core/runnables/base/RunnableEachBase/OutputType)[Aconfig\_specs: list[ConfigurableFieldSpec]](/python/langchain-core/runnables/base/RunnableEachBase/config_specs)

### Methods

[Mget\_input\_schema](/python/langchain-core/runnables/base/RunnableEachBase/get_input_schema)[Mget\_output\_schema](/python/langchain-core/runnables/base/RunnableEachBase/get_output_schema)[Mget\_graph](/python/langchain-core/runnables/base/RunnableEachBase/get_graph)[Mis\_lc\_serializable

—

Return `True` as this class is serializable.](/python/langchain-core/runnables/base/RunnableEachBase/is_lc_serializable)[Mget\_lc\_namespace

—

Get the namespace of the LangChain object.](/python/langchain-core/runnables/base/RunnableEachBase/get_lc_namespace)[Minvoke](/python/langchain-core/runnables/base/RunnableEachBase/invoke)[Mainvoke](/python/langchain-core/runnables/base/RunnableEachBase/ainvoke)[Mastream\_events](/python/langchain-core/runnables/base/RunnableEachBase/astream_events)
...
Transform inputs to outputs.](/python/langchain-core/runnables/base/Runnable/atransform)[Mwith\_types
