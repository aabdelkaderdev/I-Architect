...
| --- | --- | --- |
| `runnables`\* | `Mapping[str, Runnable[Any, Output] | Callable[[Any], Output]]` | A mapping of keys to `Runnable` objects. |
...
| Name | Type |
| --- | --- |
| runnables | [Mapping](https://docs.python.org/3/library/typing.html#typing.Mapping)[[str](https://docs.python.org/3/library/stdtypes.html#str), [Runnable](/python/langchain-core/runnables/base/Runnable)[[Any](https://docs.python.org/3/library/typing.html#typing.Any), [Output](/python/langchain-core/runnables/utils/Output)] | [Callable](https://docs.python.org/3/library/typing.html#typing.Callable)[[[Any](https://docs.python.org/3/library/typing.html#typing.Any)], [Output](/python/langchain-core/runnables/utils/Output)]] |

## Attributes

[attribute

runnables: Mapping[str, Runnable[Any, Output]]](/python/langchain-core/runnables/router/RouterRunnable/runnables)[attribute

config\_specs: list[ConfigurableFieldSpec]](/python/langchain-core/runnables/router/RouterRunnable/config_specs)[attribute

model\_config](/python/langchain-core/runnables/router/RouterRunnable/model_config)
...
Return `True` as this class is serializable.](/python/langchain-core/runnables/router/RouterRunnable/is_lc_serializable)[method

get\_lc\_namespace

Get the namespace of the LangChain object.](/python/langchain-core/runnables/router/RouterRunnable/get_lc_namespace)[method

invoke](/python/langchain-core/runnables/router/RouterRunnable/invoke)[method

ainvoke](/python/langchain-core/runnables/router/RouterRunnable/ainvoke)[method

batch](/python/langchain-core/runnables/router/RouterRunnable/batch)[method

abatch](/python/langchain-core/runnables/router/RouterRunnable/abatch)[method

stream](/python/langchain-core/runnables/router/RouterRunnable/stream)[method

astream](/python/langchain-core/runnables/router/RouterRunnable/astream)
