...
Either this or `example_selector` should be provided.](/python/langchain-core/prompts/few_shot_with_templates/FewShotPromptWithTemplates/examples)[attribute

example\_selector: BaseExampleSelector | None

`ExampleSelector` to choose the examples to format into the prompt.

Either this or `examples` should be provided.](/python/langchain-core/prompts/few_shot_with_templates/FewShotPromptWithTemplates/example_selector)[attribute

example\_prompt: PromptTemplate

`PromptTemplate` used to format an individual example.](/python/langchain-core/prompts/few_shot_with_templates/FewShotPromptWithTemplates/example_prompt)[attribute

suffix: StringPromptTemplate

A `PromptTemplate` to put after the examples.](/python/langchain-core/prompts/few_shot_with_templates/FewShotPromptWithTemplates/suffix)[attribute

example\_separator: str

String separator used to join the prefix, the examples, and suffix.](/python/langchain-core/prompts/few_shot_with_templates/FewShotPromptWithTemplates/example_separator)[attribute

prefix: StringPromptTemplate | None

A `PromptTemplate` to put before the examples.](/python/langchain-core/prompts/few_shot_with_templates/FewShotPromptWithTemplates/prefix)[attribute

template\_format: PromptTemplateFormat

The format of the prompt template.

Options are: `'f-string'`, `'jinja2'`, `'mustache'`.](/python/langchain-core/prompts/few_shot_with_templates/FewShotPromptWithTemplates/template_format)[attribute

validate\_template: bool

Whether or not to try validating the template.](/python/langchain-core/prompts/few_shot_with_templates/FewShotPromptWithTemplates/validate_template)[attribute

model\_config](/python/langchain-core/prompts/few_shot_with_templates/FewShotPromptWithTemplates/model_config)
...
Get the namespace of the LangChain object.](/python/langchain-core/prompts/few_shot_with_templates/FewShotPromptWithTemplates/get_lc_namespace)[method

check\_examples\_and\_selector

Check that one and only one of examples/example\_selector are provided.](/python/langchain-core/prompts/few_shot_with_templates/FewShotPromptWithTemplates/check_examples_and_selector)[method

template\_is\_valid

Check that prefix, suffix, and input variables are consistent.](/python/langchain-core/prompts/few_shot_with_templates/FewShotPromptWithTemplates/template_is_valid)[method

format

Format the prompt with the inputs.](/python/langchain-core/prompts/few_shot_with_templates/FewShotPromptWithTemplates/format)[method

aformat

Async format the prompt with the inputs.](/python/langchain-core/prompts/few_shot_with_templates/FewShotPromptWithTemplates/aformat)[method

save

Save the prompt to a file.](/python/langchain-core/prompts/few_shot_with_templates/FewShotPromptWithTemplates/save)

## Inherited from[StringPromptTemplate](/python/langchain-core/prompts/string/StringPromptTemplate)
...
Format the prompt with the inputs.](/python/langchain-core/prompts/string/StringPromptTemplate/format_prompt)[Maformat\_prompt

—

Async format the prompt with the inputs.](/python/langchain-core/prompts/string/StringPromptTemplate/aformat_prompt)[Mpretty\_repr

—

Get a pretty representation of the prompt.](/python/langchain-core/prompts/string/StringPromptTemplate/pretty_repr)[Mpretty\_print
...
Tags to be used for tracing.](/python/langchain-core/prompts/base/BasePromptTemplate/tags)[AOutputType: Any
...
Async create `PromptValue`.](/python/langchain-core/prompts/base/BasePromptTemplate/aformat_prompt)[Mpartial

—

Return a partial of the prompt template.](/python/langchain-core/prompts/base/BasePromptTemplate/partial)[Mdict
