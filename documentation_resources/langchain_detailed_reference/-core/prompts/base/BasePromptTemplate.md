...
prompt.](/python/langchain-core/prompts/base/BasePromptTemplate/input_variables)[attribute

optional\_variables: list[str]

A list of the names of the variables for placeholder or `MessagePlaceholder` that
are optional.

These variables are auto inferred from the prompt and user need not provide them.](/python/langchain-core/prompts/base/BasePromptTemplate/optional_variables)[attribute

input\_types: builtins.dict[str, Any]

A dictionary of the types of the variables the prompt template expects.

If not provided, all variables are assumed to be strings.](/python/langchain-core/prompts/base/BasePromptTemplate/input_types)[attribute

output\_parser: BaseOutputParser | None

How to parse the output of calling an LLM on this formatted prompt.](/python/langchain-core/prompts/base/BasePromptTemplate/output_parser)[attribute

partial\_variables: Mapping[str, Any]

A dictionary of the partial variables the prompt template carries.

Partial variables populate the template so that you don't need to pass them in every
time you call the prompt.](/python/langchain-core/prompts/base/BasePromptTemplate/partial_variables)[attribute

metadata: builtins.dict[str, Any] | None

Metadata to be used for tracing.](/python/langchain-core/prompts/base/BasePromptTemplate/metadata)[attribute

tags: list[str] | None

Tags to be used for tracing.](/python/langchain-core/prompts/base/BasePromptTemplate/tags)[attribute

model\_config](/python/langchain-core/prompts/base/BasePromptTemplate/model_config)[attribute
...
Validate variable names do not include restricted names.](/python/langchain-core/prompts/base/BasePromptTemplate/validate_variable_names)[method

get\_lc\_namespace

Get the namespace of the LangChain object.](/python/langchain-core/prompts/base/BasePromptTemplate/get_lc_namespace)[method

is\_lc\_serializable

Return `True` as this class is serializable.](/python/langchain-core/prompts/base/BasePromptTemplate/is_lc_serializable)[method

get\_input\_schema

Get the input schema for the prompt.](/python/langchain-core/prompts/base/BasePromptTemplate/get_input_schema)[method

invoke

Invoke the prompt.](/python/langchain-core/prompts/base/BasePromptTemplate/invoke)[method

ainvoke

Async invoke the prompt.](/python/langchain-core/prompts/base/BasePromptTemplate/ainvoke)[method

format\_prompt

Create `PromptValue`.](/python/langchain-core/prompts/base/BasePromptTemplate/format_prompt)[method

aformat\_prompt

Async create `PromptValue`.](/python/langchain-core/prompts/base/BasePromptTemplate/aformat_prompt)[method

partial

Return a partial of the prompt template.](/python/langchain-core/prompts/base/BasePromptTemplate/partial)[method

format

Format the prompt with the inputs.](/python/langchain-core/prompts/base/BasePromptTemplate/format)[method

aformat

Async format the prompt with the inputs.](/python/langchain-core/prompts/base/BasePromptTemplate/aformat)[method

dict

Return dictionary representation of prompt.](/python/langchain-core/prompts/base/BasePromptTemplate/dict)[method
