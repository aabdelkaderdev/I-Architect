...
`_FewShotPromptTemplateMixin``StringPromptTemplate`

## Constructors

[constructor

\_\_init\_\_](/python/langchain-core/prompts/few_shot/FewShotPromptTemplate/__init__)
...
Whether or not to try validating the template.](/python/langchain-core/prompts/few_shot/FewShotPromptTemplate/validate_template)[attribute

example\_prompt: PromptTemplate

`PromptTemplate` used to format an individual example.](/python/langchain-core/prompts/few_shot/FewShotPromptTemplate/example_prompt)[attribute

suffix: str

A prompt template string to put after the examples.](/python/langchain-core/prompts/few_shot/FewShotPromptTemplate/suffix)[attribute

example\_separator: str

String separator used to join the prefix, the examples, and suffix.](/python/langchain-core/prompts/few_shot/FewShotPromptTemplate/example_separator)[attribute

prefix: str

A prompt template string to put before the examples.](/python/langchain-core/prompts/few_shot/FewShotPromptTemplate/prefix)[attribute

template\_format: Literal['f-string', 'jinja2']

The format of the prompt template.

Options are: `'f-string'`, `'jinja2'`.](/python/langchain-core/prompts/few_shot/FewShotPromptTemplate/template_format)[attribute

model\_config](/python/langchain-core/prompts/few_shot/FewShotPromptTemplate/model_config)
...
Return `False` as this class is not serializable.](/python/langchain-core/prompts/few_shot/FewShotPromptTemplate/is_lc_serializable)[method

template\_is\_valid

Check that prefix, suffix, and input variables are consistent.](/python/langchain-core/prompts/few_shot/FewShotPromptTemplate/template_is_valid)[method

format

Format the prompt with inputs generating a string.

Use this method to generate a string representation of a prompt.](/python/langchain-core/prompts/few_shot/FewShotPromptTemplate/format)[method

aformat

Async format the prompt with inputs generating a string.

Use this method to generate a string representation of a prompt.](/python/langchain-core/prompts/few_shot/FewShotPromptTemplate/aformat)[method

save

Save the prompt template to a file.](/python/langchain-core/prompts/few_shot/FewShotPromptTemplate/save)
...
Get the namespace of the LangChain object.](/python/langchain-core/prompts/string/StringPromptTemplate/get_lc_namespace)[Mformat\_prompt
...
Validate variable names do not include restricted names.](/python/langchain-core/prompts/base/BasePromptTemplate/validate_variable_names)[Mget\_lc\_namespace

—

Get the namespace of the LangChain object.](/python/langchain-core/prompts/base/BasePromptTemplate/get_lc_namespace)[Mget\_input\_schema
