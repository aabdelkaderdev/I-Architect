...
| --- | --- | --- |
| `iterable`\* | `AsyncIterator[T]` | The iterable to split. |
| `n` | `int` | Default:`2`  The number of iterators to create. |
| `lock` | `AbstractAsyncContextManager[Any] | None` | Default:`None`  The lock to synchronise access to the shared buffers. |
...
| Name | Type |
| --- | --- |
| iterable | [AsyncIterator](https://docs.python.org/3/library/typing.html#typing.AsyncIterator)[[T](/python/langchain-core/runnables/retry/T)] |
| n | [int](https://docs.python.org/3/library/functions.html#int) |
| lock | [AbstractAsyncContextManager](https://docs.python.org/3/library/contextlib.html#contextlib.AbstractAsyncContextManager)[[Any](https://docs.python.org/3/library/typing.html#typing.Any)] | None |
...
Async close all child iterators.](/python/langchain-core/utils/aiter/Tee/aclose)
