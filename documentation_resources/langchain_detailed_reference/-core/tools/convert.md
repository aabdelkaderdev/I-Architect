<!-- Source: https://reference.langchain.com/python/langchain-core/tools/convert -->
...
Convert a `Runnable` into a `BaseTool`.](/python/langchain-core/tools/convert/convert_runnable_to_tool)
