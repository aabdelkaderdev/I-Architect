...
`ParentRunManager``ChainManagerMixin`
...
Run when chain ends running.](/python/langchain-core/callbacks/manager/CallbackManagerForChainRun/on_chain_end)[method

on\_chain\_error

Run when chain errors.](/python/langchain-core/callbacks/manager/CallbackManagerForChainRun/on_chain_error)[method

on\_agent\_action

Run when agent action is received.](/python/langchain-core/callbacks/manager/CallbackManagerForChainRun/on_agent_action)[method

on\_agent\_finish

Run when agent finish is received.](/python/langchain-core/callbacks/manager/CallbackManagerForChainRun/on_agent_finish)
