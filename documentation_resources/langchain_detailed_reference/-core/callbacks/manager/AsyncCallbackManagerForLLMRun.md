...
`AsyncRunManager``LLMManagerMixin`
...
Get the equivalent sync `RunManager`.](/python/langchain-core/callbacks/manager/AsyncCallbackManagerForLLMRun/get_sync)[method

on\_llm\_new\_token

Run when LLM generates a new token.](/python/langchain-core/callbacks/manager/AsyncCallbackManagerForLLMRun/on_llm_new_token)[method

on\_llm\_end

Run when LLM ends running.](/python/langchain-core/callbacks/manager/AsyncCallbackManagerForLLMRun/on_llm_end)[method

on\_llm\_error

Run when LLM errors.](/python/langchain-core/callbacks/manager/AsyncCallbackManagerForLLMRun/on_llm_error)
