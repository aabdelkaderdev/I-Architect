...
Get the equivalent sync `RunManager`.](/python/langchain-core/callbacks/manager/AsyncCallbackManagerForRetrieverRun/get_sync)[method

on\_retriever\_end

Run when the retriever ends running.](/python/langchain-core/callbacks/manager/AsyncCallbackManagerForRetrieverRun/on_retriever_end)[method

on\_retriever\_error

Run when retriever errors.](/python/langchain-core/callbacks/manager/AsyncCallbackManagerForRetrieverRun/on_retriever_error)
