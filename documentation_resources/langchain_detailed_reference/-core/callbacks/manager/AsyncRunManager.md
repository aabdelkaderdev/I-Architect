...
Get the equivalent sync `RunManager`.](/python/langchain-core/callbacks/manager/AsyncRunManager/get_sync)[method

on\_text

Run when a text is received.](/python/langchain-core/callbacks/manager/AsyncRunManager/on_text)[method
