<!-- Source: https://reference.langchain.com/python/langchain-core/language_models/fake_chat_models/FakeListChatModel -->
...
List of responses to **cycle** through in order.](/python/langchain-core/language_models/fake_chat_models/FakeListChatModel/responses)[attribute

sleep: float | None](/python/langchain-core/language_models/fake_chat_models/FakeListChatModel/sleep)[attribute

i: int

Internally incremented after every model invocation.](/python/langchain-core/language_models/fake_chat_models/FakeListChatModel/i)[attribute

error\_on\_chunk\_number: int | None

If set, raise an error on the specified chunk number during streaming.](/python/langchain-core/language_models/fake_chat_models/FakeListChatModel/error_on_chunk_number)

## Methods

[method

batch](/python/langchain-core/language_models/fake_chat_models/FakeListChatModel/batch)[method

abatch](/python/langchain-core/language_models/fake_chat_models/FakeListChatModel/abatch)
...
Transform a single input into an output.](/python/langchain-core/runnables/base/Runnable/ainvoke)[Mbatch\_as\_completed
