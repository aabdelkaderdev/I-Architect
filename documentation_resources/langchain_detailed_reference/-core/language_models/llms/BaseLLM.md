...
model\_config](/python/langchain-core/language_models/llms/BaseLLM/model_config)[attribute
...
invoke](/python/langchain-core/language_models/llms/BaseLLM/invoke)[method

ainvoke](/python/langchain-core/language_models/llms/BaseLLM/ainvoke)[method

batch](/python/langchain-core/language_models/llms/BaseLLM/batch)[method

abatch](/python/langchain-core/language_models/llms/BaseLLM/abatch)[method

stream](/python/langchain-core/language_models/llms/BaseLLM/stream)[method

astream](/python/langchain-core/language_models/llms/BaseLLM/astream)[method

generate\_prompt](/python/langchain-core/language_models/llms/BaseLLM/generate_prompt)[method

agenerate\_prompt](/python/langchain-core/language_models/llms/BaseLLM/agenerate_prompt)[method
...
3. Are building chains that are agnostic to the underlying language model
   type (e.g., pure text completion models vs chat models).](/python/langchain-core/language_models/llms/BaseLLM/generate)[method
...
2. Need more output from the model than just the top generated value,
3. Are building chains that are agnostic to the underlying language model
   type (e.g., pure text completion models vs chat models).](/python/langchain-core/language_models/llms/BaseLLM/agenerate)[method

dict

Return a dictionary of the LLM.](/python/langchain-core/language_models/llms/BaseLLM/dict)[method
...
If verbose is `None`, set it.](/python/langchain-core/language_models/base/BaseLanguageModel/set_verbose)[Mwith\_structured\_output
