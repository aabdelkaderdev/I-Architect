...
store: dict[str, Document]](/python/langchain-core/indexing/in_memory/InMemoryDocumentIndex/store)[attribute

top\_k: int](/python/langchain-core/indexing/in_memory/InMemoryDocumentIndex/top_k)
...
Upsert documents into the index.](/python/langchain-core/indexing/in_memory/InMemoryDocumentIndex/upsert)[method

delete

Delete by IDs.](/python/langchain-core/indexing/in_memory/InMemoryDocumentIndex/delete)[method

get](/python/langchain-core/indexing/in_memory/InMemoryDocumentIndex/get)

## Inherited from[DocumentIndex](/python/langchain-core/indexing/base/DocumentIndex)
...
Add or update documents in the `VectorStore`. Async version of `upsert`.](/python/langchain-core/indexing/base/DocumentIndex/aupsert)[Madelete

—

Delete by IDs or other criteria. Async variant.](/python/langchain-core/indexing/base/DocumentIndex/adelete)[Maget

—

Get documents by id.](/python/langchain-core/indexing/base/DocumentIndex/aget)
