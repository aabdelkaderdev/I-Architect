<!-- Source: https://reference.langchain.com/python/langchain-core/load -->
...
documentation for details and best practices.](/python/langchain-core/load/load/loads)
...
```](/python/langchain-core/load/load)[module
...
could be confused with the LC format.](/python/langchain-core/load/dump)[module

serializable

Serializable base class.](/python/langchain-core/load/serializable)[module
...
version of LangChain where the code was in a different location.](/python/langchain-core/load/mapping)
