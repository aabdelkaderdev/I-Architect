<!-- Source: https://reference.langchain.com/python/langchain-core/output_parsers/list/NumberedListOutputParser -->
...
The pattern to match a numbered list item.](/python/langchain-core/output_parsers/list/NumberedListOutputParser/pattern)

## Methods

[method

get\_format\_instructions](/python/langchain-core/output_parsers/list/NumberedListOutputParser/get_format_instructions)[method

parse

Parse the output of an LLM call.](/python/langchain-core/output_parsers/list/NumberedListOutputParser/parse)[method

parse\_iter](/python/langchain-core/output_parsers/list/NumberedListOutputParser/parse_iter)
