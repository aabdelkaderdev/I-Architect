<!-- Source: https://reference.langchain.com/python/langchain-core/output_parsers/openai_tools/JsonOutputKeyToolsParser -->
...
The type of tools to return.](/python/langchain-core/output_parsers/openai_tools/JsonOutputKeyToolsParser/key_name)
...
Parse the result of an LLM call to a list of tool calls.](/python/langchain-core/output_parsers/openai_tools/JsonOutputKeyToolsParser/parse_result)

## Inherited from[JsonOutputToolsParser](/python/langchain-core/output_parsers/openai_tools/JsonOutputToolsParser)
...
Whether to allow non-JSON-compliant strings.](/python/langchain-core/output_parsers/openai_tools/JsonOutputToolsParser/strict)[Areturn\_id: bool

—

Whether to return the tool call id.](/python/langchain-core/output_parsers/openai_tools/JsonOutputToolsParser/return_id)[Afirst\_tool\_only: bool

—

Whether to return only the first tool call.](/python/langchain-core/output_parsers/openai_tools/JsonOutputToolsParser/first_tool_only)
...
Parse the output of an LLM call to a list of tool calls.](/python/langchain-core/output_parsers/openai_tools/JsonOutputToolsParser/parse)

## Inherited from[BaseCumulativeTransformOutputParser](/python/langchain-core/output_parsers/transform/BaseCumulativeTransformOutputParser)
...
In streaming mode, whether to yield diffs between the previous and current parsed](/python/langchain-core/output_parsers/transform/BaseCumulativeTransformOutputParser/diff)
...
[Minvoke](/python/langchain-core/output_parsers/base/BaseOutputParser/invoke)[Mainvoke](/python/langchain-core/output_parsers/base/BaseOutputParser/ainvoke)[Mparse

—

Parse a single string model output into some structure.](/python/langchain-core/output_parsers/base/BaseOutputParser/parse)[Maparse\_result
...
Parse the output of an LLM call with the input prompt for context.](/python/langchain-core/output_parsers/base/BaseOutputParser/parse_with_prompt)[Mget\_format\_instructions

—

Instructions on how the LLM output should be formatted.](/python/langchain-core/output_parsers/base/BaseOutputParser/get_format_instructions)[Mdict
