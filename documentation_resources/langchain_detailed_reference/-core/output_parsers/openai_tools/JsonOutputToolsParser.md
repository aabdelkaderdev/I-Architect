<!-- Source: https://reference.langchain.com/python/langchain-core/output_parsers/openai_tools/JsonOutputToolsParser -->
...
Useful when the parsed output may include unicode characters or new lines.](/python/langchain-core/output_parsers/openai_tools/JsonOutputToolsParser/strict)[attribute

return\_id: bool

Whether to return the tool call id.](/python/langchain-core/output_parsers/openai_tools/JsonOutputToolsParser/return_id)[attribute

first\_tool\_only: bool
...
If no tool calls are found, `None` will be returned.](/python/langchain-core/output_parsers/openai_tools/JsonOutputToolsParser/first_tool_only)
...
Parse the result of an LLM call to a list of tool calls.](/python/langchain-core/output_parsers/openai_tools/JsonOutputToolsParser/parse_result)[method
...
[Minvoke](/python/langchain-core/output_parsers/base/BaseOutputParser/invoke)[Mainvoke](/python/langchain-core/output_parsers/base/BaseOutputParser/ainvoke)[Maparse\_result
