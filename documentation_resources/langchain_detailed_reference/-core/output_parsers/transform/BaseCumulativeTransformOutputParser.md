<!-- Source: https://reference.langchain.com/python/langchain-core/output_parsers/transform/BaseCumulativeTransformOutputParser -->
...
output, or just the current parsed output.](/python/langchain-core/output_parsers/transform/BaseCumulativeTransformOutputParser/diff)
...
Parse a list of candidate model `Generation` objects into a specific format.](/python/langchain-core/output_parsers/base/BaseOutputParser/parse_result)[Mparse
