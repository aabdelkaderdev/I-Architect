<!-- Source: https://reference.langchain.com/python/langchain-core/output_parsers/openai_functions/JsonKeyOutputFunctionsParser -->
...
The name of the key to return.](/python/langchain-core/output_parsers/openai_functions/JsonKeyOutputFunctionsParser/key_name)
...
Parse the result of an LLM call to a JSON object.](/python/langchain-core/output_parsers/openai_functions/JsonKeyOutputFunctionsParser/parse_result)

## Inherited from[JsonOutputFunctionsParser](/python/langchain-core/output_parsers/openai_functions/JsonOutputFunctionsParser)
...
Whether to allow non-JSON-compliant strings.](/python/langchain-core/output_parsers/openai_functions/JsonOutputFunctionsParser/strict)[Aargs\_only: bool

—

Whether to only return the arguments to the function call.](/python/langchain-core/output_parsers/openai_functions/JsonOutputFunctionsParser/args_only)
...
Parse the output of an LLM call to a JSON object.](/python/langchain-core/output_parsers/openai_functions/JsonOutputFunctionsParser/parse)
