...
Return the input type for the parser.](/python/langchain-core/output_parsers/base/BaseOutputParser/InputType)[attribute

OutputType: type[T]

Return the output type for the parser.

This property is inferred from the first type argument of the class.](/python/langchain-core/output_parsers/base/BaseOutputParser/OutputType)

## Methods

[method

invoke](/python/langchain-core/output_parsers/base/BaseOutputParser/invoke)[method

ainvoke](/python/langchain-core/output_parsers/base/BaseOutputParser/ainvoke)[method
...
is assumed to be the highest-likelihood `Generation`.](/python/langchain-core/output_parsers/base/BaseOutputParser/parse_result)[method

parse

Parse a single string model output into some structure.](/python/langchain-core/output_parsers/base/BaseOutputParser/parse)[method
...
The return value is parsed from only the first `Generation` in the result, which
is assumed to be the highest-likelihood `Generation`.](/python/langchain-core/output_parsers/base/BaseOutputParser/aparse_result)[method

aparse

Async parse a single string model output into some structure.](/python/langchain-core/output_parsers/base/BaseOutputParser/aparse)[method
...
fix the output in some way, and needs information from the prompt to do so.](/python/langchain-core/output_parsers/base/BaseOutputParser/parse_with_prompt)[method

get\_format\_instructions

Instructions on how the LLM output should be formatted.](/python/langchain-core/output_parsers/base/BaseOutputParser/get_format_instructions)[method
