...
`JsonOutputParser``Generic[TBaseModel]`

## Attributes

[attribute

pydantic\_object: Annotated[type[TBaseModel], SkipValidation()]

The Pydantic model to parse.](/python/langchain-core/output_parsers/pydantic/PydanticOutputParser/pydantic_object)[attribute

OutputType: type[TBaseModel]

Return the Pydantic model.](/python/langchain-core/output_parsers/pydantic/PydanticOutputParser/OutputType)
...
Parse the result of an LLM call to a Pydantic object.](/python/langchain-core/output_parsers/pydantic/PydanticOutputParser/parse_result)[method

parse

Parse the output of an LLM call to a Pydantic object.](/python/langchain-core/output_parsers/pydantic/PydanticOutputParser/parse)[method

get\_format\_instructions

Return the format instructions for the JSON output.](/python/langchain-core/output_parsers/pydantic/PydanticOutputParser/get_format_instructions)
...
Return the input type for the parser.](/python/langchain-core/output_parsers/base/BaseOutputParser/InputType)
