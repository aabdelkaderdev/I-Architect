...
input prompt.](/python/langchain-core/outputs/chat_result/ChatResult/generations)[attribute

llm\_output: dict | None
...
relevant information from standardized fields present in `AIMessage`.](/python/langchain-core/outputs/chat_result/ChatResult/llm_output)
