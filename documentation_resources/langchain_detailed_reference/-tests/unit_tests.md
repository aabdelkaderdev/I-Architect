<!-- Source: https://reference.langchain.com/python/langchain-tests/unit_tests -->
...
modules: list](/python/langchain-tests/unit_tests/modules)

## Classes

[class

ChatModelUnitTests](/python/langchain-tests/unit_tests/chat_models/ChatModelUnitTests)[class

EmbeddingsUnitTests](/python/langchain-tests/unit_tests/embeddings/EmbeddingsUnitTests)[class

ToolsUnitTests](/python/langchain-tests/unit_tests/tools/ToolsUnitTests)

## Modules

[module

chat\_models](/python/langchain-tests/unit_tests/chat_models)[module

embeddings](/python/langchain-tests/unit_tests/embeddings)[module

tools](/python/langchain-tests/unit_tests/tools)
