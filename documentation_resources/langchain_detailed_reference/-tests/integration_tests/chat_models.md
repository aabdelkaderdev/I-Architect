<!-- Source: https://reference.langchain.com/python/langchain-tests/integration_tests/chat_models -->
...
PYDANTIC\_MAJOR\_VERSION](/python/langchain-tests/utils/pydantic/PYDANTIC_MAJOR_VERSION)
...
Apply a magic function to an input.](/python/langchain-tests/integration_tests/chat_models/magic_function)[function

magic\_function\_no\_args

Calculate a magic function.](/python/langchain-tests/integration_tests/chat_models/magic_function_no_args)[function

unicode\_customer

Tool for creating a customer with Unicode name.](/python/langchain-tests/integration_tests/chat_models/unicode_customer)
...
```](/python/langchain-tests/integration_tests/chat_models/ChatModelIntegrationTests)
