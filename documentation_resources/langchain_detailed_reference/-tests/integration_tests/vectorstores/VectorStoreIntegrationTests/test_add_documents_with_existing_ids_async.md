<!-- Source: https://reference.langchain.com/python/langchain-tests/integration_tests/vectorstores/VectorStoreIntegrationTests/test_add_documents_with_existing_ids_async -->

Methodv1.1.4 (latest)●Since v1.1

# test\_add\_documents\_with\_existing\_ids\_async
