...
## [​](#enhanced-schema-information) Enhanced schema information
...
## [​](#return-direct-results) Return direct results
...
## [​](#add-examples-in-the-cypher-generation-prompt) Add examples in the cypher generation prompt
...
## [​](#use-separate-llms-for-cypher-and-answer-generation) Use separate LLMs for cypher and answer generation
...
## [​](#provide-context-from-database-results-as-tool/function-output) Provide context from database results as tool/function output
