<!-- Source: https://docs.langchain.com/oss/python/integrations/document_loaders/amazon_textract -->
...
## [​](#example-1-loading-from-a-local-file) Example 1: Loading from a local file
...
## [​](#example-2-loading-from-a-url) Example 2: Loading from a URL
...
## [​](#example-3-loading-multi-page-pdf-documents) Example 3: Loading multi-page PDF documents
...
## [​](#example-4-customizing-the-output-format) Example 4: Customizing the output format
...
## [​](#using-the-amazontextractpdfloader-in-a-langchain-chain-e-g-openai) Using the AmazonTextractPDFLoader in a LangChain chain (e.g. OpenAI)
