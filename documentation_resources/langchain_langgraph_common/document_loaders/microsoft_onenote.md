<!-- Source: https://docs.langchain.com/oss/python/integrations/document_loaders/microsoft_onenote -->
...
## [​](#-instructions-for-ingesting-your-documents-from-onenote) 🧑 Instructions for ingesting your documents from OneNote
...
#### [​](#-loading-pages-from-a-onenote-notebook) 📑 Loading pages from a OneNote notebook
...
#### [​](#-loading-pages-from-a-list-of-page-ids) 📑 Loading pages from a list of page IDs
...
[Edit this page on GitHub](https://github.com/langchain-ai/docs/edit/main/src/oss/python/integrations/document_loaders/microsoft_onenote.mdx) or [file an issue](https://github.com/langchain-ai/docs/issues/new/choose).
