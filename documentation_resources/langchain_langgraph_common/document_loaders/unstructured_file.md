...
#### [​](#installation-for-local) Installation for local
...
### [​](#unstructured-sdk-client) Unstructured SDK client
...
## [​](#loading-web-pages) Loading web pages
...
For detailed documentation of all `UnstructuredLoader` features and configurations head to the API reference: [python.langchain.com/api\_reference/unstructured/document\_loaders/langchain\_unstructured.document\_loaders.UnstructuredLoader.html](https://python.langchain.com/api_reference/unstructured/document_loaders/langchain_unstructured.document_loaders.UnstructuredLoader.html)
