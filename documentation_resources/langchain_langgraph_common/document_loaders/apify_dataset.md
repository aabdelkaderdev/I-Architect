<!-- Source: https://docs.langchain.com/oss/python/integrations/document_loaders/apify_dataset -->
...
| --- | --- | --- | --- | --- |
| [ApifyDatasetLoader](https://github.com/apify/langchain-apify) | [langchain-apify](https://pypi.org/project/langchain-apify/) | ❌ | ✅ |  |
...
## [​](#map-dataset-items-to-documents) Map dataset items to documents
...
## [​](#using-the-apify-mcp-server) Using the Apify MCP server
