...
### [​](#-documents-loader) 🗂️ Documents loader

#### [​](#-loading-documents-from-a-document-library-directory) 📑 Loading documents from a document library directory
...
#### [​](#-loading-documents-from-a-list-of-documents-ids) 📑 Loading documents from a list of documents IDs
...
#### [​](#-choosing-supported-file-types-and-preferred-parsers) 📑 Choosing supported file types and preferred parsers
