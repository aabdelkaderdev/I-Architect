<!-- Source: https://docs.langchain.com/oss/python/integrations/document_loaders/json -->
...
## [​](#read-from-json-lines-file) Read from JSON lines file
...
## [​](#read-specific-content-keys) Read specific content keys
