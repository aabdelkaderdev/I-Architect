<!-- Source: https://docs.langchain.com/oss/python/integrations/document_loaders/web_base -->
...
### [​](#initialization-with-multiple-pages) Initialization with multiple pages
...
### [​](#load-multiple-urls-concurrently) Load multiple urls concurrently
...
### [​](#loading-a-xml-file-or-using-a-different-beautifulsoup-parser) Loading a xml file, or using a different BeautifulSoup parser
