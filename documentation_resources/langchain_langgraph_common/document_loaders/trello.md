<!-- Source: https://docs.langchain.com/oss/python/integrations/document_loaders/trello -->
...
By default all card fields are included for the full text page\_content and metadata accordingly.
