<!-- Source: https://docs.langchain.com/oss/python/integrations/vectorstores/cassandra -->
...
## [​](#import-the-vector-store) Import the vector store
...
### [​](#connecting-to-a-cassandra-cluster) Connecting to a cassandra cluster
...
### [​](#connecting-to-astra-db-through-cql) Connecting to astra DB through CQL
...
### [​](#mmr-maximal-marginal-relevance-search) MMR (Maximal-marginal-relevance) search
...
## [​](#deleting-stored-documents) Deleting stored documents
...
## [​](#a-minimal-rag-chain) A minimal RAG chain
