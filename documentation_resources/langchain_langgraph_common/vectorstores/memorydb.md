...
## [​](#what-is-amazon-memorydb) What is Amazon MemoryDB?
...
## [​](#vector-search-for-memorydb) Vector search for MemoryDB
...
### [​](#memorydb-connection) MemoryDB connection
...
### [​](#create-memorydb-vector-store) Create MemoryDB vector store
...
## [​](#memorydb-as-retriever) MemoryDB as retriever
