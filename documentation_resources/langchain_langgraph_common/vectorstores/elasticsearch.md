...
### [​](#running-with-authentication) Running with authentication
...
## [​](#distance-similarity-algorithm) Distance similarity algorithm
...
### [​](#densevectorstrategy) DenseVectorStrategy
...
#### [​](#example-hybrid-retrieval-with-dense-vector-and-keyword-search) Example: Hybrid retrieval with dense vector and keyword search
...
#### [​](#example-dense-vector-search-with-embedding-model-in-elasticsearch) Example: Dense vector search with embedding model in Elasticsearch
...
### [​](#sparsevectorstrategy-elser) SparseVectorStrategy (ELSER)
...
### [​](#densevectorscriptscorestrategy) DenseVectorScriptScoreStrategy
...
### [​](#bm25retrievalstrategy) BM25RetrievalStrategy
...
## [​](#customize-the-document-builder) Customize the document builder
...
# [​](#upgrading-to-elasticsearchstore) Upgrading to ElasticsearchStore
...
## [​](#i-am-using-elasticknnsearch) I am using ElasticKNNSearch
...
## [​](#i-am-using-elasticvectorsearch) I am using ElasticVectorSearch
