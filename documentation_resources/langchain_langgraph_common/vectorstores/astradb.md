...
#### [​](#method-1-explicit-embeddings) Method 1: Explicit embeddings
...
#### [​](#method-2-server-side-embeddings-‘vectorize’) Method 2: Server-side embeddings (‘vectorize’)
...
#### [​](#method-3-auto-detect-from-a-pre-existing-collection) Method 3: Auto-detect from a pre-existing collection
...
#### [​](#a-note-on-“hybrid-search”) A note on “hybrid search”
...
### [​](#explicit-embedding-initialization-method-1) Explicit embedding initialization (method 1)
...
### [​](#server-side-embedding-initialization-“vectorize”-method-2) Server-side embedding initialization (“vectorize”, method 2)
...
### [​](#auto-detect-initialization-method-3) Auto-detect initialization (method 3)
...
## [​](#query-the-vector-store) Query the vector store
...
#### [​](#specify-a-different-keyword-query-requires-hybrid-search) Specify a different keyword query (requires hybrid search)
...
## [​](#cleanup-vector-store) Cleanup vector store
