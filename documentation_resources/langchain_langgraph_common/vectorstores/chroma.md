...
#### [​](#running-locally-in-memory) Running locally (In-Memory)
...
#### [​](#running-locally-with-data-persistence) Running locally (with data persistence)
...
#### [​](#connecting-to-a-chroma-server) Connecting to a chroma Server
...
### [​](#initialization-from-client) Initialization from client
...
#### [​](#running-locally-in-memory-2) Running locally (In-Memory)
...
#### [​](#running-locally-with-data-persistence-2) Running locally (with data persistence)
...
#### [​](#connecting-to-a-chroma-server-2) Connecting to a chroma Server
...
#### [​](#access-your-chroma-db) Access your chroma DB
...
#### [​](#create-a-chroma-vectorstore) Create a chroma vectorstore
...
### [​](#update-items-in-vector-store) Update items in vector store
