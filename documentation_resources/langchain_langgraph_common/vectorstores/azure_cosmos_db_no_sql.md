...
## [​](#creating-azurecosmosdb-nosql-vector-search) Creating AzureCosmosDB NoSQL vector search
...
## [​](#vector-search-with-score) Vector search with score
...
## [​](#vector-search-with-filtering) Vector search with filtering
...
## [​](#full-text-search-bm-25-ranking) Full text search BM 25 ranking
...
## [​](#hybrid-search-with-filtering) Hybrid search with filtering
...
## [​](#hybrid-search-with-custom-projection) Hybrid search with custom projection
