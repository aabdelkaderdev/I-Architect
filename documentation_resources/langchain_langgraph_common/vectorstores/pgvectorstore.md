...
### [​](#set-your-postgres-values) Set your Postgres values
...
### [​](#pgengine-connection-pool) PGEngine connection pool
...
### [​](#create-an-embedding-class-instance) Create an embedding class instance

You can use any [LangChain embeddings model](https://python.langchain.com/docs/integrations/embeddings/).
...
### [​](#initialize-a-default-pgvectorstore) Initialize a default PGVectorStore
...
### [​](#search-for-documents-by-vector) Search for documents by vector
...
### [​](#create-a-custom-vector-store) Create a custom vector store
...
### [​](#search-for-documents-with-metadata-filter) Search for documents with metadata filter
...
### [​](#create-a-vector-store-using-existing-table) Create a vector store using existing table
...
- **`content_column="description"`**: The `description` column contains text descriptions of each product. This text is used by the `embedding_service` to create vectors that go in embedding\_column and represent the semantic meaning of each description.
...
2. For new records, added via [`VectorStore`](https://reference.langchain.com/python/langchain-core/vectorstores/base/VectorStore) embeddings are automatically generated.
...
For detailed documentation of all VectorStore features and configurations head to the API reference: [python.langchain.com/api\_reference/postgres/v2/langchain\_postgres.v2.vectorstores.PGVectorStore.html](https://python.langchain.com/api_reference/postgres/v2/langchain_postgres.v2.vectorstores.PGVectorStore.html)

---

[Edit this page on GitHub](https://github.com/langchain-ai/docs/edit/main/src/oss/python/integrations/vectorstores/pgvectorstore.mdx) or [file an issue](https://github.com/langchain-ai/docs/issues/new/choose).
