<!-- Source: https://docs.langchain.com/oss/python/integrations/vectorstores/azuresearch -->
...
## [​](#install-azure-ai-search-sdk) Install Azure AI search SDK
...
## [​](#create-vector-store-instance) Create vector store instance
...
## [​](#custom-schemas-and-queries) Custom schemas and queries

This section shows you how to replace the default schema with a custom schema.

### [​](#create-a-new-index-with-custom-filterable-fields) Create a new index with custom filterable fields
...
### [​](#add-data-and-perform-a-query-that-includes-a-filter) Add data and perform a query that includes a filter
...
### [​](#create-a-new-index-with-a-scoring-profile) Create a new index with a scoring profile
