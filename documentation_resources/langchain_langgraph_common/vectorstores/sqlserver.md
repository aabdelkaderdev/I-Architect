...
### [​](#similarity-search-when-you-already-have-embeddings-you-want-to-search-on) Similarity search when you already have embeddings you want to search on
...
### [​](#delete-row-by-id) Delete row by ID
...
### [​](#drop-vector-store) Drop vector store
...
## [​](#load-a-document-from-azure-blob-storage) Load a document from Azure Blob Storage
...
#### [​](#use-case-1-q&a-system-based-on-the-story-book) Use case 1: Q&A system based on the story book
