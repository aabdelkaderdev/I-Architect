...
### [​](#pre-filtering-with-similarity-search) Pre-filtering with similarity search
...
For detailed documentation of all `MongoDBAtlasVectorSearch` features and configurations head to the API reference: [python.langchain.com/api\_reference/mongodb/index.html](https://python.langchain.com/api_reference/mongodb/index.html)
