...
### [​](#import-the-required-dependencies) Import the required dependencies
...
### [​](#create-vector-stores-with-different-distance-metrics) Create vector stores with different distance metrics
...
### [​](#add-and-delete-operations-for-texts-along-with-basic-similarity-search) Add and delete operations for texts, along with basic similarity search
...
### [​](#index-creation-with-specific-parameters) Index creation with specific parameters
...
#### [​](#prerequisites-and-model-configuration) Prerequisites and model configuration
...
### [​](#full-text-search-oracle-text) Full-text search (Oracle Text)
