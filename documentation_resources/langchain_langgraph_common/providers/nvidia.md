...
### [​](#chat-chatnvidia) Chat: ChatNVIDIA
...
#### [​](#access-the-nvidia-api-catalog) Access the NVIDIA API Catalog
...
#### [​](#nemotron-featured-models-for-agentic-ai) Nemotron: featured models for agentic AI
...
### [​](#chat-chatnvidiadynamo) Chat: ChatNVIDIADynamo
...
### [​](#embeddings-nvidiaembeddings) Embeddings: NVIDIAEmbeddings
...
### [​](#reranking-nvidiarerank) Reranking: NVIDIARerank
...
### [​](#retrieval-nvidiaragretriever) Retrieval: NVIDIARAGRetriever
...
### [​](#self-host-with-nvidia-nim-microservices) Self-host with NVIDIA NIM Microservices
...
## [​](#accelerate-langgraph-with-nvidia) Accelerate LangGraph with NVIDIA
...
## [​](#nemo-agent-toolkit-optimizations-with-langsmith-telemetry) NeMo Agent Toolkit Optimizations with LangSmith Telemetry
...
## [​](#full-stack-blueprints) Full Stack Blueprints
