...
### [​](#populating-the-vector-store) Populating the vector store
...
consult the [AstraDB Vector Store Guide](/oss/python/integrations/vectorstores/astradb).:::note
...
[Apache Cassandra Vector Store Guide](/oss/python/integrations/vectorstores/cassandra#connection-parameters):::note
...
[Chroma Vector Store Guide](/oss/python/integrations/vectorstores/chroma).:::note
...
### [​](#comparison-to-standard-retrieval) Comparison to standard retrieval
