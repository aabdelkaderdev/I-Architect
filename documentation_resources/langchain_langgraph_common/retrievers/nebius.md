<!-- Source: https://docs.langchain.com/oss/python/integrations/retrievers/nebius -->
...
### [​](#using-get_relevant_documents) Using get\_relevant\_documents
...
### [​](#customizing-number-of-results) Customizing number of results
...
### [​](#handling-empty-documents) Handling empty documents
...
### [​](#creating-a-search-tool) Creating a search tool
