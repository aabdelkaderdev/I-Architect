...
**Deprecated**This integration is deprecated and will be removed in a future release. Please use [`GoogleGenerativeAI`](/oss/python/integrations/llms/google_generative_ai) instead. See the full [release notes and migration guide](https://github.com/langchain-ai/langchain-google/discussions/1422).

**You are currently on a page documenting the use of Google Vertex text completion models. Many Google models are [chat completion models](/oss/python/langchain/models).**You may be looking for [this page instead](/oss/python/integrations/chat/google_vertex_ai).
...
### [​](#optional--managing-safety-attributes) OPTIONAL : Managing [Safety Attributes](https://cloud.google.com/vertex-ai/docs/generative-ai/learn/responsible-ai#safety_attribute_confidence_scoring)
...
### [​](#using-pdfs-with-gemini-models) Using pdfs with gemini models
...
### [​](#using-video-with-gemini-models) Using video with gemini models
...
### [​](#using-audio-with-gemini-models) Using audio with gemini models
...
### [​](#llama-on-vertex-model-garden) Llama on vertex model garden
...
### [​](#falcon-on-vertex-model-garden) Falcon on vertex model garden
