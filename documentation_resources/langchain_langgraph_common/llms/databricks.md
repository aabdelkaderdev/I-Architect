<!-- Source: https://docs.langchain.com/oss/python/integrations/llms/databricks -->
...
## [​](#wrapping-model-serving-endpoint) Wrapping model serving endpoint
...
### [​](#transform-input-and-output) Transform input and output
