...
### [​](#example-llama-2-completions-with-real-time-endpoints) Example: LlaMa 2 completions with real-time endpoints
...
### [​](#example-chat-completions-with-pay-as-you-go-deployments-model-as-a-service) Example: Chat completions with pay-as-you-go deployments (model as a service)
...
### [​](#example-custom-content-formatter) Example: Custom content formatter
...
### [​](#example-dolly-with-llmchain) Example: Dolly with LLMChain
