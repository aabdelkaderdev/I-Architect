<!-- Source: https://docs.langchain.com/oss/python/integrations/tools/hyperbrowser_browser_agent_tools -->
...
### [​](#openai-cua-tool) OpenAI CUA tool
...
### [​](#claude-computer-use-tool) Claude computer use tool
...
#### [​](#browser-use-tool-2) Browser use tool
...
#### [​](#openai-cua-tool-2) OpenAI CUA tool
...
#### [​](#claude-computer-use-tool-2) Claude computer use tool
...
### [​](#with-custom-session-options) With custom session options
