<!-- Source: https://docs.langchain.com/oss/python/integrations/tools/nia -->
...
| --- | --- | --- | --- | --- |
| [NiaToolkit](https://github.com/nozomio-labs/nia-langchain) | [langchain-nia](https://pypi.org/project/langchain-nia/) | ❌ | ❌ |  |
...
### [​](#search-across-indexed-sources) Search across indexed sources
...
### [​](#read-files-from-indexed-sources) Read files from indexed sources
...
### [​](#within-an-agent) Within an agent
...
### [​](#source-management-tools) Source management tools
...
### [​](#context-and-memory-tools) Context and memory tools
