<!-- Source: https://docs.langchain.com/oss/python/integrations/tools/jina_search -->
...
### [​](#invoke-directly-with-args) [Invoke directly with args](/oss/python/langchain/tools)
...
### [​](#invoke-with-toolcall) [Invoke with ToolCall](/oss/python/langchain/tools)
...
[Edit this page on GitHub](https://github.com/langchain-ai/docs/edit/main/src/oss/python/integrations/tools/jina_search.mdx) or [file an issue](https://github.com/langchain-ai/docs/issues/new/choose).
