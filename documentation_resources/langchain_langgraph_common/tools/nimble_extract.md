<!-- Source: https://docs.langchain.com/oss/python/integrations/tools/nimble_extract -->
...
| --- | --- | --- | --- | --- |
| [NimbleExtractTool](https://github.com/Nimbleway/langchain-nimble) | [langchain-nimble](https://pypi.org/project/langchain-nimble/) | ❌ | ❌ |  |
...
- **Multiple formats**: plain\_text (default), markdown, or simplified\_html
...
| `parsing_type` | str | ”plain\_text” | Output format: “plain\_text”, “markdown”, or “simplified\_html” |
...
### [​](#when-to-use-wait-times) When to use wait times
...
- **Choose appropriate formats**: Use **plain\_text** for speed, **markdown** for structure, **HTML** for detailed styling
