<!-- Source: https://docs.langchain.com/oss/python/integrations/tools/cassandra_database -->
...
### [​](#cassandra_db_schema) `cassandra_db_schema`
...
### [​](#cassandra_db_query) `cassandra_db_query`
...
## [​](#connect-to-a-cassandra-database) Connect to a cassandra Database
