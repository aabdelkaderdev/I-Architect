...
# [​](#bigquery-callback-handler) BigQuery Callback Handler
...
**Preview release**The BigQuery Callback Handler is in **Preview**. APIs and functionality are subject to change.
For more information, see the
[launch stage descriptions](https://cloud.google.com/products#product-launch-stages).

**BigQuery Storage Write API**This feature uses the **BigQuery Storage Write API**, which is a paid service.
...
## [​](#use-with-langgraph-agent) Use with LangGraph agent
...
[​](#param-clustering-fields)

clustering\_fields

List[str]

default:"['event\_type', 'agent', 'user\_id']"

The fields used to cluster the BigQuery table when it is automatically created.

[​](#param-gcs-bucket-name)
...
[​](#param-batch-flush-interval)

batch\_flush\_interval
...
[​](#param-log-multi-modal-content)

log\_multi\_modal\_content
...
### [​](#retriever-usage) Retriever usage
...
### [​](#1-reconstruct-a-trace-conversation-turn) 1. Reconstruct a Trace (Conversation Turn)
...
### [​](#2-analyze-llm-latency-&-token-usage) 2. Analyze LLM Latency & Token Usage
...
### [​](#3-analyze-multimodal-content-with-bigquery-remote-model-gemini) 3. Analyze Multimodal Content with BigQuery Remote Model (Gemini)
...
### [​](#4-analyze-span-hierarchy-&-duration) 4. Analyze Span Hierarchy & Duration
...
### [​](#5-querying-offloaded-content-get-signed-urls) 5. Querying Offloaded Content (Get Signed URLs)
...
### [​](#6-advanced-sql-scenarios) 6. Advanced SQL Scenarios
...
**Conversational Analytics**You can also use [BigQuery Conversational Analytics](https://cloud.google.com/bigquery/docs/conversational-analytics) to analyze your agent logs using natural language.
...
### [​](#langgraph-event-types) LangGraph event types
...
### [​](#graph-context-manager) Graph context manager
