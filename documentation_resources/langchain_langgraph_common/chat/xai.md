...
**API Reference**For detailed documentation of all features and configuration options, head to the [`ChatXAI`](https://reference.langchain.com/python/langchain-xai/chat_models/ChatXAI) API reference.
...
| --- | --- | --- | --- | --- | --- |
| [`ChatXAI`](https://reference.langchain.com/python/langchain-xai/chat_models/ChatXAI) | [`langchain-xai`](https://reference.langchain.com/python/langchain-xai/) | beta | ✅ |  |  |
...
### [​](#chatxai-bind_tools) ChatXAI.bind\_tools()
