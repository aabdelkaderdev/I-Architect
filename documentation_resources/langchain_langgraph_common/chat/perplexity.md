...
## [​](#using-perplexity-specific-parameters-through-chatperplexity) Using perplexity-specific parameters through `ChatPerplexity`
...
### [​](#accessing-the-search-results-metadata) Accessing the search results metadata
...
## [​](#chatperplexity-also-supports-streaming-functionality) `ChatPerplexity` also supports streaming functionality
...
## [​](#chatperplexity-supports-structured-outputs-for-tier-3+-users) `ChatPerplexity` supports structured outputs for tier 3+ users
