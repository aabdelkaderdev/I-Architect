...
| --- | --- | --- | --- | --- | --- |
| [`ChatNVIDIA`](https://reference.langchain.com/python/langchain-nvidia-ai-endpoints/chat_models/ChatNVIDIA) | [`langchain-nvidia-ai-endpoints`](https://reference.langchain.com/python/langchain-nvidia-ai-endpoints) | beta | ❌ |  |  |
...
### [​](#nemotron-models-for-agentic-ai) Nemotron models for agentic AI
...
## [​](#use-with-nvidia-dynamo) Use with NVIDIA Dynamo
...
### [​](#set-defaults-at-construction-time) Set defaults at construction time
...
### [​](#override-per-invocation) Override per invocation
...
### [​](#stream-with-dynamo-hints) Stream with Dynamo hints
...
### [​](#inspect-the-payload) Inspect the payload
