<!-- Source: https://docs.langchain.com/oss/python/integrations/chat/azureml_chat_endpoint -->
...
### [​](#example-chat-completions-with-real-time-endpoints) Example: Chat completions with real-time endpoints
