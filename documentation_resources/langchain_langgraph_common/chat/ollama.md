...
**API Reference**For detailed documentation of all features and configuration options, head to the [`ChatOllama`](https://reference.langchain.com/python/langchain-community/chat_models/ollama/ChatOllama) API reference.
...
| --- | --- | --- | --- | --- | --- |
| [`ChatOllama`](https://reference.langchain.com/python/langchain-community/chat_models/ollama/ChatOllama) | [`langchain-ollama`](https://reference.langchain.com/python/langchain-ollama/) | ❌ | ✅ |  |  |
...
## [​](#reasoning-models-and-custom-message-roles) Reasoning models and custom message roles
