...
**API Reference**For detailed documentation of all features and configuration options, head to the [`ChatGroq`](https://reference.langchain.com/python/langchain-groq/chat_models/ChatGroq) API reference.
...
| --- | --- | --- | --- | --- | --- |
| [`ChatGroq`](https://reference.langchain.com/python/langchain-groq/chat_models/ChatGroq) | [`langchain-groq`](https://reference.langchain.com/python/langchain-groq/) | beta | ✅ |  |  |
...
**Reasoning Format**If you choose to set a `reasoning_format`, you must ensure that the model you are using supports it. You can find a list of supported models in the [Groq documentation](https://console.groq.com/docs/reasoning).
...
**Image URL requirements**Groq fetches images from URLs directly. Ensure your image URLs:
