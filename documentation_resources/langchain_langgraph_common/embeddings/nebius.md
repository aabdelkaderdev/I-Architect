<!-- Source: https://docs.langchain.com/oss/python/integrations/embeddings/nebius -->
...
### [​](#using-with-inmemoryvectorstore) Using with InMemoryVectorStore
...
### [​](#embedding-a-single-text) Embedding a single text
...
### [​](#document-similarity-example) Document similarity example
