<!-- Source: https://docs.langchain.com/oss/python/integrations/embeddings/aimlapi -->
...
| --- | --- | --- | --- | --- | --- |
| [AIMLAPIEmbeddings](https://python.langchain.com/api_reference/aimlapi/embeddings/langchain_aimlapi.embeddings.AIMLAPIEmbeddings.html) | [langchain-aimlapi](https://python.langchain.com/api_reference/aimlapi/index.html) | ❌ | ❌ |  |  |
...
### [​](#embed-single-text) Embed single text
