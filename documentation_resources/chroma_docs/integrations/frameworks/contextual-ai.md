...
#### [​](#parse-documents-and-store-in-chroma) Parse documents and store in Chroma
...
#### [​](#query-chroma-and-rerank-results-with-custom-instructions) Query Chroma and rerank results with custom instructions
...
#### [​](#generate-grounded-response) Generate grounded response
...
#### [​](#evaluate-response-quality-with-lmunit) Evaluate response quality with LMUnit
...
### [​](#generate-api-glm) Generate API (GLM)
