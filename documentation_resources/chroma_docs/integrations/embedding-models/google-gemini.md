...
You can view a more [complete example](https://github.com/chroma-core/chroma/tree/main/examples/gemini) chatting over documents with Gemini embedding and language models.For more info - please visit the [official Google docs](https://ai.google.dev/gemini-api/docs/embeddings).
...
You can view a more [complete example using Node](https://github.com/chroma-core/chroma/blob/main/clients/js/examples/node/app.js).For more info - please visit the [official Google docs](https://ai.google.dev/gemini-api/docs/embeddings).
...
### [​](#example-video-search) Example: Video Search
