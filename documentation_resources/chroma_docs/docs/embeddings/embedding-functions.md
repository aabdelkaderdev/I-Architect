...
## [​](#using-embedding-functions) Using Embedding Functions
...
## [​](#default-all-minilm-l6-v2) Default: all-MiniLM-L6-v2
...
## [​](#using-embedding-functions-2) Using Embedding Functions
...
## [​](#custom-embedding-functions-2) Custom Embedding Functions
...
## [​](#default-all-minilm-l6-v2-2) Default: all-MiniLM-L6-v2
...
## [​](#all-embedding-functions) All Embedding Functions
