...
## [​](#chroma-js-client-failures-on-nextjs-projects) Chroma JS-Client failures on NextJS projects
...
## [​](#cannot-return-the-results-in-a-contiguous-2d-array-probably-ef-or-m-is-too-small) Cannot return the results in a contiguous 2D array. Probably ef or M is too small
...
## [​](#using-get-or-query-embeddings-say-none) Using .get or .query, embeddings say `None`
...
## [​](#build-error-when-running-pip-install-chromadb) Build error when running `pip install chromadb`
...
## [​](#my-data-directory-is-too-large) My data directory is too large
