<!-- Source: https://docs.celeryq.dev/en/main/reference/cli.html -->

This document describes the current stable version of Celery (5.6).
For development docs,
[go here](https://docs.celeryq.dev/en/main/reference/cli.html).

# Command Line Interface

Note

The prefix CELERY\_ must be added to the names of the environment
variables described below. E.g., APP becomes CELERY\_APP.
...
--skip-checks
:   Skip Django core checks on startup. Setting the SKIP\_CHECKS environment variable to any non-empty string will have the same effect.

Environment variables

APP
:   > Provide a default for [`-A`](#cmdoption-celery-A)

BROKER\_URL
:   > Provide a default for [`-b`](#cmdoption-celery-b)

RESULT\_BACKEND
:   > Provide a default for [`--result-backend`](#cmdoption-celery-result-backend)

LOADER
:   > Provide a default for [`--loader`](#cmdoption-celery-loader)

CONFIG\_MODULE
:   > Provide a default for [`--config`](#cmdoption-celery-config)

NO\_COLOR
:   > Provide a default for [`-C`](#cmdoption-celery-C)

SKIP\_CHECKS
:   > Provide a default for [`--skip-checks`](#cmdoption-celery-skip-checks)
...
-X, --exclude-queues <exclude\_queues>
...
-n, --hostname <hostname>
:   Set custom hostname (e.g., [‘w1@%%h](mailto:'w1%40%%h)’). Expands: %%h (hostname), %%n (name) and %%d, (domain).
...
--heartbeat-interval <heartbeat\_interval>

--autoscale <autoscale>

-B, --beat

-s, --schedule-filename, --schedule <schedule\_filename>
