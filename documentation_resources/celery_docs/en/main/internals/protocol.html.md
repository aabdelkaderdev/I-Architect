<!-- Source: https://docs.celeryq.dev/en/main/internals/protocol.html -->

This document describes the current stable version of Celery (5.6).
For development docs,
[go here](https://docs.celeryq.dev/en/main/internals/protocol.html).
...
- `timelimit`
  :   <tuple>(float, float):
      ...
      limit value (int/float or `None` for no limit).
...
[Event Reference](../userguide/monitoring.html#event-reference).
