<!-- Source: https://docs.celeryq.dev/en/main/internals/reference/celery.utils.dispatch.html -->
...
class celery.utils.dispatch.Signal(*providing\_args=None*, *use\_caching=False*, *name=None*)[[source]](../../_modules/celery/utils/dispatch/signal.html#Signal)
:   Create new signal.
