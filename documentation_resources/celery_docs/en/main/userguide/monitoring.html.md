<!-- Source: https://docs.celeryq.dev/en/main/userguide/monitoring.html -->
...
- **shell**: Drop into a Python shell.
  ...
  [`--without-tasks`](../reference/cli.html#cmdoption-celery-shell-T) flag is set).

  Uses <https://pypi.org/project/Ipython/>, <https://pypi.org/project/bpython/>, or regular **python** in that
  order if installed. You can force an implementation using
  [`--ipython`](../reference/cli.html#cmdoption-celery-shell-I),
  [`--bpython`](../reference/cli.html#cmdoption-celery-shell-B), or
  [`--python`](../reference/cli.html#cmdoption-celery-shell-python).
...
- **inspect registered**: List registered tasks
  ...
  > ```
- **inspect stats**: Show worker statistics (see [Statistics](workers.html#worker-statistics))
...
[`--timeout`](../reference/cli.html#cmdoption-celery-inspect-t) argument,
...
[`--destination`](../reference/cli.html#cmdoption-celery-inspect-d) argument:
...
[`--broker`](../reference/cli.html#cmdoption-celery-b) argument :
...
See the API reference for [`celery.events.state`](../reference/celery.events.state.html#module-celery.events.state "celery.events.state") to read more
about state objects.

Now you can use this cam with **celery events** by specifying
it with the [`-c`](../reference/cli.html#cmdoption-celery-events-c) option:
...
the [`task_send_sent_event`](configuration.html#std-setting-task_send_sent_event) setting is enabled.
...
See [`event_queue_durable`](configuration.html#std-setting-event_queue_durable) and [`event_queue_exclusive`](configuration.html#std-setting-event_queue_exclusive) for advanced configuration.