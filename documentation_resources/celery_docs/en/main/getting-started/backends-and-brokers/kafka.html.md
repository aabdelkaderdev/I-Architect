<!-- Source: https://docs.celeryq.dev/en/main/getting-started/backends-and-brokers/kafka.html -->

This document describes the current stable version of Celery (5.6).
For development docs,
[go here](https://docs.celeryq.dev/en/main/getting-started/backends-and-brokers/kafka.html).
...
Please note that “allow\_create\_topics” is needed if the topic does not exist
...
Celery queues get routed to Kafka topics. For example, if a queue is named “add\_queue”,
then a topic named “add\_queue” will be created/used in Kafka.
