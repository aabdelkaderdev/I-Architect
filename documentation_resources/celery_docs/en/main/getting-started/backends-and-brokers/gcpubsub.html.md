<!-- Source: https://docs.celeryq.dev/en/main/getting-started/backends-and-brokers/gcpubsub.html -->

This document describes the current stable version of Celery (5.6).
For development docs,
[go here](https://docs.celeryq.dev/en/main/getting-started/backends-and-brokers/gcpubsub.html).
...
the `celery[gcpubsub]` [bundle](../introduction.html#bundles):
...
by configuring the `expiration_seconds` setting:
...
The ack\_deadline\_seconds defines the number of seconds pub/sub infra shall wait
