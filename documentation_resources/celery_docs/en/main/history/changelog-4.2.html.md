<!-- Source: https://docs.celeryq.dev/en/main/history/changelog-4.2.html -->

This document describes the current stable version of Celery (5.6).
For development docs,
[go here](https://docs.celeryq.dev/en/main/history/changelog-4.2.html).

# Change history

This document contains change notes for bugfix releases in
the 4.2.x series, please see [What’s new in Celery 4.2 (windowlicker)](whatsnew-4.2.html#whatsnew-4-2) for
...
- **Worker**: Fixed multiple issues with rate limited tasks
  ...
  Fix possible scheduling of a [`celery.worker.request.Request`](../reference/celery.worker.request.html#celery.worker.request.Request "celery.worker.request.Request") with the wrong [`kombu.utils.limits.TokenBucket`](https://docs.celeryq.dev/projects/kombu/en/main/reference/kombu.utils.limits.html#kombu.utils.limits.TokenBucket "(in Kombu v5.6)") which could cause tasks’ rate limit to behave incorrectly.
  Fix possible duplicated execution of tasks that were rate limited or if ETA/Countdown was provided for them.

  Contributed by [@ideascf](https://github.com/ideascf/)
...
- **Task**: Fix shadow\_name issue when using previous version Task class (#4572)
  ...
  > Contributed by [@pachewise](https://github.com/pachewise/).
- **Task**: Add support for bound tasks as link\_error parameter (Fixes #3723) (#4545)

  > Contributed by [@brabiega](https://github.com/brabiega/).
- **Deployment**: Add a command line option for setting the Result Backend URL (#4549)

  > Contributed by [@y0ngdi](https://github.com/y0ngdi/).
...
- **Timezones**: Correctly detect UTC timezone and timezone from settings (Fixes #4517) (#4519)
  ...
  > Contributed by [@last-partizan](https://github.com/last-partizan/).
...
- **Message Protocol Properties**: Allow the shadow keyword argument and the shadow\_name method to set shadow properly (#4381)
  ...
  > Contributed by [@hclihn](https://github.com/hclihn/).
...
- **CouchDB Backend**: Correct CouchDB key string type for Python 2/3 compatibility (#4166)
  ...
  > Contributed by [@fmind](https://github.com/fmind/) && **Omer Katz**.
...
- **Celery Beat**: Better equality comparison for ScheduleEntry instances (#4312)
  ...
  > Contributed by [@mariia-zelenova](https://github.com/mariia-zelenova/).
...
- Use unique time values for Collections/LimitedSet (#3879 and #3891) (#3892)
  ...
  > Contributed by [@lead2gold](https://github.com/lead2gold/).
...
- **Canvas**: Properly take into account chain tasks link\_error (#4240)
  ...
  > Contributed by [@agladkov](https://github.com/agladkov/).
...
- **Worker**: Apply rate limiting for tasks with ETA (#4251)
  ...
  > Contributed by [@arpanshah29](https://github.com/arpanshah29/).
...
- **Beat**: Set default scheduler class in beat command. (#4189)
  ...
  > Contributed by [@Kxrr](https://github.com/Kxrr/).
...
- **Deployment**: Adds stopasgroup to the supervisor scripts (#4200)
  ...
  > Contributed by [@martialp](https://github.com/martialp/).
...
- Use heartbeat setting from application configuration for Broker connection (#4148)
  ...
  > Contributed by [@mperice](https://github.com/mperice/).
...
- **Canvas** Keyword arguments are passed to tasks in chain as expected.
  ...
  Contributed by [@tothegump](https://github.com/tothegump/)
...
- GreenletExit is not in \_\_all\_\_ in greenlet.py which can not be imported by Python 3.6.
...
- Matched the behavior of GroupResult.as\_tuple() to that of AsyncResult.as\_tuple().
...
> - [@jairojair](https://github.com/jairojair/)
> - **Ben Welsh**
> - **Michael Peake**
> - **Fengyuan Chen**
> - [@arpanshah29](https://github.com/arpanshah29/)
> - **Xavier Hardy**
> - **Shitikanth**
> - **Igor Kasianov**
> - **John Arnold**
> - [@dmollerm](https://github.com/dmollerm/)
> - **Robert Knight**
> - **Asif Saifuddin Auvi**
> - **Eduardo Ramírez**
> - **Kamil Breguła**
