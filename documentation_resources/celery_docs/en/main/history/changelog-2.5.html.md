<!-- Source: https://docs.celeryq.dev/en/main/history/changelog-2.5.html -->

This document describes the current stable version of Celery (5.6).
For development docs,
[go here](https://docs.celeryq.dev/en/main/history/changelog-2.5.html).

# Change history for Celery 2.5

This document contains change notes for bugfix releases in the 2.5.x series,
please see [What’s new in Celery 2.5](whatsnew-2.5.html#whatsnew-2-5) for an overview of what’s
new in Celery 2.5.

If you’re looking for versions prior to 2.5 you should visit our
[History](index.html#history) of releases.
...
- Version parity with <https://pypi.org/project/django-celery/>
...
- A bug causes messages to be sent with UTC time-stamps even though
  `CELERY_ENABLE_UTC` wasn’t enabled (Issue #636).
...
- Django documentation has been moved to the main Celery docs.
  ...
  > See [Django](../django/index.html#django).
- New [`celeryd_init`](../userguide/signals.html#std-signal-celeryd_init) signal can be used to configure workers
  by hostname.
...
- [celery control|inspect] can now be configured on the command-line.
  ...
  > ```
- Version dependency for <https://pypi.org/project/python-dateutil/> fixed to be strict.
...
- [`multiprocessing`](https://docs.python.org/dev/library/multiprocessing.html#module-multiprocessing "(in Python v3.15)"): Fixed an error occurring if the pool was stopped
...
- celery shell: can now be started with
  [`--eventlet`](../reference/cli.html#cmdoption-celery-shell-eventlet) or
  [`--gevent`](../reference/cli.html#cmdoption-celery-shell-gevent) options to apply their
  monkey patches.
...
See [What’s new in Celery 2.5](whatsnew-2.5.html#whatsnew-2-5).
