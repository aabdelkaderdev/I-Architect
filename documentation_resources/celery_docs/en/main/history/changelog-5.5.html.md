<!-- Source: https://docs.celeryq.dev/en/main/history/changelog-5.5.html -->

This document describes the current stable version of Celery (5.6).
For development docs,
[go here](https://docs.celeryq.dev/en/main/history/changelog-5.5.html).

# Change history

This document contains change notes for bugfix & new features
in the main branch & 5.5.x series, please see [What’s new in Celery 5.5 (Immunity)](whatsnew-5.5.html#whatsnew-5-5) for
...
See [What’s new in Celery 5.5 (Immunity)](whatsnew-5.5.html#whatsnew-5-5) for a complete overview or read the main highlights below.
...
- Added missing “ [|oc-sponsor-3|](#id200)” in README (#9326)
...
See [What’s new in Celery 5.5 (Immunity)](whatsnew-5.5.html#whatsnew-5-5) or read the main highlights below.
...
See [What’s new in Celery 5.5 (Immunity)](whatsnew-5.5.html#whatsnew-5-5) or read main highlights below.
...
- Revert “Added Blacksmith.sh to the Sponsors section in the README” (#9324)
- Added Blacksmith.sh to the Sponsors section in the README (#9325)
- Added missing “ [|oc-sponsor-3|](#id202)” in README (#9326)
- Use Blacksmith SVG logo (#9327)
- Updated Blacksmith SVG logo (#9328)
- Revert “Updated Blacksmith SVG logo” (#9329)
- Update pymongo to 4.10.0 (#9330)
