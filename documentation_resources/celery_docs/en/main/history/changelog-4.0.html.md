<!-- Source: https://docs.celeryq.dev/en/main/history/changelog-4.0.html -->

This document describes the current stable version of Celery (5.6).
For development docs,
[go here](https://docs.celeryq.dev/en/main/history/changelog-4.0.html).

# Change history

This document contains change notes for bugfix releases in
the 4.0.x series (latentcall), please see [What’s new in Celery 4.0 (latentcall)](whatsnew-4.0.html#whatsnew-4-0) for
...
- **Requirements**
  ...
  > - Now depends on [Kombu 4.0.2](https://docs.celeryq.dev/projects/kombu/en/main/changelog.html#version-4-0-2 "(in Kombu v5.6)").
...
- Documentation and examples improvements by:
  ...
  > - **BLAGA Razvan-Paul**
  > - **Michael Howitz**
  > - [@paradox41](https://github.com/paradox41/)
...
- [Security: [CELERYSA-0003](https://github.com/celery/celery/tree/master/docs/sec/CELERYSA-0003.txt)] Insecure default configuration
  ...
  > The default [`accept_content`](../userguide/configuration.html#std-setting-accept_content) setting was set to allow
...
- **Tasks**: Argument checking now supports keyword-only arguments on Python3
  ...
  > Contributed by [@sww](https://github.com/sww/).
...
- **Canvas**: Fixed [`ValueError`](https://docs.python.org/dev/library/exceptions.html#ValueError "(in Python v3.15)") in chord with single task header
  (Issue #3608).
...
- **Worker**: Fixed [`KeyError`](https://docs.python.org/dev/library/exceptions.html#KeyError "(in Python v3.15)") in `inspect stats` when `-O` argument
...
- **Results**: Redis has a new [`redis_socket_connect_timeout`](../userguide/configuration.html#std-setting-redis_socket_connect_timeout)
  setting.
...
- **Deps**: Bundle `celery[sqs]` now also requires <https://pypi.org/project/pycurl/>
  (Issue #3619).
...
- **Results**: Redis/memcache backends now uses [`result_expires`](../userguide/configuration.html#std-setting-result_expires)
...
- Documentation improvements contributed by
  ...
  > - [@csfeathers](https://github.com/csfeathers/)
  > - **Moussa Taifi**
  > - **Yuhannaa**
  > - **Laurent Peuch**
  > - **Christian**
...
See [What’s new in Celery 4.0 (latentcall)](whatsnew-4.0.html#whatsnew-4-0) (in `docs/whatsnew-4.0.rst`).
