<!-- Source: https://docs.celeryq.dev/en/main/history/changelog-5.4.html -->

This document describes the current stable version of Celery (5.6).
For development docs,
[go here](https://docs.celeryq.dev/en/main/history/changelog-5.4.html).

# Change history

This document contains change notes for bugfix & new features
in the & 5.4.x series, please see [What’s new in Celery 5.4 (Opalescent)](whatsnew-5.4.html#whatsnew-5-4) for
