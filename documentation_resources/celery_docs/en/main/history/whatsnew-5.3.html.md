<!-- Source: https://docs.celeryq.dev/en/main/history/whatsnew-5.3.html -->

This document describes the current stable version of Celery (5.6).
For development docs,
[go here](https://docs.celeryq.dev/en/main/history/whatsnew-5.3.html).
...
This release has been codenamed [Emerald Rush](https://www.youtube.com/watch?v=4sk0uDbM5lc).
...
Unless [`broker_connection_retry_on_startup`](../userguide/configuration.html#std-setting-broker_connection_retry_on_startup) is set to False,
Celery will automatically retry reconnecting to the broker after
the first connection loss. [`broker_connection_retry`](../userguide/configuration.html#std-setting-broker_connection_retry) controls
...
[`worker_prefetch_multiplier`](../userguide/configuration.html#std-setting-worker_prefetch_multiplier).
...
BasePool.\_get\_info(), and enhances it to report the worker pool class in use via the
“celery inspect stats” command. For example:

$ celery -A … inspect stats
-> [celery@freenas](mailto:celery%40freenas): OK
...
>
>     > …
>     > :   “implementation”: “celery\_aio\_pool.pool:AsyncIOPool”,

It can be used as follows:

> Set the environment variable CELERY\_CUSTOM\_WORKER\_POOL to the name of
...
`global_keyprefix` key under [`result_backend_transport_options`](../userguide/configuration.html#std-setting-result_backend_transport_options):
...
Previously, REVOKES\_MAX, REVOKE\_EXPIRES, SUCCESSFUL\_MAX and
SUCCESSFUL\_EXPIRES were hardcoded in celery.worker.state. This
version introduces CELERY\_WORKER\_ prefixed environment variables
