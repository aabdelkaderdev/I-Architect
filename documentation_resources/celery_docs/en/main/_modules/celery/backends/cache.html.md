<!-- Source: https://docs.celeryq.dev/en/main/_modules/celery/backends/cache.html -->

This document describes the current stable version of Celery (5.6).
For development docs,
[go here](https://docs.celeryq.dev/en/main/_modules/celery/backends/cache.html).

# Source code for celery.backends.cache
