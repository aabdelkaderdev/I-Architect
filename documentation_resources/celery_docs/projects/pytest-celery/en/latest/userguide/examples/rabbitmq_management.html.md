<!-- Source: https://docs.celeryq.dev/projects/pytest-celery/en/latest/userguide/examples/rabbitmq_management.html -->

This document describes the current stable version of pytest\_celery (1.3).
For development docs,
[go here](https://pytest-celery.readthedocs.io/en/main/userguide/examples/rabbitmq_management.html).
...
to use the [rabbitmq:management](https://hub.docker.com/_/rabbitmq) image.
...
The [`RabbitMQTestBroker`](../../reference/pytest_celery.vendors.rabbitmq.html#pytest_celery.vendors.rabbitmq.api.RabbitMQTestBroker "pytest_celery.vendors.rabbitmq.api.RabbitMQTestBroker") class is used to represent a logical broker in the
...
The [`celery_broker`](../../reference/pytest_celery.fixtures.html#pytest_celery.fixtures.broker.celery_broker "pytest_celery.fixtures.broker.celery_broker") fixture is a special parameterized fixture that
provides all of the available broker fixtures. By default [`celery_broker_cluster`](../../reference/pytest_celery.fixtures.html#pytest_celery.fixtures.broker.celery_broker_cluster "pytest_celery.fixtures.broker.celery_broker_cluster")
...
Calling celery\_rabbitmq\_broker.get\_management\_url() during debug and opening the link in your browser allows you to see the RabbitMQ management UI
