...
If you want to use different string for parts of the response such as `detail` and `non_field_errors` then you can modify this behavior by using a [custom exception handler](../../api-guide/exceptions/#custom-exception-handling).
...
by following the guidelines in the [Contributing to REST Framework](../../community/contributing/#development) section and submitting a pull request.
...
3. Now copy the [base translations file](https://raw.githubusercontent.com/encode/django-rest-framework/main/rest_framework/locale/en_US/LC_MESSAGES/django.po) from the REST framework source code into your translations folder.
