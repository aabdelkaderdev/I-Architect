<!-- Source: https://www.django-rest-framework.org/topics/browsable-api -->
...
If you include fully-qualified URLs in your resource output, they will be 'urlized' and made clickable for easy browsing by humans. The `rest_framework` package includes a [`reverse`](../../api-guide/reverse/) helper for this purpose.
...
**templates/rest\_framework/api.html**
...
- [drf-redesign](https://github.com/youzarsiph/drf-redesign) - A package for customizing the API using Bootstrap 5. Modern and sleek design, it comes with the support for dark mode.
