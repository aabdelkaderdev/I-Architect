...
The [rest-framework-gm2m-relations](https://github.com/mojtabaakbari221b/rest-framework-gm2m-relations) library provides read/write serialization for [django-gm2m](https://github.com/tkhyn/django-gm2m).
