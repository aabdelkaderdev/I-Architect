...
For more information see the documentation on [content negotiation](../content-negotiation/).
...
See the [*HTML & Forms* Topic Page](../../topics/html-and-forms/) for further examples of `TemplateHTMLRenderer` usage.
...
For more information see the [HTML & Forms](../../topics/html-and-forms/) documentation.
...
If you require cross-domain AJAX requests, you should generally be using the more modern approach of [CORS](https://www.w3.org/TR/cors/) as an alternative to `JSONP`. See the [CORS documentation](https://www.django-rest-framework.org/topics/ajax-csrf-cors/) for more details.
...
[Rest Framework Latex](https://github.com/mypebble/rest-framework-latex) provides a renderer that outputs PDFs using Lualatex. It is maintained by [Pebble (S/F Software)](https://github.com/mypebble).
