...
- It supports REST framework's flexible request parsing, rather than just supporting form data. For example you can handle incoming [JSON data](../parsers/#jsonparser) similarly to how you handle incoming [form data](../parsers/#formparser).

For more details see the [parsers documentation](../parsers/).
...
For more details see the [authentication documentation](../authentication/).
...
For more information see the [browser enhancements documentation](../../topics/browser-enhancements/).
