...
[setting](../pagination/#setting-the-pagination-style) and
[modifying](../pagination/#modifying-the-pagination-style) the pagination style.
...
May be any of `None`, `'iso-8601'` or a Python [strftime format](https://docs.python.org/3/library/datetime.html#strftime-and-strptime-format-codes) string.
...
May be a list including the string `'iso-8601'` or Python [strftime format](https://docs.python.org/3/library/datetime.html#strftime-and-strptime-format-codes) strings.
...
Global settings for [select field cutoffs for rendering relational fields](../relations/#select-field-cutoffs) in the browsable API.
