...
Together with [authentication](../authentication/) and [throttling](../throttling/), permissions determine whether a request should be granted or denied access.
