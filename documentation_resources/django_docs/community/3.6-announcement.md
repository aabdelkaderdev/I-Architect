<!-- Source: https://www.django-rest-framework.org/community/3.6-announcement -->
...
The 3.6 release would not have been possible without our [backing from Mozilla](../mozilla-grant/) to the project, and our [collaborative funding model](https://opencollective.com/django-rest-framework).
...
**[signing up for a paid plan](https://opencollective.com/django-rest-framework)**.
...
- [Machinalis](https://machinalis.com/)
- [Rollbar](https://rollbar.com)
- [MicroPyramid](https://micropyramid.com/django-rest-framework-development-services/)

*Many thanks to all our [sponsors](https://fund.django-rest-framework.org/topics/funding/#our-sponsors), and in particular to our premium backers, [Rover](https://www.rover.com/careers/), [Sentry](https://sentry.io/welcome/), [Stream](https://getstream.io/?utm_source=drf&utm_medium=banner&utm_campaign=drf), [Machinalis](https://machinalis.com/), [Rollbar](https://rollbar.com), and [MicroPyramid](https://micropyramid.com/django-rest-framework-development-services/).*
...
For more information on documenting your API endpoints see the ["Documenting your API"](../../topics/documenting-your-api/) section.
...
For more details see the [JavaScript client library documentation](https://github.com/encode/django-rest-framework/blob/3.14.0/docs/topics/api-clients.md#javascript-client-library).
...
For more information see the [Python client library documentation](https://github.com/encode/django-rest-framework/blob/3.14.0/docs/topics/api-clients.md#python-client-library).
