<!-- Source: https://www.django-rest-framework.org/community/3.14-announcement -->
...
There are a number of minor fixes and improvements in this release. See the [release notes](../release-notes/) page for a complete listing.
