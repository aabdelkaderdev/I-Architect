<!-- Source: https://www.django-rest-framework.org/community/3.5-announcement -->
...
The 3.5 release would not have been possible without our [collaborative funding model](https://opencollective.com/django-rest-framework).
...
- [Machinalis](https://www.machinalis.com/#services)
...
you to [use the schema definition to document your API](../../api-guide/schemas/#schemas-as-documentation).

There is now also a shortcut function, `get_schema_view()`, which makes it easier to
[adding schema views](../../api-guide/schemas/#get_schema_view) to your API.
...
[publicly documented API](../../api-guide/schemas/#schemagenerator), allowing you to more easily
...
We now have preliminary support for [RAML documentation generation](https://github.com/encode/django-rest-raml).
...
with APIs that expose a RAML specification. The [RAML codec](https://github.com/core-api/python-raml-codec) gives some examples of
...
now fully support file [uploads](https://core-api.github.io/python-client/api-guide/utils/#file) and [downloads](https://core-api.github.io/python-client/api-guide/codecs/#downloadcodec).
