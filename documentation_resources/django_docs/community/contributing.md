...
Other really great ways you can help move the community forward include helping to answer questions on the [discussion group](https://groups.google.com/forum/?fromgroups#!forum/django-rest-framework), or setting up an [email alert on StackOverflow](https://stackexchange.com/filters/66475/rest-framework) so that you get notified of any new questions with the `django-rest-framework` tag.
...
[Django REST Framework repo](https://github.com/encode/django-rest-framework) on GitHub.
...
See GitHub's [*Fork a Repo*](https://help.github.com/articles/fork-a-repo/) Guide for more help.

Changes should broadly follow the [PEP 8](https://www.python.org/dev/peps/pep-0008/) style conventions, and we recommend you set up your editor to automatically indicate non-conforming styles.
...
If you want to draw attention to a note or warning, use an [admonition](https://python-markdown.github.io/extensions/admonition/), like so:
