...
- Update TokenAdmin to respect USERNAME\_FIELD of the user model by [@m000](https://github.com/m000) in [#9836](https://github.com/encode/django-rest-framework/pull/9836)
...
- Allow to override child.run\_validation call in ListSerializer [[#8035](https://github.com/encode/django-rest-framework/pull/8035)]
...
- Make set\_value a method within `Serializer` [[#8001](https://github.com/encode/django-rest-framework/pull/8001)]
- Fix URLPathVersioning reverse fallback [[#7247](https://github.com/encode/django-rest-framework/pull/7247)]
- Warn about Decimal type in min\_value and max\_value arguments of DecimalField [[#8972](https://github.com/encode/django-rest-framework/pull/8972)]
...
- Refactor get\_field\_info method to include max\_digits and decimal\_places attributes in SimpleMetadata class [[#8943](https://github.com/encode/django-rest-framework/pull/8943)]
...
- Fix BooleanField's allow\_null behavior [[#8614](https://github.com/encode/django-rest-framework/pull/8614)]
...
- Fixes instance check in ListSerializer.to\_representation [[#8726](https://github.com/encode/django-rest-framework/pull/8726)] [[#8727](https://github.com/encode/django-rest-framework/pull/8727)]
...
- Add missing DurationField to SimpleMetadata label\_lookup [[#8702](https://github.com/encode/django-rest-framework/pull/8702)]
...
- Properly handle ATOMIC\_REQUESTS when multiple database configurations are used. [#7739]
...
- Fix issue if `rest_framework.authtoken.models` is imported, but `rest_framework.authtoken` is not in INSTALLED\_APPS. [#7571]
...
- Drop `.set_context` API [in favor of a `requires_context` marker](../3.11-announcement/#validator-default-context).
...
- Ability to specify urlconf in include\_docs\_urls.
...
- Adjusted the compat check for django-guardian to allow the last guardian
  version (v1.4.9) compatible with Python 2. [#6613](https://github.com/encode/django-rest-framework/issues/6613)
...
- Added 'request\_forms' block to base.html [#6340](https://github.com/encode/django-rest-framework/issues/6340)
...
- Added SearchFilter.get\_search\_fields() hook. [#6279](https://github.com/encode/django-rest-framework/issues/6279)
...
- Allowed Q objects in limit\_choices\_to introspection. [#6472](https://github.com/encode/django-rest-framework/issues/6472)
...
- Change `CharField` to disallow null bytes. [#6073](https://github.com/encode/django-rest-framework/issues/6073)
...
- Render descriptions (from help\_text) using safe [#5869](https://github.com/encode/django-rest-framework/issues/5869)
- Removed input value from default\_error\_message [#5881](https://github.com/encode/django-rest-framework/issues/5881)
- Added min\_value/max\_value support in DurationField [#5643](https://github.com/encode/django-rest-framework/issues/5643)
...
- Improved get\_error\_detail to use error\_dict/error\_list [#5785](https://github.com/encode/django-rest-framework/issues/5785)
...
- Fix autoescape not getting passed to urlize\_quoted\_links filter [#6191](https://github.com/encode/django-rest-framework/issues/6191)
...
- authtoken.views import coreapi from rest\_framework.compat, not directly. [#5921](https://github.com/encode/django-rest-framework/issues/5921)
...
- **Breaking Change**: Alter `read_only` plus `default` behavior. [#5886](https://github.com/encode/django-rest-framework/issues/5886)
...
- Correct allow\_null behavior when required=False [#5888](https://github.com/encode/django-rest-framework/issues/5888)
...
- Allowed customizing API documentation code samples [#5752](https://github.com/encode/django-rest-framework/issues/5752)
...
- Add DEFAULT\_SCHEMA\_CLASS setting [#5658](https://github.com/encode/django-rest-framework/issues/5658)
...
- Fix format\_suffix\_patterns behavior with Django 2 path() routes [#5691](https://github.com/encode/django-rest-framework/issues/5691)
...
- Fix processing unicode symbols in query\_string by Python 2 [#5552](https://github.com/encode/django-rest-framework/issues/5552)
...
- Don't strip microseconds from `time` when encoding. Makes consistent with `datetime`.
  **BC Change**: Previously only milliseconds were encoded. [#5440](https://github.com/encode/django-rest-framework/issues/5440)
- Added `STRICT_JSON` setting (default `True`) to raise exception for the extended float values (`nan`, `inf`, `-inf`) accepted by Python's `json` module.
  **BC Change**: Previously these values would converted to corresponding strings. Set `STRICT_JSON` to `False` to restore the previous behavior. [#5265](https://github.com/encode/django-rest-framework/issues/5265)
...
- Make `DEFAULT_PAGINATION_CLASS` `None` by default.
  **BC Change**: If your were **just** setting `PAGE_SIZE` to enable pagination you will need to add `DEFAULT_PAGINATION_CLASS`.
  The previous default was `rest_framework.pagination.PageNumberPagination`. There is a system check warning to catch this case. You may silence that if you are setting pagination class on a per-view basis. [#5170](https://github.com/encode/django-rest-framework/issues/5170)
...
- Adjust schema get\_filter\_fields rules to match framework [#5454](https://github.com/encode/django-rest-framework/issues/5454)
- Updated test matrix to add Django 2.0 and drop Django 1.8 & 1.9
  **BC Change**: This removes Django 1.8 and Django 1.9 from Django REST Framework supported versions. [#5457](https://github.com/encode/django-rest-framework/issues/5457)
...
- Ensure content\_type is set when passing empty body to RequestFactory [#5351](https://github.com/encode/django-rest-framework/issues/5351)
...
- Update get\_object() example in permissions.md [#5401](https://github.com/encode/django-rest-framework/issues/5401)
...
- Reuse 'apply\_markdown' function in 'render\_markdown' templatetag [#5469](https://github.com/encode/django-rest-framework/issues/5469)
...
- Docs: Clarified 'to\_internal\_value()' validation behavior [#5466](https://github.com/encode/django-rest-framework/issues/5466)
- Fix missing six.text\_type() call on APIException.**str** [#5476](https://github.com/encode/django-rest-framework/issues/5476)
...
- Have `is_list_view` recognize RetrieveModel… views [#5480](https://github.com/encode/django-rest-framework/issues/5480)
...
- Make sure max\_length is in FileField kwargs. [#5186](https://github.com/encode/django-rest-framework/issues/5186)
...
- Honor http\_method\_names on class based view, when generating API schemas. ([#5085](https://github.com/encode/django-rest-framework/issues/5085))
...
- Add max\_length and min\_length arguments for ListField. ([#4877](https://github.com/encode/django-rest-framework/issues/4877))
...
- Fix is\_simple\_callable with variable args, kwargs. ([#4622](https://github.com/encode/django-rest-framework/issues/4622), [#4602](https://github.com/encode/django-rest-framework/issues/4602))
...
- Fix support of get\_full\_details() for Throttled exceptions. ([#4627](https://github.com/encode/django-rest-framework/issues/4627))
...
- Fixed an issue where the incorrect value is set to `ResolverMatch.func_name` of api\_view decorated view. ([#4465](https://github.com/encode/django-rest-framework/issues/4465), [#4462](https://github.com/encode/django-rest-framework/issues/4462))
...
- Allow custom CSRF\_HEADER\_NAME setting. ([#4415](https://github.com/encode/django-rest-framework/issues/4415), [#4410](https://github.com/encode/django-rest-framework/issues/4410))
...
- Fix docstring of Field.get\_default. ([#4404](https://github.com/encode/django-rest-framework/issues/4404))
...
- Fix handling of ALLOWED\_VERSIONS and no DEFAULT\_VERSION. [#4370](https://github.com/encode/django-rest-framework/issues/4370)
...
- Fix call to TemplateHTMLRenderer.resolve\_context() fallback method. ([#4371](https://github.com/encode/django-rest-framework/issues/4371))
...
- Include kwargs passed to 'as\_view' when generating schemas. ([#4359](https://github.com/encode/django-rest-framework/issues/4359), [#4330](https://github.com/encode/django-rest-framework/issues/4330), [#4331](https://github.com/encode/django-rest-framework/issues/4331))
...
- extra\_kwargs takes precedence over uniqueness kwargs. ([#4198](https://github.com/encode/django-rest-framework/issues/4198), [#4199](https://github.com/encode/django-rest-framework/issues/4199), [#4349](https://github.com/encode/django-rest-framework/issues/4349))
...
- Test cases for DictField with allow\_null options. ([#4348](https://github.com/encode/django-rest-framework/issues/4348))
...
- Set view.format\_kwarg in schema generator. ([#4293](https://github.com/encode/django-rest-framework/issues/4293), [#4315](https://github.com/encode/django-rest-framework/issues/4315))
...
- Use verbose\_name instead of object\_name in error messages. ([#4299](https://github.com/encode/django-rest-framework/issues/4299))
...
- Exclude read\_only=True fields from unique\_together validation & add docs. ([#4192](https://github.com/encode/django-rest-framework/issues/4192))
...
- Fix string\_types / text\_types confusion. ([#4025](https://github.com/encode/django-rest-framework/issues/4025))
...
- Using safer calling way of "@api\_view" in tutorial. ([#3971](https://github.com/encode/django-rest-framework/issues/3971))
- ListSerializer doesn't handle unique\_together constraints. ([#3970](https://github.com/encode/django-rest-framework/issues/3970))
...
- Fixed \_force\_text\_recursive typo. ([#3908](https://github.com/encode/django-rest-framework/issues/3908))
...
- Use get\_serializer\_class in ordering filter. ([#3487](https://github.com/encode/django-rest-framework/issues/3487))
...
- Do not ignore overridden View.get\_view\_name() in breadcrumbs. ([#3273](https://github.com/encode/django-rest-framework/issues/3273))
...
- Uniqueness validators should not be run for excluded (read\_only) fields. ([#2848](https://github.com/encode/django-rest-framework/issues/2848))
...
- Raise error when setting a removed rest\_framework setting. Thanks to Luis San Pablo for the fix. ([#3715](https://github.com/encode/django-rest-framework/issues/3715))
- Add missing csrf\_token in AdminRenderer post form. Thanks to Piotr Śniegowski for the fix. ([#3703](https://github.com/encode/django-rest-framework/issues/3703))
...
- Fix empty pk detection in HyperlinkRelatedField.get\_url. Thanks to @jslang for the fix ([#3962](https://github.com/encode/django-rest-framework/issues/3962))
...
- Use related\_objects api for Django 1.9+. ([#3656](https://github.com/encode/django-rest-framework/issues/3656), [#3252](https://github.com/encode/django-rest-framework/issues/3252))
...
- Reveal previously hidden AttributeErrors and TypeErrors while calling has\_[object\_]permissions. ([#3668](https://github.com/encode/django-rest-framework/issues/3668))
...
- Fix Admin and API browser for views without a filter\_class. ([#3705](https://github.com/encode/django-rest-framework/issues/3705), [#3596](https://github.com/encode/django-rest-framework/issues/3596), [#3597](https://github.com/encode/django-rest-framework/issues/3597))
- Add app\_name to rest\_framework.urls. ([#3714](https://github.com/encode/django-rest-framework/issues/3714))
...
- Set the action on a view when override\_method regardless of its None-ness. ([#2933](https://github.com/encode/django-rest-framework/issues/2933))
...
- Handle reversal of non-API view\_name in `HyperLinkedRelatedField` ([#2724](https://github.com/encode/django-rest-framework/issues/2724), [#2711](https://github.com/encode/django-rest-framework/issues/2711))
...
- LimitOffsetPagination raises `TypeError` if PAGE\_SIZE not set ([#2667](https://github.com/encode/django-rest-framework/issues/2667), [#2700](https://github.com/encode/django-rest-framework/issues/2700))
