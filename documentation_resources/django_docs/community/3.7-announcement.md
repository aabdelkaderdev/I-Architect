<!-- Source: https://www.django-rest-framework.org/community/3.7-announcement -->
...
For full details on the new functionality, please see the [Schema Documentation](../../api-guide/schemas/).
...
This will likely be timed so that any REST framework development here ties in with similar work on [API Star](https://github.com/encode/apistar).
