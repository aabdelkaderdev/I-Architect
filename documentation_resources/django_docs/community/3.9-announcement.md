...
The 3.9 release gives access to *extra actions* in the Browsable API, introduces composable permissions and built-in [OpenAPI](https://www.openapis.org/) schema support. (Formerly known as Swagger)
...
- The `Router.get_default_base_name` method has been renamed in favor of `Router.get_default_basename`. [#5990](https://github.com/encode/django-rest-framework/pull/5990)

See [#5990](https://github.com/encode/django-rest-framework/pull/5990).
...
There are a large number of minor fixes and improvements in this release. See the [release notes](../release-notes/) page for a complete listing.
