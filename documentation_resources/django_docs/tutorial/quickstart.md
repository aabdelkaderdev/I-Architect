...
If you want to get a more in depth understanding of how REST framework fits together head on over to [the tutorial](../1-serialization/), or start browsing the [API guide](../../api-guide/requests/).
