...
Before we do anything else we'll create a new virtual environment called `.venv`, using [venv](https://docs.python.org/3/library/venv.html). This will make sure our package configuration is kept nicely isolated from any other projects we're working on.
...
We'll see how we can start to improve things in [part 2 of the tutorial](../2-requests-and-responses/).
