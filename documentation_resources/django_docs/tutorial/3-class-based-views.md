...
Next we'll move onto [part 4 of the tutorial](../4-authentication-and-permissions/), where we'll take a look at how we can deal with authentication and permissions for our API.
