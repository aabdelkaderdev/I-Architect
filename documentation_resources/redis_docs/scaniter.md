<!-- Source: https://redis.io/docs/latest/develop/clients/redis-py/scaniter -->

# Scan iteration

Iterate through results from `SCAN`, `HSCAN`, etc.

Redis has a small family of related commands that retrieve
keys and, in some cases, their associated values:

- [`SCAN`](/docs/latest/commands/scan/) retrieves keys
  from the main Redis keyspace.
- [`HSCAN`](/docs/latest/commands/hscan/) retrieves keys and optionally,
  their values from a
  [hash](/docs/latest/develop/data-types/hashes/) object.
- [`SSCAN`](/docs/latest/commands/sscan/) retrieves keys from a
  [set](/docs/latest/develop/data-types/sets/) object.
- [`ZSCAN`](/docs/latest/commands/zscan/) retrieves keys and their score values from a
  [sorted set](/docs/latest/develop/data-types/sorted-sets/) object.
...
the set of keys it returns (see the [`SCAN`](/docs/latest/commands/scan/)
