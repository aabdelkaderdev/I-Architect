<!-- Source: https://redis.io/docs/latest/develop/clients/redis-py/prob -->
...
[probabilistic data types](/docs/latest/develop/data-types/probabilistic/)
...
a [set](/docs/latest/develop/data-types/sets/):
...
- [Membership](#set-membership): The
  [Bloom filter](/docs/latest/develop/data-types/probabilistic/bloom-filter/) and
  [Cuckoo filter](/docs/latest/develop/data-types/probabilistic/cuckoo-filter/)
  data types let you track whether or not a given item is a member of a set.
- [Cardinality](#set-cardinality): The
  [HyperLogLog](/docs/latest/develop/data-types/probabilistic/hyperloglogs/)
...
Instead of storing strings directly, like a [set](/docs/latest/develop/data-types/sets/),
...
A [HyperLogLog](/docs/latest/develop/data-types/probabilistic/hyperloglogs/)
...
- [Frequency](#frequency): The
  [Count-min sketch](/docs/latest/develop/data-types/probabilistic/count-min-sketch/)
  data type lets you find the approximate frequency of a labeled item in a data stream.
- [Quantiles](#quantiles): The
  [t-digest](/docs/latest/develop/data-types/probabilistic/t-digest/)
  data type estimates the quantile of a query value in a data stream.
- [Ranking](#ranking): The
  [Top-K](/docs/latest/develop/data-types/probabilistic/top-k/) data type
...
A [Count-min sketch](/docs/latest/develop/data-types/probabilistic/count-min-sketch/)
...
A [t-digest](/docs/latest/develop/data-types/probabilistic/t-digest/)
...
A [Top-K](/docs/latest/develop/data-types/probabilistic/top-k/)
