<!-- Source: https://redis.io/docs/latest/develop/clients/redis-py/amr -->
...
Install [`redis-py`](/docs/latest/develop/clients/redis-py/#install) first,
...
[Connect with TLS](/docs/latest/develop/clients/redis-py/connect/#connect-to-your-production-redis-with-tls) for more information).
