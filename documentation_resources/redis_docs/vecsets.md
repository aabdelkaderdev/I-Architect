<!-- Source: https://redis.io/docs/latest/develop/clients/redis-py/vecsets -->
...
A Redis [vector set](/docs/latest/develop/data-types/vector-sets/) lets
...
[Redis for AI](/docs/latest/develop/ai/) to learn more about text
...
[`vadd()`](/docs/latest/commands/vadd/) command to set the embedding.
...
[`vemb()`](/docs/latest/commands/vemb/) to retrieve the embedding,
...
[hash vector indexing](/docs/latest/develop/ai/search-and-query/vectors/)).
...
or by using the [`vgetattr()`](/docs/latest/commands/vgetattr/) method.
...
the query vector to [`vsim()`](/docs/latest/commands/vsim/) to return elements
...
You can also use
[filter expressions](/docs/latest/develop/data-types/vector-sets/filtered-search/)
...
See the [vector sets](/docs/latest/develop/data-types/vector-sets/)
docs for more information and code examples. See the
[Redis for AI](/docs/latest/develop/ai/) section for more details
about text embeddings and other AI techniques you can use with Redis.

You may also be interested in
[vector search](/docs/latest/develop/clients/redis-py/vecsearch/).
This is a feature of
[Redis Search](/docs/latest/develop/ai/search-and-query/)
that lets you retrieve
[JSON](/docs/latest/develop/data-types/json/) and
[hash](/docs/latest/develop/data-types/hashes/) documents based on
