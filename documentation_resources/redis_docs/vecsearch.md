<!-- Source: https://redis.io/docs/latest/develop/clients/redis-py/vecsearch -->
...
lets you index vector fields in [hash](/docs/latest/develop/data-types/hashes/)
or [JSON](/docs/latest/develop/data-types/json/) objects (see the
[Vectors](/docs/latest/develop/ai/search-and-query/vectors/)
reference page for more information).
Among other things, vector fields can store *text embeddings*, which are AI-generated vector
representations of the semantic information in pieces of text. The
[vector distance](/docs/latest/develop/ai/search-and-query/vectors/#distance-metrics)
...
Install [`redis-py`](/docs/latest/develop/clients/redis-py/) if you
...
[tag](/docs/latest/develop/ai/search-and-query/advanced-concepts/tags/)
field to represent the "genre" of the text, and the embedding vector generated from
the original text content. The `embedding` field specifies
[HNSW](/docs/latest/develop/ai/search-and-query/vectors/#hnsw-index)
indexing, the
[L2](/docs/latest/develop/ai/search-and-query/vectors/#distance-metrics)
...
when you add them with [`hset()`](/docs/latest/commands/hset/), as long as
...
you must supply a [path](/docs/latest/develop/data-types/json/path/) in the schema
...
Use [`json().set()`](/docs/latest/commands/json.set/) to add the data
instead of [`hset()`](/docs/latest/commands/hset/). The dictionaries
