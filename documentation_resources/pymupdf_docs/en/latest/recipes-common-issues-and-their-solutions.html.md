...
2. When using PyMuPDF to change an “alien” annotation, try to **avoid** [`Annot.update()`](annot.html#Annot.update "Annot.update"). The following methods **can be used without it,** so that the original appearance should be maintained:

> - [`Annot.set_rect()`](annot.html#Annot.set_rect "Annot.set_rect") (location changes)
> - [`Annot.set_flags()`](annot.html#Annot.set_flags "Annot.set_flags") (annotation behaviour)
> - [`Annot.set_info()`](annot.html#Annot.set_info "Annot.set_info") (meta information, except changes to *content*)
> - [`Annot.set_popup()`](annot.html#Annot.set_popup "Annot.set_popup") (create popup or change its rect)
> - [`Annot.set_oc()`](annot.html#Annot.set_oc "Annot.set_oc") (add / remove reference to optional content information)
> - [`Annot.set_open()`](annot.html#Annot.set_open "Annot.set_open")
> - [`Annot.update_file()`](annot.html#Annot.update_file "Annot.update_file") (file attachment changes)
