<!-- Source: https://pymupdf.readthedocs.io/en/latest/colors.html -->
...
Since the introduction of methods involving colors (like [`Page.draw_circle()`](page.html#Page.draw_circle "Page.draw_circle")), a requirement may be to have access to predefined colors.

The fabulous GUI package [wxPython](https://wxpython.org/) has a database of over 540 predefined RGB colors, which are given more or less memorizable names. Among them are not only standard names like “green” or “blue”, but also “turquoise”, “skyblue”, and 100 (not only 50 …) shades of “gray”, etc.
