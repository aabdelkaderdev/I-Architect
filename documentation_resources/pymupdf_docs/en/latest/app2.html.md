<!-- Source: https://pymupdf.readthedocs.io/en/latest/app2.html -->
...
Embedded File Streams”, pp. 103 of the [Adobe PDF References](app3.html#adobemanual)).
...
There even also is a new function, which delivers a list of all names under which embedded data are registered in a PDF, [`Document.embfile_names()`](document.html#Document.embfile_names "Document.embfile_names").
